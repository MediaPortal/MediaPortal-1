...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  public partial class Servers : SectionSettings
  {
    ...
    {
      IList<TVDatabase.Gentle.Server> servers = TVDatabase.Gentle.Server.ListAll();
      mpListView1.Items.Clear();
      foreach (TVDatabase.Gentle.Server server in servers)
      {
    ...
    private void buttonDelete_Click(object sender, EventArgs e)
    {
      ...
      TVDatabase.Gentle.Server server = (TVDatabase.Gentle.Server)item.Tag;
      server.Delete();
