...
using ProgramCategory = Mediaportal.TV.Server.TVDatabase.Gentle.ProgramCategory;
using ProgramCredit = Mediaportal.TV.Server.TVDatabase.Gentle.ProgramCredit;
using RuleBasedSchedule = Mediaportal.TV.Server.TVDatabase.Gentle.RuleBasedSchedule;
using Schedule = Mediaportal.TV.Server.TVDatabase.Gentle.Schedule;
using ScheduleRulesTemplate = Mediaportal.TV.Server.TVDatabase.Gentle.ScheduleRulesTemplate;
...
namespace Mediaportal.TV.Server.SetupTV.Dialogs
{
  public partial class FormEditSchedule : Form
  {
    ...
    private void PreFillInProgramDataForCredits()
    {
      ...
      {
        IList<TVDatabase.Entities.ProgramCredit> programCreditDtoList = ProgramCredit.ConvertToEntities(programCredits);
    ...
    private void PreFillInProgramDataForCategories()
    {
      ...
      if (category != null)
      {
        TVDatabase.Entities.ProgramCategory programCategoryDto = category.ConvertToEntity();
    ...
    private void PopulateRolesComboBox()
    {
      ...
      IList<TVDatabase.Entities.ProgramCredit> rolesDtos = ProgramCredit.ConvertToEntities(roles);
    ...
    private void PopulateCategoriesComboBox()
    {
      ...
      IList<TVDatabase.Entities.ProgramCategory> categoriesDtos = ProgramCategory.ConvertToEntities(categories);
