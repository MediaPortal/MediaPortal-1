...
using Mediaportal.TV.Server.TVService.TCPEventServer;
...
namespace Mediaportal.TV.Server.TVService
{
  ...
  public class TVController : MarshalByRefObject, IController, IDisposable, ITvServerEvent, IEpgEvents, ICiMenuCallbacks
  {
    ...
    /// </summary>
    private TVDatabase.Gentle.Server _ourServer;
 ...
 _tcpServer = new TCPServer(this);
    ...
    private bool InitController()
    {
      ...
      try
      {
        ...
        IList<TVDatabase.Gentle.Server> servers;
        try
        {
          servers = TVDatabase.Gentle.Server.ListAll();
        }
        catch (Exception ex)
        {
        ...
        if (_ourServer == null)
        {
          ...
          if (servers.Count == 0)
          {
            ...
            _ourServer = new TVDatabase.Gentle.Server(false, Dns.GetHostName(), RtspStreaming.DefaultPort);
        ...
        if (_isMaster)
        {
          ...
          _epgGrabber.Start();
          _scheduler = new Scheduler.Scheduler(this);
          _scheduler.Start();
        }
        ...
        TVDatabase.Gentle.Program.ResetAllStates();
    ...
    {      
      ...
      var channelStates = new ChannelStates(layer, this);      
