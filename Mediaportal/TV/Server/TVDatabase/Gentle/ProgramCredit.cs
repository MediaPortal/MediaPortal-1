...
namespace Mediaportal.TV.Server.TVDatabase.Gentle
{
  ...
  public class ProgramCredit : Persistent
  {
    ...
    public static IList<Entities.ProgramCredit> ConvertToEntities(IEnumerable<ProgramCredit> roles)
    {
      var creditDtos = new ObservableCollection<Entities.ProgramCredit>();
      foreach (var role in roles)
      {
        var creditDto = new Entities.ProgramCredit { person = role.Person, role = role.Role, idProgramCredit = role.IdProgramCredit };
