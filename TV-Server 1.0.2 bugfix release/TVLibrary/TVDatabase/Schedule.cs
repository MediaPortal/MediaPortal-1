...
namespace TvDatabase
{
  ...
  public class Schedule : Persistent
  {
    ...
    /// </summary> 
    public Schedule(int idChannel, int scheduleType, string programName, DateTime startTime, DateTime endTime,
    ...
    /// </summary> 
    public Schedule(int idSchedule, int idChannel, int scheduleType, string programName, DateTime startTime,
    ...
    {
      Schedule schedule = new Schedule(IdChannel, scheduleType, ProgramName, StartTime, EndTime, MaxAirings, Priority,
