...
namespace TvDatabase
{
  ...
  public class Program : Persistent
  {
    ...
    [TableColumn("idProgramCategory", NotNull = true), ForeignKey("ProgramCategory", "idProgramCategory")]
    ...
    [TableColumn("episodePart", NotNull = true)]
    private string episodePart;
    [TableColumn("episodeName", NotNull = true)]
    ...
    [TableColumn("previouslyShown", NotNull = true)]
    private bool previouslyShown;
    ...
    {
      get { return previouslyShown; }
      set { previouslyShown = value; }
    }
    ...
    /// <param name="channelId">Referenced Channel id</param>
    /// <returns></returns>
    public static IList<Program> RetrieveByChannelAndTimesInterval(DateTime startTime, DateTime endTime,
                                                                    int channelId)
    {
      //select * from 'foreigntable'
      SqlBuilder sb = new SqlBuilder(StatementType.Select, typeof(Program));
    ...
    ///
    /// </summary>
    public ProgramCategory ReferencedProgramCategory()
    {
      return ProgramCategory.Retrieve(idProgramCategory);
    }

    /// <summary>
    /// Get a list of TuningDetail referring to the current entity.
    /// </summary>
    public IList<ProgramCredit> ReferringProgramCredit()
    {
      SqlBuilder sb = new SqlBuilder(StatementType.Select, typeof(ProgramCredit));
      sb.AddConstraint(Operator.Equals, "idProgram", idProgram);
      SqlStatement stmt = sb.GetStatement(true);
      return ObjectFactory.GetCollection<ProgramCredit>(stmt.Execute());
    }
