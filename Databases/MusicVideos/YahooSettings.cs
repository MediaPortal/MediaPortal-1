...
namespace MediaPortal.MusicVideos.Database
{
  public class YahooSettings
  {
    ...
    public string msDefaultBitRate = "768";
    public string msDefaultCountryName = "Germany";
    ...
    public void loadSettings()
    {
      ...
      {
        msDefaultCountryName = xmlreader.GetValueAsString("musicvideo", "country", "Germany");
        ...
        mbUseVMR9 = false; //xmlreader.GetValueAsBool("musicvideo", "useVMR9", false);
      }
