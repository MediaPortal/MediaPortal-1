...
namespace MediaPortal.Drawing
{
	public struct Matrix
	{
		...
		{
			return new Matrix(Microsoft.DirectX.Matrix.AffineTransformation2D((float)scaling, rotationCenter.ToVector2(), (float)rotation, translation.ToVector2()));
		}
		...
		{
			return new Matrix(Matrix.Multiply(l, r));
		}
		...
		{
			return Matrix.MultiplyTranspose(l, r);
		}

		public static Matrix OrthoLH(double width, double height, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.OrthoLH((float)width, (float)height, (float)znearPlane, (float)zfarPlane));
		}
			
		public static Matrix OrthoOffCenterLH(double left, double right, double bottom, double top, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.OrthoOffCenterLH((float)left, (float)right, (float)bottom, (float)top, (float)znearPlane, (float)zfarPlane));
		}	
			
		public static Matrix OrthoOffCenterRH(double left, double right, double bottom, double top, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.OrthoOffCenterRH((float)left, (float)right, (float)bottom, (float)top, (float)znearPlane, (float)zfarPlane));
		}
		
		public static Matrix OrthoRH(double width, double height, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.OrthoRH((float)width, (float)height, (float)znearPlane, (float)zfarPlane));
		}
		
		public static Matrix PerspectiveFovLH(float fieldOfViewY, float aspectRatio, float znearPlane, float zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveFovLH((float)fieldOfViewY, (float)aspectRatio, (float)znearPlane, (float)zfarPlane));	
		}

		public static Matrix PerspectiveFovRH(double fieldOfViewY, double aspectRatio, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveFovRH((float)fieldOfViewY, (float)aspectRatio, (float)znearPlane, (float)zfarPlane));
		}

		public static Matrix PerspectiveLH(double width, double height, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveLH((float)width, (float)height, (float)znearPlane, (float)zfarPlane));
		}

		public static Matrix PerspectiveOffCenterLH(double left, double right, double bottom, double top, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveOffCenterLH((float)left, (float)right, (float)bottom, (float)top, (float)znearPlane, (float)zfarPlane));
		}
		
		public static Matrix PerspectiveOffCenterRH(double left, double right, double bottom, double top, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveOffCenterRH((float)left, (float)right, (float)bottom, (float)top, (float)znearPlane, (float)zfarPlane));
		}
		
		public static Matrix PerspectiveRH(double width, double height, double znearPlane, double zfarPlane)
		{
			return new Matrix(Microsoft.DirectX.Matrix.PerspectiveFovRH((float)width, (float)height, (float)znearPlane, (float)zfarPlane));
		}
...
//		}
		...
		public static Matrix Transformation2D(Point scalingCenter, double scalingRotation, Point scaling, Point rotationCenter, double rotation, Point translation)
		{
			return new Matrix(Microsoft.DirectX.Matrix.Transformation2D(scalingCenter, (float)scalingRotation, scaling, rotationCenter, (float)rotation, translation));
		}
		...
		Microsoft.DirectX.Matrix	_matrix;
