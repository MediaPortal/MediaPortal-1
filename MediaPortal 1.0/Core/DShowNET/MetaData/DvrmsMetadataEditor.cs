...
namespace Toub.MediaCenter.Dvrms.Metadata
{
	...
	public interface IFileSourceFilter 
	{
		...
		int Load(
			...
			[In, MarshalAs(UnmanagedType.LPStruct)] Toub.MediaCenter.Dvrms.Metadata.AmMediaType pmt);
		...
		int GetCurFile(
			...
			[Out, MarshalAs(UnmanagedType.LPStruct)] Toub.MediaCenter.Dvrms.Metadata.AmMediaType pmt);
	}
