			...
			if( b < 0x20 )
			{
				...
				while( b != 0 )
				{
					...
					switch( b )
					{
						...
						case 0xD0: ch = (char)0x2014; break;
						...
						case 0xE4: ch = (char)0x126; break;
						case 0xE6: ch = (char)0x132; break;
						case 0xE7: ch = (char)0x013F; break;
						case 0xE8: ch = (char)0x141; break;
						case 0xE9: ch = (char)0xD8; break;
						case 0xEA: ch = (char)0x152; break;
						case 0xEB: ch = (char)0xBA; break;
						case 0xEC: ch = (char)0xDE; break;
						case 0xED: ch = (char)0x166; break;
						case 0xEE: ch = (char)0x014A; break;
						case 0xEF: ch = (char)0x149; break;
						case 0xF0: ch = (char)0x138; break;
						case 0xF1: ch = (char)0xE6; break;
						case 0xF2: ch = (char)0x111; break;
						case 0xF3: ch = (char)0xF0; break;
						case 0xF4: ch = (char)0x127; break;
						case 0xF5: ch = (char)0x131; break;
						case 0xF6: ch = (char)0x133; break;
						case 0xF7: ch = (char)0x140; break;
						case 0xF8: ch = (char)0x142; break;
						case 0xF9: ch = (char)0xF8; break;
						case 0xFA: ch = (char)0x153; break;
						case 0xFB: ch = (char)0xDF; break;
						case 0xFC: ch = (char)0xFE; break;
						case 0xFD: ch = (char)0x167; break;
						...
						case 0xC2:
							...
							switch( b )
							{
								...
								case 0x6E: ch = (char)0x144; break;
								case 0x6F: ch = (char)0xF3; break;
								case 0x72: ch = (char)0x155; break;
						...
						case 0xC4:
							...
							switch( b )
							{
								case 0x41: ch = (char)0xC3; break;
								case 0x49: ch = (char)0x128; break;
								case 0x4E: ch = (char)0xD1; break;
								case 0x4F: ch = (char)0xD5; break;
								case 0x55: ch = (char)0x168; break;
								case 0x61: ch = (char)0xE3; break;
								case 0x69: ch = (char)0x129; break;
								case 0x6E: ch = (char)0xF1; break;
								case 0x6F: ch = (char)0xF5; break;
								case 0x75: ch = (char)0x169; break;
								// unknown character --> fallback
								default: ch = (char)b; break;
							}
							break;
						case 0xC5:
							...
							switch( b )
							{
								case 0x20: ch = (char)0xAF; break;
								case 0x41: ch = (char)0x100; break;
								case 0x45: ch = (char)0x112; break;
								case 0x49: ch = (char)0x012A; break;
								case 0x4F: ch = (char)0x014C; break;
								case 0x55: ch = (char)0x016A; break;
								case 0x61: ch = (char)0x101; break;
								case 0x65: ch = (char)0x113; break;
						...
						case 0xC7:
							...
							switch( b )
							{
								...
								case 0x45: ch = (char)0x116; break;
								case 0x47: ch = (char)0x120; break;
								case 0x49: ch = (char)0x130; break;
								case 0x5A: ch = (char)0x017B; break;
								case 0x63: ch = (char)0x010B; break;
								case 0x65: ch = (char)0x117; break;
								case 0x67: ch = (char)0x121; break;
						...
						case 0xC8:
							...
							switch( b )
							{
								case 0x20: ch = (char)0xA8; break;
								case 0x41: ch = (char)0xC4; break;
								case 0x45: ch = (char)0xCB; break;
								case 0x49: ch = (char)0xCF; break;
								case 0x4F: ch = (char)0xD6; break;
								case 0x55: ch = (char)0xDC; break;
								case 0x59: ch = (char)0x178; break;
								case 0x61: ch = (char)0xE4; break;
								case 0x65: ch = (char)0xEB; break;
								case 0x69: ch = (char)0xEF; break;
								case 0x6F: ch = (char)0xF6; break;
								case 0x75: ch = (char)0xFC; break;
								case 0x79: ch = (char)0xFF; break;
								// unknown character --> fallback
								default: ch = (char)b; break;
							}
							break;
						...
						case 0xCB:
							...
							switch( b )
							{
								...
								case 0x47: ch = (char)0x122; break;
								case 0x4B: ch = (char)0x136; break;
								case 0x4C: ch = (char)0x013B; break;
								case 0x4E: ch = (char)0x145; break;
								case 0x52: ch = (char)0x156; break;
								case 0x53: ch = (char)0x015E; break;
								case 0x54: ch = (char)0x162; break;
								case 0x63: ch = (char)0xE7; break;
								case 0x67: ch = (char)0x123; break;
								case 0x6B: ch = (char)0x137; break;
								case 0x6C: ch = (char)0x013C; break;
								case 0x6E: ch = (char)0x146; break;
								case 0x72: ch = (char)0x157; break;
								case 0x73: ch = (char)0x015F; break;
								case 0x74: ch = (char)0x163; break;
								// unknown character --> fallback
								default: ch = (char)b; break;
							}
							break;
						case 0xCD:
							...
							switch( b )
							{
								...
								case 0x4F: ch = (char)0x150; break;
								case 0x55: ch = (char)0x170; break;
								case 0x6F: ch = (char)0x151; break;
								case 0x75: ch = (char)0x171; break;
								// unknown character --> fallback
								default: ch = (char)b; break;
							}
							break;
						case 0xCE:
							...
							switch( b )
							{
								...
								case 0x41: ch = (char)0x104; break;
								case 0x45: ch = (char)0x118; break;
								case 0x49: ch = (char)0x012E; break;
								case 0x55: ch = (char)0x172; break;
								case 0x61: ch = (char)0x105; break;
								case 0x65: ch = (char)0x119; break;
								case 0x69: ch = (char)0x012F; break;
								case 0x75: ch = (char)0x173; break;
								// unknown character --> fallback
								default: ch = (char)b; break;
							}
							break;
						case 0xCF:
							...
							switch( b )
							{
								...
								case 0x4E: ch = (char)0x147; break;
								case 0x52: ch = (char)0x158; break;
								case 0x53: ch = (char)0x160; break;
								case 0x54: ch = (char)0x164; break;
								...
								case 0x6E: ch = (char)0x148; break;
								case 0x72: ch = (char)0x159; break;
								case 0x73: ch = (char)0x161; break;
								case 0x74: ch = (char)0x165; break;
