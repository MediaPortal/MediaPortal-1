...
namespace SQLiteLibrary
{
    class TagDAL
    {
        ...
        #region public static IMLHashItem GetTags(IDbCommand Command)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        /// <returns></returns>
        public static IMLHashItem GetTags(IDbCommand Command)
        {
        ...
        #region private static IMLHashItem FillTags(IDataReader Reader)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Reader"></param>
        /// <returns></returns>
        private static IMLHashItem FillTags(IDataReader Reader)
        {
            IMLHashItem Tags = new MLHashItem();
            try
            {
                while (Reader.Read())
