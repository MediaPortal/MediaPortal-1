...
namespace SQLiteLibrary
{
    ...
    internal class ItemDAL
    {
        ...
        private class Sql
        {
            ...
            public static string SearchByImage(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON" 
                    + " item_dates.item_id = items.item_id WHERE items.item_image = @TagValue ";
            }
            public static string SearchByLocation(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON" 
                    + " item_dates.item_id = items.item_id WHERE items.item_location = @TagValue";
            }
            public static string SearchByTag(IMLHashItem Tags, string CurrentTag)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON" 
                    + " item_dates.item_id = items.item_id WHERE SearchTag( @TagValue, " 
                    + CurrentTag + " ) ";
            ...
            public static string SearchByTitle(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON" 
                    + " item_dates.item_id = items.item_id  WHERE items.item_name = @TagValue";
            }
            public static string FindItemByID(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON" 
                    + " item_dates.item_id = items.item_id WHERE items.item_id = @TagValue";

            }
            public static string FindItemByLocation(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON"
                    + " item_dates.item_id = items.item_id WHERE items.item_location = @TagValue";
            }
            public static string FindItemByExtID(IMLHashItem Tags)
            {
                return "SELECT " + SqlHelper.GetAllTags(Tags) + " FROM items JOIN item_dates ON"
            ...
            public static string GetGroupByItems(string Filter, string GroupBy, IMLHashItem Tags)
            {
        ...
        public static bool UpdateDataSet(IDbDataAdapter Adapter, DbCommandBuilder Builder,
            DataSet dataSet, IMLHashItem Tags)
        {
            Adapter.SelectCommand.CommandText = Sql.GetAllItemsAs(Tags);
            Builder.DataAdapter = Adapter as DbDataAdapter;
                     
            //This is a hack to force updates.  Since the Media Library is designed to run 
            //with very few network users altering data it should be fine.
            Builder.ConflictOption = ConflictOption.OverwriteChanges;   
            Adapter.InsertCommand = Builder.GetInsertCommand(true);
            Adapter.DeleteCommand = Builder.GetDeleteCommand(true);
            Adapter.UpdateCommand = Builder.GetUpdateCommand(true);
            //TODO write custom commands for Update, Inset, and Delete to
            //better handle optimistic concurency conflicts and remove hack above.
            return DbProvider.UpdateDataAdapter(Adapter, dataSet);
        }

        public static DataSet GetDataSet(IDbDataAdapter Adapter, IMLHashItem Tags)
        {
            Adapter.SelectCommand.CommandText = Sql.GetAllItemsAs(Tags);
        ...
        #region public static IMLItem FindItemByID(IDbCommand Command, IMLHashItem Tags, string Value)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <returns></returns>
        public static IMLItem FindItemByID(IDbCommand Command, IMLHashItem Tags, string Value)
        {
        ...
        #region public static IMLItem FindItemByLocation(IDbCommand Command, IMLHashItem Tags, string Value)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="Value"></param>
        /// <returns></returns>
        public static IMLItem FindItemByLocation(IDbCommand Command, IMLHashItem Tags, string Value)
        {
        ...
        #region public static IMLItem FindItemByExtID(IDbCommand Command, IMLHashItem Tags, string Value)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="Value"></param>
        /// <returns></returns>
        public static IMLItem FindItemByExtID(IDbCommand Command, IMLHashItem Tags, string Value)
        {
        ...
        #region public static IMLItemList GetAllItems(IDbCommand Command, IMLHashItem Tags)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        /// <param name="Tags"></param>
        /// <returns></returns>
        public static IMLItemList GetAllItems(IDbCommand Command, IMLHashItem Tags)
        {
        ...
        #region public static IMLItemList SearchAll(IDbCommand Command, IMLHashItem Tags, string SearchString)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <returns></returns>
        public static IMLItemList SearchAll(IDbCommand Command, IMLHashItem Tags, string SearchString)
        {
        ...
        #region public static IMLItemList SearchByImage(IDbCommand Command, IMLHashItem Tags, string SearchString)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="SearchString"></param>
        /// <returns></returns>
        public static IMLItemList SearchByImage(IDbCommand Command, IMLHashItem Tags, string SearchString)
        {
        ...
        #region public static IMLItemList SearchByLocation(IDbCommand Command, IMLHashItem Tags, string SearchString)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="SearchString"></param>
        /// <returns></returns>
        public static IMLItemList SearchByLocation(IDbCommand Command, IMLHashItem Tags, string SearchString)
        {
            Command.CommandText = Sql.SearchAll(Tags);
            DbProvider.AddParameter(Command, "@TagValue", SearchString);
            return FillItems(DbProvider.ExecuteDataReader(Command), Tags.Keys as ArrayList);
        ...
        #region public static IMLItemList SearchByTag(IDbCommand Command, IMLHashItem Tags, string TagName, string SearchString)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="SearchString"></param>
        /// <returns></returns>
        public static IMLItemList SearchByTag(IDbCommand Command, IMLHashItem Tags, string TagName, string SearchString)
        {
        ...
        #region public static IMLItemList SearchByTitle(IDbCommand Command, IMLHashItem Tags, string SearchString)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <param name="SearchString"></param>
        /// <returns></returns>
        public static IMLItemList SearchByTitle(IDbCommand Command, IMLHashItem Tags, string SearchString)
        {
        ...
        #region public static IMLItemList CustomSearch(IDbCommand Command, IMLHashItem Tags)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        /// <param name="Tags"></param>
        /// <returns></returns>
        public static IMLItemList CustomSearch(IDbCommand Command, IMLHashItem Tags)
        {
            return FillItems(DbProvider.ExecuteDataReader(Command), Tags.Keys as ArrayList);
        }
        #endregion

        #region public static IMLHashItem GetGroupByItems(IDbCommand Command, IMLHashItem Tags, string Filter, string GroupByCol, bool Index)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <returns></returns>
        public static IMLHashItem GetGroupByItems(IDbCommand Command, IMLHashItem Tags, string Filter, string GroupByCol, bool Index)
        {
        ...
        /// <param name="Index"></param>
        /// <returns></returns>
        private static IMLHashItem FillGroupByItems(IDataReader Reader, bool Index)
        {
        ...
        private static IMLItemList FillItems(IDataReader Reader, ArrayList Keys)
        {
            ...
            try
            {
                while (Reader.Read())
                {
                    ...
                    {
                        if (i == Reader.FieldCount -1 && Keys.Count + 8 < Reader.FieldCount)
