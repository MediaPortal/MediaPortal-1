...
namespace MsSqlLibrary
{
    internal class SqlHelper
    {
        ...
        public static string FilterString(string str, string tbl, IMeedioItem Tags)
        {
            if (str == null)
                return string.Empty;
        ...
        public static string GetAllTags(IMeedioItem Tags)
        {
        ...
        public static string GetAllTagsAs(IMeedioItem Tags)
        {
            StringBuilder sb = new StringBuilder();
        ...
        public static string GetItemTags(IMeedioItem Tags)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("items.item_id, ");
            sb.Append("items.item_name, ");
        ...
        public static string GetItemTagsAs(IMeedioItem Tags)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("items.item_id as ID, ");
            sb.Append("items.item_name as Name, ");
