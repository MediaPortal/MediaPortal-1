...
{
  class VCRedist2005Checker : IInstallationPackage
  {
    ...
    public bool Install()
    {
      Process setup = Process.Start(Application.StartupPath + "\\Deploy\\" + Utils.GetDownloadString("VCRedist2005", "FILE"), "/Q");
      try
      {
        if (setup != null)
        {
    ...
    public CheckResult CheckStatus()
    {
      ...
      string fileName = Application.StartupPath + "\\deploy\\" + Utils.GetDownloadString("VCRedist2005", "FILE");
