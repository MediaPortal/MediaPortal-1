namespace MediaPortal.DeployTool.Sections
{
  partial class MPSettingsDlg
  {
    ...
    private void InitializeComponent()
    {
			...
			this.checkBoxLAV = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// buttonBrowse
			// 
			...
			// checkBoxLAV
			// 
			this.checkBoxLAV.AutoSize = true;
			this.checkBoxLAV.Checked = true;
			this.checkBoxLAV.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkBoxLAV.Cursor = System.Windows.Forms.Cursors.Hand;
			this.checkBoxLAV.ForeColor = System.Drawing.Color.White;
			this.checkBoxLAV.Location = new System.Drawing.Point(30, 158);
			this.checkBoxLAV.Name = "checkBoxLAV";
			this.checkBoxLAV.Size = new System.Drawing.Size(398, 17);
			this.checkBoxLAV.TabIndex = 24;
			this.checkBoxLAV.Text = "Install LAV Filters to enable playback of many common audio and video formats";
			this.checkBoxLAV.UseVisualStyleBackColor = true;
			// 
			// MPSettingsDlg
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackgroundImage = global::MediaPortal.DeployTool.Images.Background_middle_empty;
			this.Controls.Add(this.checkBoxLAV);
			...
			this.Controls.SetChildIndex(this.checkBoxLAV, 0);
	...
	private System.Windows.Forms.CheckBox checkBoxLAV;
  }
}