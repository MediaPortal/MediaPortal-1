...
namespace TvDatabase
{
  ...
  public class DiSEqCMotor : Persistent
  {
    ...
    [TableColumn("idDiSEqCMotor", NotNull = true), PrimaryKey(AutoGenerated = true)]
    private int idDiSEqCMotor;
    [TableColumn("idCard", NotNull = true)]
    private int idCard;
    [TableColumn("idSatellite", NotNull = true)]
    private int idSatellite;
    [TableColumn("position", NotNull = true)]
    ...
    public int IdSatellite
    {
      ...
      set { isChanged |= idSatellite != value; idSatellite = value; }
    }
    /// <summary>
    /// Property relating to database column hostName
    /// </summary>
    ...
    {
      get { return position; }
      set { isChanged |= position != value; position = value; }
    }
    #endregion
