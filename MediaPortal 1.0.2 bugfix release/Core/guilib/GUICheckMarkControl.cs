...
namespace MediaPortal.GUI.Library
{
  ...
  public class GUICheckMarkControl : GUIControl
  {
    ...
    public GUICheckMarkControl(int dwParentID, int dwControlId, int dwPosX, int dwPosY, int dwWidth, int dwHeight,
                               string strTextureCheckMark, string strTextureCheckMarkNF, int dwCheckWidth,
                               int dwCheckHeight, Alignment dwAlign)
    ...
    public override bool Focus
    {
      ...
      set
      {
        if (value != IsFocused)
        {
          if (value == true)
          {
            if (_imageCheckMarkFocused != null)
            {
              _imageCheckMarkFocused.Begin();
            }
          }
          else
          {
            if (_imageCheckMarkNonFocused != null)
            {
              _imageCheckMarkNonFocused.Begin();
            }
          }
        }
        base.Focus = value;
    ...
    public override int DimColor
    {
      ...
      set
      {
        ...
        if (_imageCheckMarkFocused != null)
        {
          _imageCheckMarkFocused.DimColor = value;
        }
        if (_imageCheckMarkNonFocused != null)
        {
          _imageCheckMarkNonFocused.DimColor = value;
        }
      }
    }
  }
