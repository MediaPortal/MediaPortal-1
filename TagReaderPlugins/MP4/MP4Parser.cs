  ...
  public class MP4Parser
  {
    ...
    protected static ParsedAtom[] parseAtoms(Stream s, long offset, long stopAt)
    {
      ...
      while (offset < stopAt)
      {
        ...
        Console.WriteLine(atomType);

        //switch (atomType)
        //{
        //    case "ESDS":
        //        Console.WriteLine("Found ESDS!");
        //        break;

        //    case "STSD":
        //        Console.WriteLine("Found STSD!");
        //        break;

        //    case "SINF":
        //        Console.WriteLine("Found SINF!");
        //        break;

        //    case "MDIA":
        //        Console.WriteLine("Found MDIA!");
        //        break;

        //    case "MINF":
        //        Console.WriteLine("Found MINF!");
        //        break;

        //    case "STBL":
        //        Console.WriteLine("Found STBL!");
        //        break;
        //}
