                                ...
                                if (iLength == iSize)
                                {
                                    ...
                                    switch (cmd)
                                    {
                                        ...
                                        case CommandEnum.ImonRCInit:
                                            if (iLength == 17)
                                                iResult = Drivers.iMONDisplay.S_iMONRC_Init(
                                        ...
                                        case CommandEnum.ImonRCUninit:
                                            Drivers.iMONDisplay.S_iMONRC_Uninit();
                                            iResult = 1;
                                            goto resp;

                                        case CommandEnum.ImonRCIsInited:
                                            iResult = Drivers.iMONDisplay.S_iMONRC_IsInited() ? 1 : 0;
                                            goto resp;

                                        case CommandEnum.ImonRCGetHWType:
                                            iResult = Drivers.iMONDisplay.S_iMONRC_GetHWType();
                                            goto resp;

                                        case CommandEnum.ImonRCGetFirmwareVer:
                                            iResult = Drivers.iMONDisplay.S_iMONRC_GetFirmwareVer();
                                            goto resp;

                                        case CommandEnum.ImonRCCheckDriverVersion:
                                            iResult = Drivers.iMONDisplay.S_iMONRC_CheckDriverVersion();
                                            goto resp;

                                        case CommandEnum.ImonRCChangeiMONRCSet:
                                            if (iLength == 9)
                                                iResult = Drivers.iMONDisplay.S_iMONRC_ChangeiMONRCSet(BitConverter.ToInt32(data, iIdx)) ? 1 : 0;
                                            goto resp;

                                        case CommandEnum.ImonRCChangeRC6:
                                            if (iLength == 9)
                                                iResult = Drivers.iMONDisplay.S_iMONRC_ChangeRC6(BitConverter.ToInt32(data, iIdx)) ? 1 : 0;
                                            goto resp;

                                        case CommandEnum.ImonRCGetLastRFMode:
                                            iResult = Drivers.iMONDisplay.S_iMONRC_GetLastRFMode();
                                            goto resp;
                                        ...
                                        case CommandEnum.ImonRCGetPacket:
                                            if (iLength > 5)
                                            {
                                                ...
                                                unsafe
                                                {
                                                    fixed (byte* p = data)
                                                    {
                                                        iResult = Drivers.iMONDisplay.S_iMONRC_GetPacket(p + 5, i) ? 1 : 0;
                                                    }
                                                }
