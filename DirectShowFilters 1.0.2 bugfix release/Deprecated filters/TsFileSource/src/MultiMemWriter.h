...
#ifndef MULTIMEMWRITER_H
#define MULTIMEMWRITER_H
...
class MultiMemWriter
{
public:
	MultiMemWriter(SharedMemory *pSharedMemory, MultiMemWriterParam *pWriterParams);
	virtual ~MultiMemWriter();
	...
	MemWriter* getCurrentTSFile(void);
