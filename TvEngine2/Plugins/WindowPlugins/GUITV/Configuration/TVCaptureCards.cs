...
namespace MediaPortal.Configuration.TVE2.Sections
{
  public class TVCaptureCards : SectionSettings
  {
    ...
    private MPListView cardsListView;
    ...
    private void cardsListView_SelectedIndexChanged(object sender, EventArgs e)
    {
