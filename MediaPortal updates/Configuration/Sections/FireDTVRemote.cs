...
namespace MediaPortal.Configuration.Sections
{
  ...
  public class FireDtvRemote : MediaPortal.Configuration.SectionSettings
  {
    ...
    private MediaPortal.UserInterface.Controls.MPLabel labelAction;
    private MediaPortal.UserInterface.Controls.MPLabel labelKey;
    private MediaPortal.UserInterface.Controls.MPLabel labelKeyCode;
    private MediaPortal.UserInterface.Controls.MPComboBox comboBoxAction;
    private MediaPortal.UserInterface.Controls.MPTextBox textBoxKey;
    private MediaPortal.UserInterface.Controls.MPComboBox comboBoxKeyCode;
    private MediaPortal.UserInterface.Controls.MPComboBox comboBoxGotoWindow;
    ...
    private MediaPortal.UserInterface.Controls.MPComboBox comboBoxRemoteControl;
    ...
    private MediaPortal.UserInterface.Controls.MPTextBox textBoxcSharp;
    private MediaPortal.UserInterface.Controls.MPLabel labelcSharp;
    private MediaPortal.UserInterface.Controls.MPLabel label2;
    private MediaPortal.UserInterface.Controls.MPLabel label3;
    private MediaPortal.UserInterface.Controls.MPTextBox textBoxCode;
    private MediaPortal.UserInterface.Controls.MPTextBox textBoxDescription;
    ...
    private MediaPortal.UserInterface.Controls.MPComboBox comboBoxFireDTVDevice;
    private MediaPortal.UserInterface.Controls.MPTextBox textBoxFireDTVKeyFile;
    ...
    private void InitializeComponent()
    {
      ...
      this.comboBoxFireDTVDevice = new MediaPortal.UserInterface.Controls.MPComboBox();
      this.comboBoxRemoteControl = new MediaPortal.UserInterface.Controls.MPComboBox();
      this.textBoxFireDTVKeyFile = new MediaPortal.UserInterface.Controls.MPTextBox();
      ...
      this.textBoxDescription = new MediaPortal.UserInterface.Controls.MPTextBox();
      this.textBoxCode = new MediaPortal.UserInterface.Controls.MPTextBox();
      this.label3 = new MediaPortal.UserInterface.Controls.MPLabel();
      this.label2 = new MediaPortal.UserInterface.Controls.MPLabel();
      this.labelcSharp = new MediaPortal.UserInterface.Controls.MPLabel();
      this.textBoxcSharp = new MediaPortal.UserInterface.Controls.MPTextBox();
      this.buttonLearn = new MediaPortal.UserInterface.Controls.MPButton();
      this.comboBoxGotoWindow = new MediaPortal.UserInterface.Controls.MPComboBox();
      this.label1 = new MediaPortal.UserInterface.Controls.MPLabel();
      this.comboBoxKeyCode = new MediaPortal.UserInterface.Controls.MPComboBox();
      this.textBoxKey = new MediaPortal.UserInterface.Controls.MPTextBox();
      this.labelKeyCode = new MediaPortal.UserInterface.Controls.MPLabel();
      this.labelKey = new MediaPortal.UserInterface.Controls.MPLabel();
      this.labelAction = new MediaPortal.UserInterface.Controls.MPLabel();
      this.comboBoxAction = new MediaPortal.UserInterface.Controls.MPComboBox();
