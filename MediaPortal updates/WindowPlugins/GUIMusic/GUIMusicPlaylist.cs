...
namespace MediaPortal.GUI.Music
{
  ...
  public class GUIMusicPlayList : GUIMusicBaseWindow
  {
    ...
    private void LoadScrobbleUserSettings()
    {
      ...
      Log.Write("GUIMusicPlayList: Scrobblesettings loaded for {0} - Active: {1} , Trackpreference: {2}", _currentScrobbleUser, Convert.ToString(ScrobblerOn), Convert.ToString(_preferCountForTracks));
    }
