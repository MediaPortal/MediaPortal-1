...
namespace MediaPortal.GUI.TV
{
  ...
  public class GUIFullScreenTV : GUIWindow, IRenderLayer
  {
    ...
    void SaveSettings()
    {
      using ( MediaPortal.Profile.Settings xmlwriter = new MediaPortal.Profile.Settings("MediaPortal.xml") )
      {
        ...
        switch ( GUIGraphicsContext.ARType )
        {
          ...
          case MediaPortal.GUI.Library.Geometry.Type.Zoom149:
        ...
        case Action.ActionType.ACTION_ASPECT_RATIO:
          {
            ...
            switch ( GUIGraphicsContext.ARType )
            {
              ...
              case MediaPortal.GUI.Library.Geometry.Type.PanScan43:
                GUIGraphicsContext.ARType = MediaPortal.GUI.Library.Geometry.Type.Zoom149;
                status = GUILocalizeStrings.Get(1190); //"Zoom to 14:9";
                break;
    ...
    void ShowAspectRatioMenu()
    {
      ...
      dlg.AddLocalizedString(1190); // Zoom149
