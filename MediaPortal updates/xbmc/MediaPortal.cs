...
public class MediaPortalApp : D3DApp, IRender
{
  ...
  void OnResume()
  {
    ...
    using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings("MediaPortal.xml"))
    {
      ...
      if (turnMonitorOn)
      {
        Log.Write("Main: OnResume - Trying to wake up the monitor / tv");
  ...
  protected override void Render(float timePassed)
  {
    ...
    {
      Log.Write("Main: MediaPortal.Render() called while VMR9 render - {0} / {1}",
                    GUIGraphicsContext.Vmr9Active, GUIGraphicsContext.Vmr9FPS);
      return;
    }
    if (GUIGraphicsContext.Vmr9Active)
    {
      Log.Write("Main: MediaPortal.Render() called while VMR9 active");
      return;
    }
