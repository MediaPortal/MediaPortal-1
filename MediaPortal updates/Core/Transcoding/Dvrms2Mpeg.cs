  ...
  public class Dvrms2Mpeg : ITranscode
  {
    ...
    public bool Transcode(TranscodeInfo info, MediaPortal.Core.Transcoding.VideoFormat format, MediaPortal.Core.Transcoding.Quality quality)
    {
      ...
      try
      {
        ...
        {
          Log.Write("DVR2MPG: FAILED:Unable to create Cyberlink MPEG Muxer (PowerDVD)");
          Cleanup();
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVR2MPG: FAILED:Add Cyberlink MPEG Muxer to filtergraph :0x{0:X}", hr);
          Cleanup();
          return false;
        }
        ...
        {
          Log.Write("DVR2MPG: FAILED:Unable to create FileWriter");
          Cleanup();
          return false;
        }
        ...
        {
          Log.Write("DVR2MPG: FAILED:Add unable to get IFileSinkFilter for filewriter");
          Cleanup();
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVR2MPG: FAILED:Add FileWriter to filtergraph :0x{0:X}", hr);
          Cleanup();
          return false;
        }
        ...
        {
          Log.Write("DVR2MPG: FAILED:unable to get pins of muxer&source");
          Cleanup();
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVR2MPG: FAILED:unable to set filename for filewriter :0x{0:X}", hr);
          Cleanup();
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVR2MPG: FAILED:unable to start graph :0x{0:X}", hr);
          Cleanup();
          return false;
        }
      }
