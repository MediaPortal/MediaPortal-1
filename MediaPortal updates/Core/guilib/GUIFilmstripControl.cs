...
namespace MediaPortal.GUI.Library
{
  ...
  public class GUIFilmstripControl : GUIControl
  {
    ...
    void RenderItem( float timePassed, bool bFocus, int dwPosX, int dwPosY, GUIListItem pItem )
    {
      ...
      if ( bFocus == true && Focus && _listType == GUIListControl.ListType.CONTROL_LIST )
      {
        ...
        if ( true == _showTexture )
          _imageFolderFocus.Render(timePassed);
      ...
      else
      {
        ...
        if ( true == _showTexture )
          _imageFolder.Render(timePassed);
    ...
    public override void PreAllocResources()
    {
      ...
      if ( _imageFolder != null )
        _imageFolder.PreAllocResources();
      if ( _imageFolderFocus != null )
        _imageFolderFocus.PreAllocResources();
      if ( _horizontalScrollbar != null )
    ...
    public override void AllocResources()
    {
      ...
      if ( _imageFolder != null )
        _imageFolder.AllocResources();
      if ( _imageFolderFocus != null )
        _imageFolderFocus.AllocResources();
      if ( _horizontalScrollbar != null )
    ...
    public override void FreeResources()
    {
      ...
      if ( _imageFolder != null )
        _imageFolder.FreeResources();
      if ( _imageFolderFocus != null )
        _imageFolderFocus.FreeResources();
      if ( _horizontalScrollbar != null )
    ...
    public override void StorePosition()
    {
      ...
      if ( _imageFolder != null )
        _imageFolder.StorePosition();
      if ( _imageFolderFocus != null )
        _imageFolderFocus.StorePosition();
      if ( _horizontalScrollbar != null )
    ...
    public override void ReStorePosition()
    {
      ...
      if ( _imageFolder != null )
        _imageFolder.ReStorePosition();
      if ( _imageFolderFocus != null )
        _imageFolderFocus.ReStorePosition();
      if ( _horizontalScrollbar != null )
      ...
      if ( _imageBackground != null )
        _imageBackground.GetRect(out _backGroundPositionX, out _backGroundPositionY, out _backGroundWidth, out _backGroundHeight);
      if ( _upDownControl != null )
        _upDownControl.GetRect(out _spinControlPositionX, out _spinControlPositionY, out _spinControlWidth, out _spinControlHeight);
    ...
    public override int DimColor
    {
      ...
      set
      {
        ...
        if ( _imageFolder != null )
          _imageFolder.DimColor = value;
        if ( _imageFolderFocus != null )
          _imageFolderFocus.DimColor = value;
        if ( _horizontalScrollbar != null )
