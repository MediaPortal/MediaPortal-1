...
namespace MediaPortal.TV.Recording
{
  ...
  public class DVBGraphBDA : DVBGraphBase
  {
    ...
    public override bool CreateGraph(int Quality)
    {
      try
      {
        ...
        if ((_card.Graph == null) || (_card.Graph.TvFilterDefinitions == null))
        {
          ...
          Log.Write("DVBGraphBDA:FAILED card does not contain filters?");
          return false;
        }
        ...
        if ((_card.Graph == null) || (_card.Graph.TvConnectionDefinitions == null))
        {
          ...
          Log.Write("DVBGraphBDA:FAILED card does not contain connections for tv?");
          return false;
        }
        ...
        if (hr < 0)
        {
          Log.Write("DVBGraphBDA:FAILED link :0x{0:X}", hr);
          return false;
        }
        ...
        */
        ...
        foreach (FilterDefinition dsFilter in _card.Graph.TvFilterDefinitions)
        {
          ...
          if (dsFilter.MonikerDisplayName == String.Empty)
          {
            ...
            Log.Write("DVBGraphBDA:  no moniker found for filter:{0}", dsFilter.FriendlyName);
            return false;
          }
          ...
          else
          {
            ...
            Log.Write("DVBGraphBDA:  Error! Result code = 0x{0:X}", hr);
            return false;
          }
        ...
        for (int i = 0; i < _card.Graph.TvConnectionDefinitions.Count; i++)
        {
          ...
          {
            Log.Write("DVBGraphBDA:FAILED Cannot find source filter for connection:{0}", i);
            continue;
          }
          ...
          if (sinkFilter == null)
          {
            Log.Write("DVBGraphBDA:FAILED Cannot find sink filter for connection:{0}", i);
            continue;
          }
          ...
          if (sourcePin == null)
          {
            ...
            if ((strPinName.Length == 1) && (Char.IsDigit(strPinName, 0)))
            {
              ...
              if (sourcePin == null)
                Log.Write("DVBGraphBDA:FAILED   Unable to find sourcePin: <{0}>", strPinName);
              else
                Log.Write("DVBGraphBDA:   Found sourcePin: <{0}> <{1}>", strPinName, sourcePin.ToString());
            }
          }
          else
            Log.Write("DVBGraphBDA:   Found sourcePin: <{0}> ", ((ConnectionDefinition)_card.Graph.TvConnectionDefinitions[i]).SourcePinName);
          ...
          if (sinkPin == null)
          {
            ...
            Log.Write("DVBGraphBDA:   Found sinkPin: <{0}> ", ((ConnectionDefinition)_card.Graph.TvConnectionDefinitions[i]).SinkPinName);
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphBDA:FAILED   unable to connect pins:0x{0:X}", hr);
            if (sourceFilter.Category == "tunerdevice" && sinkFilter.Category == "capture")
            {
              Log.Write("DVBGraphBDA:   try other instances");
              if (sinkPin != null)
              ...
              foreach (string key in AvailableFilters.Filters.Keys)
              {
                ...
                {
                  Log.Write("DVBGraphBDA:   found {0} instances", al.Count);
                  for (int filterInstance = 0; filterInstance < al.Count; ++filterInstance)
                  {
                    filter = (Filter)al[filterInstance];
                    Log.Write("DVBGraphBDA:   try:{0}", filter.MonikerString);
                    ...
                    if (sinkPin == null)
                    {
                      ...
                      if ((strPinName.Length == 1) && (Char.IsDigit(strPinName, 0)))
                      {
                        sinkPin = DsFindPin.ByDirection(sinkFilter.DSFilter, PinDirection.Input, Convert.ToInt32(strPinName));
                        if (sinkPin == null)
                          Log.Write("DVBGraphBDA:FAILED   Unable to find sinkPin: <{0}>", strPinName);
                        else
                          Log.Write("DVBGraphBDA:   Found sinkPin: <{0}> <{1}>", strPinName, sinkPin.ToString());
                      }
                    }
                    if (sinkPin != null)
                    {
                      ...
                      {
                        Log.Write("DVBGraphBDA:FAILED   cannot connect pins:0x{0:X}", hr);
                        if (sinkPin != null)
                          Marshal.ReleaseComObject(sinkPin);
                        sinkPin = null;
                        if (sinkFilter.DSFilter != null)
        ...
        if (GUIGraphicsContext.DX9Device != null && _sampleInterface != null)
        {
          if (!ConnectFilters(ref lastFilter.DSFilter, ref _filterSampleGrabber))
          {
            ...
            Log.Write("DVBGraphBDA:Failed to connect Tee/Sink-Sink converter filter->grabber");
            return false;
          }
        }
        //=========================================================================================================
        ...
        //Log.Write("DVBGraphBDA:CreateGraph() create MPEG2-Demultiplexer");
        ...
        /*
                ...
                if (UseTsTimeShifting)
                {
                  ...
                  {
                    Log.Write("DVBGraphBDA:Failed to create TS Mpeg2 Demultiplexer");
                    return false;
                  }
        ...
        */
        ...
        if (GUIGraphicsContext.DX9Device != null && _sampleInterface != null)
        {
          //Log.Write("DVBGraphBDA:CreateGraph() connect grabber->demuxer");
        ...
        {
          //Log.Write("DVBGraphBDA:CreateGraph() connect capture->demuxer");
        ...
        */
        ...
        //        Log.Write("DVBGraphBDA:CreateGraph() connect demuxer->tif");
        if (!ConnectFilters(ref _filterMpeg2Demultiplexer, ref _filterTIF))
        {
          ...
          Log.Write("DVBGraphBDA:Failed to connect mpeg2 demultiplexer->TIF");
          //return false;
        }
        ...
        //Log.Write("DVBGraphBDA:CreateGraph() add stream analyzer");
        ...
        if (hr != 0)
        {
          ...
          Log.Write("DVBGraphBDA: FAILED to add SectionsFilter 0x{0:X}", hr);
          return false;
        }


        //        Log.Write("DVBGraphBDA:CreateGraph() find audio/video pins");
              ...
              if (fetchedm == 1)
              {
                ...
                if (pinMediaType[0].majorType == MEDIATYPE_MPEG2_SECTIONS && !connected)
                {
                  ...
                  if (pinConnectedTo == null)
                  {
                    ...
                    {
                      Log.Write("DVBGraphBDA:FAILED to connect mpeg2 demux->stream analyzer");
                    }
                    pin[0] = null;
                  }
                  if (pinConnectedTo != null)
        ...
        if (_pinDemuxerVideo == null)
        {
          ...
          Log.Write("DVBGraphBDA:Failed to get pin '{0}' (video out) from MPEG-2 Demultiplexer", _pinDemuxerVideo);
          return false;
        }
        if (_pinDemuxerAudio == null)
        {
          ...
          Log.Write("DVBGraphBDA:Failed to get pin '{0}' (audio out)  from MPEG-2 Demultiplexer", _pinDemuxerAudio);
          return false;
        }

        //Log.Write("DVBGraphBDA:CreateGraph() create ac3/mpg1 pins");
        if (demuxer != null)
        {
          ...
          if (hr != 0)
          {
            ...
            Log.Write("DVBGraphBDA: FAILED to create audio output pin on demuxer");
            return false;
          }
          ...
          if (hr != 0)
          {
            ...
            Log.Write("DVBGraphBDA: FAILED to create video output pin on demuxer");
            return false;
          }

          //Log.Write("mpeg2: create ac3 pin");
          ...
          if (hr != 0 || _pinAC3Out == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to create AC3 pin:0x{0:X}", hr);
          }

          //Log.Write("DVBGraphBDA: create mpg1 audio pin");
          ...
          {
            _lastError = String.Format("failed to add mpg1 audio pin");
            Log.Write("DVBGraphBDA:FAILED to create MPG1 pin:0x{0:X}", hr);
          }

          //Log.Write("DVBGraphBDA: create mpg4 video pin");
          ...
          if (hr != 0 || _pinDemuxerVideoMPEG4 == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to create MPG4 pin:0x{0:X}", hr);
          }
          ...
          if (hr != 0 || _pinDemuxerEPG == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to create EPG pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (hr != 0 || _pinDemuxerMHWd2 == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to create MHW1 pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (hr != 0 || _pinDemuxerMHWd3 == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to create MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (pinMHW1In == null)
          {
            ...
            Log.Write("DVBGraphBDA:FAILED to get MHW1 pin on MSPA");
            return false;
          }
          ...
          {
            _lastError = String.Format("failed to connect analyzer filter");
            Log.Write("DVBGraphBDA:FAILED to get MHW2 pin on MSPA");
            return false;
          }
          ...
          {
            _lastError = String.Format("failed to connect analyzer filter");
            Log.Write("DVBGraphBDA:FAILED to get EPG pin on MSPA");
            return false;
          }
          ...
          {
            _lastError = String.Format("failed to connect analyzer filter");
            Log.Write("DVBGraphBDA:FAILED to connect EPG pin:0x{0:X}", hr);
            return false;
          }
          ...
          {
            _lastError = String.Format("failed to connect analyzer filter");
            Log.Write("DVBGraphBDA:FAILED to connect MHW1 pin:0x{0:X}", hr);
            return false;
          }
          ...
          {
            _lastError = String.Format("failed to connect analyzer filter");
            Log.Write("DVBGraphBDA:FAILED to connect MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (GUIGraphicsContext.DX9Device != null)
          {
            ...
            if (hr != 0 || _pinTeletext == null)
            {
              ...
              Log.Write("DVBGraphBDA:FAILED to create ttx pin:0x{0:X}", hr);
              return false;
            }
            ...
            if (pinIn == null)
            {
              ...
              Log.Write("DVBGraphBDA:unable to find sample grabber input:0x{0:X}", hr);
              return false;
            }
            ...
            {
              _lastError = String.Format("failed to sample grabber");
              Log.Write("DVBGraphBDA:FAILED to connect demux->sample grabber:0x{0:X}", hr);
              return false;
            }
            if (pinIn != null)
            {
        ...
        else
        {
          ...
          Log.Write("DVBGraphBDA:mapped IMPEG2Demultiplexer not found");
        }
        //=========================================================================================================
    ...
    public override void DeleteGraph()
    {
      try
      {
        ...
        if (_tunerStatistics != null)
        {
          for (int i = 0; i < _tunerStatistics.Count; i++)
          {
            if (_tunerStatistics[i] != null)
            {
              ...
              if (hr != 0)
                Log.Write("DVBGraphBDA:ReleaseComObject(tunerstat):{0}", hr);
        ...
        if (_filterDvbAnalyzer != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterDvbAnalyzer):{0}", hr);
        ...
        if (_filterCaptureDevice != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterCaptureDevice):{0}", hr);
          _filterCaptureDevice = null;
        }
        if (_filterMpeg2Demultiplexer != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterMpeg2Demultiplexer):{0}", hr);
        ...
        if (_filterNetworkProvider != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterNetworkProvider):{0}", hr);
        ...
        if (_filterSampleGrabber != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterSampleGrabber):{0}", hr);
          _filterSampleGrabber = null;
        }
        if (_filterSmartTee != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterSmartTee):{0}", hr);
        ...
        if (_filterTIF != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterTIF):{0}", hr);
          _filterTIF = null;
        }
        if (_filterTunerDevice != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(_filterTunerDevice):{0}", hr);
        ...
        if (m_mpeg2Analyzer != null)
        {
          ...
          if (hr != 0)
            Log.Write("ReleaseComObject(m_mpeg2Analyzer):{0}", hr);
    ...
    protected override void UpdateSignalPresent()
    {
      ...
      if (_tunerStatistics == null)
      {
        Log.Write("DVBGraphBDA:UpdateSignalPresent() no tuner stat interfaces");
        return;
      }
      if (_tunerStatistics.Count == 0)
      {
      ...
      for (int i = 0; i < _tunerStatistics.Count; i++)
      {
        ...
        {
          //Log.Write("DVBGraphBDA:UpdateSignalPresent() locked :{0}", ex.Message);
        }
        catch (Exception)
        {
          //Log.Write("DVBGraphBDA:UpdateSignalPresent() locked :{0}", ex.Message);
        ...
        {
          //Log.Write("DVBGraphBDA:UpdateSignalPresent() present :{0}", ex.Message);
        }
        catch (Exception)
        {
          // Log.Write("DVBGraphBDA:UpdateSignalPresent() present :{0}", ex.Message);
        ...
        {
          //Log.Write("DVBGraphBDA:UpdateSignalPresent() quality :{0}", ex.Message);
        }
        catch (Exception)
        {
          //Log.Write("DVBGraphBDA:UpdateSignalPresent() quality :{0}", ex.Message);
        ...
        //Log.Write("  #{0}  locked:{1} present:{2} quality:{3} strength:{4}", i, isLocked, isPresent, quality, strength);
      }
      if (_tunerStatistics.Count > 0)
      {
    ...
    protected void GetTunerSignalStatistics()
    {
      ...
      if (_filterTunerDevice == null)
      {
        Log.Write("DVBGraphBDA: could not get IBDA_Topology since no tuner device");
        return;
      }
      ...
      if (hr != 0)
      {
        Log.Write("DVBGraphBDA: FAILED could not get node types from tuner:0x{0:X}", hr);
        return;
      }
      if (nodeTypeCount == 0)
      {
        Log.Write("DVBGraphBDA: FAILED could not get any node types");
      }
      ...
      for (int i = 0; i < nodeTypeCount; ++i)
      {
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphBDA: FAILED could not GetNodeInterfaces for node:{0} 0x:{1:X}", i, hr);
        }

        hr = topology.GetControlNode(0, 1, nodeTypes[i], out objectNode);
        if (hr != 0)
        {
          Log.Write("DVBGraphBDA: FAILED could not GetControlNode for node:{0} 0x:{1:X}", i, hr);
          return;
        }
          ...
          case NetworkType.ATSC:
            {
              ...
              {
                Log.Write("DVBGraphBDA: failed SubmitTuneRequest() tuningspace=null");
                return;
              }
              ...
              {
                Log.Write("DVBGraphBDA: failed SubmitTuneRequest() could not create new tuningrequest");
                return;
              }
              ...
              if (myLocator == null)
              {
                Log.Write("DVBGraphBDA:FAILED tuning to frequency:{0} kHz. cannot get IATSCLocator", ch.Frequency);
                return;
              }
              //set the properties on the new tuning request
              Log.Write("DVBGraphBDA:SubmitTuneRequest(ATSC) set tuning properties. Freq:{0} physical:{1} major:{2} minor:{3} SR:{4} mod:{5} tsid:{6}",
          ...
          case NetworkType.DVBC:
            {
              ...
              if (myLocator == null)
              {
                Log.Write("DVBGraphBDA:FAILED tuning to frequency:{0} kHz. cannot get locator", ch.Frequency);
                return;
              }
              //set the properties on the new tuning request
          ...
          case NetworkType.DVBS:
            {
              ...
              if (dvbSpace == null)
              {
                Log.Write("DVBGraphBDA: failed could not get IDVBSTuningSpace");
                return;
              }

              Log.Write("DVBGraphBDA: set LNBSwitch to {0} kHz lowOsc={1} MHz hiOsc={2} MHz disecq:{3}", ch.LnbSwitchFrequency, lowOsc, hiOsc, diseqcUsed);
              ...
              if (myLocator == null)
              {
                Log.Write("DVBGraphBDA: failed SubmitTuneRequest() could not get IDVBSLocator");
                return;
              }
          ...
          case NetworkType.DVBT:
            {
              ...
              if (myLocator == null)
              {
                Log.Write("DVBGraphBDA:FAILED tuning to frequency:{0} kHz ONID:{1} TSID:{2}, SID:{3}. cannot get locator", ch.Frequency, ch.NetworkID, ch.TransportStreamID, ch.ProgramNumber);
                return;
              }
              //set the properties on the new tuning request
              Log.Write("DVBGraphBDA:SubmitTuneRequest() frequency:{0} kHz Bandwidth:{1} ONID:{2} TSID:{3}, SID:{4}",
