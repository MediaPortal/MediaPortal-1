  ...
  public class DVBGraphSkyStar2 : DVBGraphBase
  {
    ...
    public override bool CreateGraph(int Quality)
    {
      try
      {
        ...
        Log.Write("DVBGraphSkyStar2:CreateGraph(). ");

        //no card defined? then we cannot build a graph
        if (_card == null)
        {
          Log.Write("DVBGraphSkyStar2:card is not defined");
          return false;
        }
        ...
        if (hr < 0)
        {
          Log.Write("DVBGraphSkyStar2:FAILED link :0x{0:X}", hr);
          return false;
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphSkyStar2:CreateGraph() create B2C2 adapter");
        ...
        {
          Log.Write("DVBGraphSkyStar2:creategraph() _filterB2C2Adapter not found");
          return false;
        }
        Log.Write("DVBGraphSkyStar2:creategraph() add filters to graph");
        hr = _graphBuilder.AddFilter(_filterB2C2Adapter, "B2C2-Source");
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2: FAILED to add B2C2-Adapter");
          return false;
        }
        // get interfaces
        ...
        //=========================================================================================================
        Log.Write("DVBGraphSkyStar2: Initialize Tuner()");
        hr = _interfaceB2C2TunerCtrl.Initialize();
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2: Tuner initialize failed:0x{0:X}", hr);
          return false;
        }
        ...
        */
        ...
        {
          Log.Write("DVBGraphSkyStar2:Failed to create Mpeg2 Demultiplexer");
          return false;
        }
        ...
        {
          Log.Write("DVBGraphSS2:FAILED to create sections pin:0x{0:X}", hr);
          return false;
        }

        Log.Write("DVBGraphSkyStar2: create audio/video output pin");
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2:FAILED to create video output pin on demuxer");
          return false;
        }
        hr = demuxer.CreateOutputPin(mpegAudioOut, "audio", out filterMpeg2DemuxerAudioPin);
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2: FAILED to create audio output pin on demuxer");
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2: FAILED to add SectionsFilter 0x{0:X}", hr);
          return false;
        }
        ...
        if (GUIGraphicsContext.DX9Device != null && _sampleInterface != null)
        {
          ...
          if (pinData0 == null)
          {
            Log.Write("DVBGraphSkyStar2:Failed to get pin 'Data 0' from B2BC source");
            return false;
          }
          ...
          if (pinIn == null)
          {
            Log.Write("DVBGraphSkyStar2:Failed to get input pin from sample grabber");
            return false;
          }
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:Failed to connect B2BC->sample grabber");
            return false;
          }
        }
        ...
        else
        {
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:Failed to connect B2BC->demuxer");
            return false;
          }
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphSkyStar2:CreateGraph() find audio/video pins");
              ...
              if (fetchedm == 1)
              {
                ...
                if (pinMediaType[0].majorType == MEDIATYPE_MPEG2_SECTIONS && !connected)
                {
                  ...
                  if (pinConnectedTo == null)
                  {
                    ...
                    {
                      Log.Write("DVBGraphSkyStar2:FAILED to connect mpeg2 demux->stream analyzer");
                    }
                    pin[0] = null;
                  }
                  if (pinConnectedTo != null)
        ...
        {
          //video pin not found
          Log.Write("DVBGraphSkyStar2:Failed to get pin (video out) from MPEG-2 Demultiplexer", _pinDemuxerVideo);
          return false;
        }
        if (_pinDemuxerAudio == null)
        {
          //audio pin not found
          Log.Write("DVBGraphSkyStar2:Failed to get pin (audio out)  from MPEG-2 Demultiplexer", _pinDemuxerAudio);
          return false;
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphSkyStar2:CreateGraph() create ac3/mpg1 pins");
        if (demuxer != null)
        {
          ...
          {
            Log.Write("DVBGraphSkyStar2:FAILED to create AC3 pin:0x{0:X}", hr);
          }

          //Log.Write("DVBGraphSkyStar2: create mpg1 audio pin");
          ...
          {
            Log.Write("DVBGraphSkyStar2:FAILED to create MPG1 pin:0x{0:X}", hr);
          }
          ...
          {
            Log.Write("DVBGraphSkyStar2:FAILED to create EPG pin:0x{0:X}", hr);
            return false;
          }
          hr = demuxer.CreateOutputPin(mtEPG, "MHW1", out _pinDemuxerMHWd2);
          if (hr != 0 || _pinDemuxerMHWd2 == null)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to create MHW1 pin:0x{0:X}", hr);
            return false;
          }
          hr = demuxer.CreateOutputPin(mtEPG, "MHW2", out _pinDemuxerMHWd3);
          if (hr != 0 || _pinDemuxerMHWd3 == null)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to create MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (pinMHW1In == null)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to get MHW1 pin on MSPA");
            return false;
          }
          IPin pinMHW2In = DsFindPin.ByDirection(_filterDvbAnalyzer, PinDirection.Input, 2);
          if (pinMHW2In == null)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to get MHW2 pin on MSPA");
            return false;
          }
          IPin pinEPGIn = DsFindPin.ByDirection(_filterDvbAnalyzer, PinDirection.Input, 3);
          if (pinEPGIn == null)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to get EPG pin on MSPA");
            return false;
          }
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to connect EPG pin:0x{0:X}", hr);
            return false;
          }
          hr = _graphBuilder.Connect(_pinDemuxerMHWd2, pinMHW1In);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to connect MHW1 pin:0x{0:X}", hr);
            return false;
          }
          hr = _graphBuilder.Connect(_pinDemuxerMHWd3, pinMHW2In);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:FAILED to connect MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          Log.Write("DVBGraphSkyStar2:mapped IMPEG2Demultiplexer not found");
    ...
    public override void DeleteGraph()
    {
      try
      {
        ...
        Log.Write("DVBGraphSkyStar2:DeleteGraph()");
        StopRecording();
        StopTimeShifting();
        StopViewing();
    ...
    protected override void SubmitTuneRequest(DVBChannel ch)
    {
      ...
      if (frequency > 13000)
        frequency /= 1000;
      Log.Write("DVBGraphSkyStar2:  Transponder Frequency:{0} MHz", frequency);
      int hr = _interfaceB2C2TunerCtrl.SetFrequency(frequency);
      if (hr != 0)
      {
        Log.Write("DVBGraphSkyStar2:SetFrequencyKHz() failed:0x{0:X}", hr);
        return;
      }
      ...
      switch (Network())
      {
        case NetworkType.ATSC:
          Log.Write("DVBGraphSkyStar2:  ATSC Channel:{0}", ch.PhysicalChannel);
          ...
          //Log.Write("DVBGraphSkyStar2:  Channel:{0} KHz", ch.Frequency);
          //hr = _interfaceB2C2TunerCtrl.SetChannel(ch.PhysicalChannel);
          Log.Write("DVBGraphSkyStar2:  ATSC Frequency:{0} MHz", atscfreq);
          hr = _interfaceB2C2TunerCtrl.SetFrequency(atscfreq);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetFrequency() failed:0x{0:X}", hr);
            return;
          }
          break;
        ...
        case NetworkType.DVBC:
          {
            Log.Write("DVBGraphSkyStar2:  SymbolRate:{0} KS/s", ch.Symbolrate);
            hr = _interfaceB2C2TunerCtrl.SetSymbolRate(ch.Symbolrate);
            if (hr != 0)
            {
              Log.Write("DVBGraphSkyStar2:SetSymbolRate() failed:0x{0:X}", hr);
              return;
            }
            ...
            Log.Write("DVBGraphSkyStar2:  Modulation:{0}", ((eModulationTAG)modulation));
            hr = _interfaceB2C2TunerCtrl.SetModulation(modulation);
            if (hr != 0)
            {
              Log.Write("DVBGraphSkyStar2:SetModulation() failed:0x{0:X}", hr);
              return;
            }
          }
          break;
        ...
        case NetworkType.DVBT:
          Log.Write("DVBGraphSkyStar2:  GuardInterval:auto");
          hr = _interfaceB2C2TunerCtrl.SetGuardInterval((int)GuardIntervalType.Interval_Auto);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetGuardInterval() failed:0x{0:X}", hr);
            return;
          }

          Log.Write("DVBGraphSkyStar2:  Bandwidth:{0} MHz", ch.Bandwidth);
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetBandwidth() failed:0x{0:X}", hr);
            return;
          }
          break;
        ...
        case NetworkType.DVBS:
          ...
          {
            Log.Write("DVBGraphSkyStar2:  Error: LNB Frequency must be less than Transponder frequency");
          }
          Log.Write("DVBGraphSkyStar2:  SymbolRate:{0} KS/s", ch.Symbolrate);
          hr = _interfaceB2C2TunerCtrl.SetSymbolRate(ch.Symbolrate);
          if (hr != 0)
          ...
          Log.Write("DVBGraphSkyStar2:  LNBFrequency:{0} MHz", ch.LNBFrequency);
          hr = _interfaceB2C2TunerCtrl.SetLnbFrequency(ch.LNBFrequency);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetLnbFrequency() failed:0x{0:X}", hr);
            return;
          }

          int fec = (int)FecType.Fec_Auto;
          Log.Write("DVBGraphSkyStar2:  Fec:{0} {1}", ((FecType)fec), fec);
          hr = _interfaceB2C2TunerCtrl.SetFec(fec);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetFec() failed:0x{0:X}", hr);
            return;
          }

          //0=horizontal,1=vertical
          Log.Write("DVBGraphSkyStar2:  Polarity:{0} {1}", ((PolarityType)ch.Polarity), ch.Polarity);
          hr = _interfaceB2C2TunerCtrl.SetPolarity(ch.Polarity);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetPolarity() failed:0x{0:X}", hr);
            return;
          }
          ...
          Log.Write("DVBGraphSkyStar2:  Lnb: {0} Khz", lnbKhzTone);
          hr = _interfaceB2C2TunerCtrl.SetLnbKHz((int)lnbSelection);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetLnbKHz() failed:0x{0:X}", hr);
            return;
          }
          ...
          Log.Write("DVBGraphSkyStar2:  Diseqc:{0} {1}", disType, (int)disType);
          hr = _interfaceB2C2TunerCtrl.SetDiseqc((int)disType);
          if (hr != 0)
          {
            Log.Write("DVBGraphSkyStar2:SetDiseqc() failed:0x{0:X}", hr);
            return;
          }
      ...
      {
        Log.Write("DVBGraphSkyStar2:could not lock tuner");
        //dump all values:
      ...
      else
      {
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2:SetTunerStatus failed:0x{0:X}", hr);
          return;
        }
      }
      _interfaceB2C2TunerCtrl.CheckLock();
    ...
    protected override void SendHWPids(ArrayList pids)
    {
      ...
      {
        Log.Write("DVBGraphSkyStar2:DeleteAllPIDs() failed pid:0x2000");
      }
      if (pids.Count == 0)
      {
        ...
        if (added != 1)
        {
          Log.Write("DVBGraphSkyStar2:SetPidToPin() failed pid:0x2000");
        }
      }
      else
      {
    ...
    DVBChannel LoadDiseqcSettings(DVBChannel ch, int disNo)
    {
      ...
      //Log.Write("auto-tune ss2: freq={0} lnbKHz={1} lnbFreq={2} diseqc={3}", ch.Frequency, ch.LnbSwitchFrequency, ch.LNBFrequency, ch.DiSEqC);
      Log.Write("auto-tune ss2: freq={0} lnbKHz={1} lnbFreq={2} diseqc={3}", ch.Frequency, lnbKhz, ch.LNBFrequency, ch.DiSEqC);
      return ch;
    ...
    protected override void SetupDiseqc(int disNo)
    {
      ...
      Log.Write("auto-tune ss2: freq={0} lnbKHz={1} lnbFreq={2} diseqc={3}", _currentTuningObject.Frequency, _currentTuningObject.LnbSwitchFrequency, _currentTuningObject.LNBFrequency, _currentTuningObject.DiSEqC);
    }// LoadDiseqcSettings()
    ...
    private void GetTunerCapabilities()
    {
      try
      {
        ...
        // add the skystar 2 specific filters
        //=========================================================================================================
        Log.Write("DVBGraphSkyStar2:GetTunerCapabilities() create B2C2 adapter");
        _filterB2C2Adapter = (IBaseFilter)Activator.CreateInstance(Type.GetTypeFromCLSID(DVBSkyStar2Helper.CLSID_B2C2Adapter, false));
        if (_filterB2C2Adapter == null)
        {
          Log.Write("DVBGraphSkyStar2:GetTunerCapabilities() _filterB2C2Adapter not found");
          return;
        }
        _interfaceB2C2TunerCtrl = _filterB2C2Adapter as DVBSkyStar2Helper.IB2C2MPEG2TunerCtrl2;
        if (_interfaceB2C2TunerCtrl == null)
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphSkyStar2: Tuner Type failed:0x{0:X}", hr);
          return;
        }
