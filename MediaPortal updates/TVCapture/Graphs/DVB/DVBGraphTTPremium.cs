  ...
  public class DVBGraphTTPremium : DVBGraphBase
  {
    ...
    public override bool CreateGraph(int Quality)
    {
      try
      {
        ...
        Log.Write("DVBGraphTTPremium:CreateGraph(). ");

        //no card defined? then we cannot build a graph
        if (_card == null)
        {
          Log.Write("DVBGraphTTPremium:card is not defined");
          return false;
        }
        ...
        if (hr < 0)
        {
          Log.Write("DVBGraphTTPremium:FAILED link :0x{0:X}", hr);
          return false;
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphTTPremium:CreateGraph() create TTPremium source filter");
        ...
        {
          Log.Write("DVBGraphTTPremium:creategraph() _filterTTPremium not found");
          return false;
        }
        Log.Write("DVBGraphTTPremium:creategraph() add filters to graph");
        hr = _graphBuilder.AddFilter(_filterTTPremium, "TTPremiumSource");
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium: FAILED to add TTPremium source filter to graph");
          return false;
        }
        ...
        {
          Log.Write("DVBGraphTTPremium: cannot get ITTPremiumSource");
          return false;
        }
        ...
        // initialize tuner
        //=========================================================================================================
        Log.Write("DVBGraphTTPremium: Initialize Tuner()");
        hr = _interfaceTTPremium.Init();
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium: Tuner initialize failed:0x{0:X}", hr);
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium: Network Type failed:0x{0:X}", hr);
          return false;
        }
        ...
        */
        ...
        {
          Log.Write("DVBGraphTTPremium:Failed to get Mpeg2 Demultiplexer");
          return false;
        }
        ...
        {
          Log.Write("DVBGraphTTPremium:FAILED to create sections pin:0x{0:X}", hr);
          return false;
        }

        Log.Write("DVBGraphTTPremium: create audio/video output pin");
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium:FAILED to create video output pin on demuxer");
          return false;
        }
        hr = demuxer.CreateOutputPin(mpegAudioOut, "audio", out filterMpeg2DemuxerAudioPin);
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium: FAILED to create audio output pin on demuxer");
          return false;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium: FAILED to add SectionsFilter 0x{0:X}", hr);
          return false;
        }
        ...
        if (GUIGraphicsContext.DX9Device != null && _sampleInterface != null)
        {
          ...
          if (pinData0 == null)
          {
            Log.Write("DVBGraphTTPremium:Failed to get pin 'output' from TTPremium source");
            return false;
          }
          ...
          if (pinIn == null)
          {
            Log.Write("DVBGraphTTPremium:Failed to get input pin from sample grabber");
            return false;
          }
          ...
          if (hr != 0)
          {
            Log.Write("DVBGraphTTPremium:Failed to connect TTPremium->sample grabber");
            return false;
          }
          ...
          {
            Log.Write("DVBGraphTTPremium:Failed to connect samplegrabber filter->mpeg2 demultiplexer");
            return false;
          }*/
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphTTPremium:CreateGraph() find audio/video pins");
        ...
        {
          //video pin not found
          Log.Write("DVBGraphTTPremium:Failed to get pin (video out) from MPEG-2 Demultiplexer", _pinDemuxerVideo);
          return false;
        }
        if (_pinDemuxerAudio == null)
        {
          //audio pin not found
          Log.Write("DVBGraphTTPremium:Failed to get pin (audio out)  from MPEG-2 Demultiplexer", _pinDemuxerAudio);
          return false;
        }
        ...
        //=========================================================================================================
        Log.Write("DVBGraphTTPremium:CreateGraph() create ac3/mpg1 pins");
        if (demuxer != null)
        {
          ...
          {
            Log.Write("DVBGraphTTPremium:FAILED to create AC3 pin:0x{0:X}", hr);
          }
          ...
          {
            Log.Write("DVBGraphTTPremium:FAILED to create MPG1 pin:0x{0:X}", hr);
          }
          ...
          {
            Log.Write("DVBGraphTTPremium:FAILED to create EPG pin:0x{0:X}", hr);
            return false;
          }
          hr = demuxer.CreateOutputPin(mtEPG, "MHW1", out _pinDemuxerMHWd2);
          if (hr != 0 || _pinDemuxerMHWd2 == null)
          {
            Log.Write("DVBGraphTTPremium:FAILED to create MHW1 pin:0x{0:X}", hr);
            return false;
          }
          hr = demuxer.CreateOutputPin(mtEPG, "MHW2", out _pinDemuxerMHWd3);
          if (hr != 0 || _pinDemuxerMHWd3 == null)
          {
            Log.Write("DVBGraphTTPremium:FAILED to create MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          {
            Log.Write("DVBGraphTTPremium:FAILED to get Input pin on MSPA");
            return false;
          }
          ...
          if (pinMHW1In == null)
          {
            Log.Write("DVBGraphTTPremium:FAILED to get MHW1 pin on MSPA");
            return false;
          }
          IPin pinMHW2In = DsFindPin.ByDirection(_filterDvbAnalyzer, PinDirection.Input, 2);
          if (pinMHW2In == null)
          {
            Log.Write("DVBGraphTTPremium:FAILED to get MHW2 pin on MSPA");
            return false;
          }
          IPin pinEPGIn = DsFindPin.ByDirection(_filterDvbAnalyzer, PinDirection.Input, 3);
          if (pinEPGIn == null)
          {
            Log.Write("DVBGraphTTPremium:FAILED to get EPG pin on MSPA");
            return false;
          }
          ...
          {
              Log.Write("DVBGraphTTPremium:FAILED to connect mpeg2 demux->stream analyzer");
          }

          hr = _graphBuilder.Connect(_pinDemuxerEPG, pinEPGIn);
          if (hr != 0)
          {
            Log.Write("DVBGraphTTPremium:FAILED to connect EPG pin:0x{0:X}", hr);
            return false;
          }
          hr = _graphBuilder.Connect(_pinDemuxerMHWd2, pinMHW1In);
          if (hr != 0)
          {
            Log.Write("DVBGraphTTPremium:FAILED to connect MHW1 pin:0x{0:X}", hr);
            return false;
          }
          hr = _graphBuilder.Connect(_pinDemuxerMHWd3, pinMHW2In);
          if (hr != 0)
          {
            Log.Write("DVBGraphTTPremium:FAILED to connect MHW2 pin:0x{0:X}", hr);
            return false;
          }
          ...
          if (GUIGraphicsContext.DX9Device != null)
          {
            ...
            {
              Log.Write("DVBGraphTTPremium:FAILED to create ttx pin:0x{0:X}", hr);
              return false;
            }
            ...
            if (pinIn == null)
            {
              Log.Write("DVBGraphTTPremium:unable to find sample grabber input:0x{0:X}", hr);
              return false;
            }
            hr = _graphBuilder.Connect(_pinTeletext, pinIn);
            if (hr != 0)
            {
              Log.Write("DVBGraphTTPremium:FAILED to connect demux->sample grabber:0x{0:X}", hr);
              return false;
            }
          }
        }
        ...
        {
          Log.Write("DVBGraphTTPremium:mapped IMPEG2Demultiplexer not found");
        }
    ...
    public override void DeleteGraph()
    {
      try
      {
        ...
        Log.Write("DVBGraphTTPremium:DeleteGraph()");
        StopRecording();
        StopTimeShifting();
        StopViewing();
    ...
    protected override void SubmitTuneRequest(DVBChannel ch)
    {
      ...
      if (_networkType == NetworkType.DVBC || _networkType == NetworkType.DVBT)
      {
        switch ((ModulationType)ch.Modulation)
        {
          ...
          default:
            Log.Write("DVBGraphTTPremium:SubmitTureRequest(), unsupported modulation type:{0}", (ModulationType)ch.Modulation);
            break;
        }
        ...
        switch (ch.Bandwidth)
        {
          ...
          default:
            Log.Write("DVBGraphTTPremium:SubmitTureRequest(), unsupported bandwidth:{0}mhz", ch.Bandwidth);
            break;
        }
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium:SubmitTureRequest(), filter tune request failed:{0}", hr);
        }
      }
      else if (_networkType == NetworkType.DVBS)
      {
        ...
        if (hr != 0)
        {
          Log.Write("DVBGraphTTPremium:SubmitTuneRequest(), filter tune request failed:{0},{1},{2},{3},{4},{5},{6},{7},{8}", ch.Frequency, ch.Symbolrate, ch.Polarity, ch.LnbSwitchFrequency, ch.LNBFrequency, true, diseq, mod, bw, false);
          _signalPresent = false;
          _signalQuality = 0;
          _signalLevel = 0;
          return;
     ...
     protected void DeleteAllPids(int pinIndex)
    {
      ...
      if (pin == null)
      {
        Log.Write("DVBGraphTTPremium:DeleteAllPids(), couldn't find pin:{0}", pinIndex);
      }
      ...
      if (hr != 0)
      {
        Log.Write("DVBGraphTTPremium:DeleteAllPids(), couldn't enumerate PIDs on pin:{0}, hr:{1}", pinIndex, hr);
      }
      ...
      if (hr != 0)
      {
        Log.Write("DVBGraphTTPremium:DeleteAllPids(), couldn't delete PIDs on pin:{0}, hr:{1}", pinIndex, hr);
      }
    }
  }
}