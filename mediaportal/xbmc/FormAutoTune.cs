...
{
	/// <summary>
	/// Summary description for FormAutoTune.
	/// </summary>
	public class FormAutoTune : System.Windows.Forms.Form
	{
    ...
    ArrayList tvchannels = new ArrayList();
      ...
      System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FormAutoTune));
      ...
      this.Name = "FormAutoTune";
      this.Text = "FormAutoTune";
      this.Closing += new System.ComponentModel.CancelEventHandler(this.FormAutoTune_Closing);
      this.Load += new System.EventHandler(this.FormAutoTune_Load);
    ...
    private void timer1_Tick(object sender, System.EventArgs e)
    {
      ...
      else
      {
        ...
        try
        {
          ...
          m_card.TVTuner.Channel=m_iChannel;
          this.labelFreq.Text=String.Format("{0} MHz", ((float)m_card.TVTuner.GetVideoFrequency)/1000000f);
        }
        catch(Exception)
        {
        }*/
    ...
    void AddChannel(int Channel, int Frequency)
    {
      ...
      {
        if (chan.Frequency==Frequency) return;
        if (chan.Number==Channel) return;
      }
      TVChannel newChan= new TVChannel();
      newChan.Name=String.Format("Auto {0:00}",Channel);
      newChan.Frequency=Frequency;
      newChan.Number=Channel;
      newChan.ID=-1;
      newChan.XMLId="";
    ...
    private void FormAutoTune_Load(object sender, System.EventArgs e)
    {
      ...
      foreach (TVCaptureDevice card in cards)
      {
        ...
        {
          card.StartCapture("",1);
          if (card.TVTuner !=null)
          {
            int[] minmaxchan=card.TVTuner.ChanelMinMax;
    ...
    private void FormAutoTune_Closing(object sender, System.ComponentModel.CancelEventArgs e)
    {
      if (m_card!=null)
      {
        //m_card.StopCapture();
