...
namespace MediaPortal
{
    ...
    /// <summary>
      ...
      SetupCapture();
		...
		private void InitializeComponent()
		{
			...
			// textEditBox
			// 
			this.textEditBox.Location = new System.Drawing.Point(464, 240);
			this.textEditBox.Name = "textEditBox";
			this.textEditBox.TabIndex = 15;
			...
			// btnRecPath
			// 
			this.btnRecPath.Location = new System.Drawing.Point(400, 344);
			...
			// textBoxRecPath
			// 
			this.textBoxRecPath.Location = new System.Drawing.Point(40, 344);
			...
			this.comboAudioPlayer.Name = "comboAudioPlauer";
			this.comboAudioPlayer.Size = new System.Drawing.Size(230, 21);
			this.comboAudioPlayer.TabIndex = 0;
			// 
			// label30
			// 
    ...
    private void bntSelectMovieFile_Click(object sender, System.EventArgs e)
    {
      ...
      txtboxAudioFiles.Text=xmlreader.GetValueAsString("music","extensions",".mp3,.wma,.ogg,.flac,.wav");
			...
			txtboxVideoFiles.Text=xmlreader.GetValueAsString("movies","extensions",".avi,.mpg,.ogm,.mpeg,.mkv,.wmv,.ifo,.qt,.rm");
    ...
    void SaveCapture(AMS.Profile.Xml xmlWriter)
    {
      ...
      for (int i=0; i < listTVChannels.Items.Count;++i)
      {
        try
        {
          ...
          if (iNumber <254)
          {
            dbs.SetChannelNumber(strChannel,iNumber);
            dbs.SetChannelFrequency(strChannel,strFreq);
            dbs.SetChannelSort(strChannel,i);
          }
        }
        catch(Exception)
        {
