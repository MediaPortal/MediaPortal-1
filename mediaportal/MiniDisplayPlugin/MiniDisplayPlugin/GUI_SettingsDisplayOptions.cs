namespace CybrDisplayPlugin
{
    ...
    public class GUI_SettingsDisplayOptions : GUIWindow
    {
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsDisplayOptions.OnAdded(): Window {0} added to window manager", new object[] { this.GetID });
            base.OnAdded();
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            GUIPropertyManager.SetProperty("#currentmodule", "CybrDisplay Display Options");
        }
