namespace CybrDisplayPlugin
{
    ...
    public class XMLUTILS
    {
        ...
        public static string Create_GUI_Menu(GUIMenu WhichMenu)
        {
            ...
            string str4 = "CybrDisplay - " + Settings.Instance.Type;
            ...
            else
            {
                ...
                if (parentNode == null)
                {
                    Log.Info("CybrDisplay.XMLUTILS.Create_GUI_Menu():  Skin Template not compatible! Can not create menu file \"{0}\".", new object[] { str2 });
                    return string.Empty;
                }
            }
        ...
        public static void Delete_GUI_Menu(GUIMenu WhichMenu)
        {
            ...
            {
                File.Delete(path);
                Log.Info("CybrDisplay.XMLUTILS.Delete_GUI_Menu(): Deleted \"{0}\"", new object[] { path });
            }
            catch
            {
                Log.Info("CybrDisplay.XMLUTILS.Delete_GUI_Menu(): COULD NOT DELETE \"{0}\"", new object[] { path });
            }
        }
        ...
        public static string Get_GUI_Menu_Filename(GUIMenu WhichMenu)
        {
            ...
            {
                case GUIMenu.MainMenu:
                    str = @"\CybrDisplay_GUI_Setup.xml";
                    break;

                case GUIMenu.DisplayOptions:
                    str = @"\CybrDisplay_GUI_DisplayOptions.xml";
                    break;

                case GUIMenu.DisplayControl:
                    str = @"\CybrDisplay_GUI_DisplayControl.xml";
                    break;

                case GUIMenu.Equalizer:
                    str = @"\CybrDisplay_GUI_Equalizer.xml";
                    break;

                case GUIMenu.Remote:
                    str = @"\CybrDisplay_GUI_Remote.xml";
                    break;

                case GUIMenu.BackLight:
                    str = @"\CybrDisplay_GUI_BackLight.xml";
                    break;

                case GUIMenu.KeyPad:
                    str = @"\CybrDisplay_GUI_Keypad.xml";
                    break;

                case GUIMenu.Fan:
                    str = @"\CybrDisplay_GUI_Fan.xml";
                    break;
