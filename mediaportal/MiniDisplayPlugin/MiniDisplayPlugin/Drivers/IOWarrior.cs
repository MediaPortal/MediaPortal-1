namespace CybrDisplayPlugin.Drivers
{
    ...
    public class IOWarrior : BaseDisplay, IDisplay, IDisposable
    {
        ...
        private void LoadAdvancedSettings()
        {
            ...
            FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml"));
        ...
        private void UpdateAdvancedSettings()
        {
            if (DateTime.Now.Ticks >= this.LastSettingsCheck.AddMinutes(1.0).Ticks)
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml")))
                {
                    FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml"));
        ...
        public class AdvancedSettings
        {
            ...
            public static IOWarrior.AdvancedSettings Load()
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml")))
                {
                    ...
                    XmlTextReader xmlReader = new XmlTextReader(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml"));
            ...
            public static void Save(IOWarrior.AdvancedSettings ToSave)
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(IOWarrior.AdvancedSettings));
                XmlTextWriter writer = new XmlTextWriter(Config.GetFile(Config.Dir.Config, "CybrDisplay_IOWarrior.xml"), Encoding.UTF8);
            ...
            public bool OpenDisplay(IOWarrior.AdvancedSettings UseSettings)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        this.IOW_ClearDisplay();
                        this.IOW_Surface = new Bitmap(CybrDisplayPlugin.Settings.Instance.GraphicWidth, CybrDisplayPlugin.Settings.Instance.GraphicHeight);
                        this.IOW_Graphics = Graphics.FromImage(this.IOW_Surface);
                        this._isOpen = true;
