namespace CybrDisplayPlugin.Drivers
{
    ...
    public class GenericSerial : BaseDisplay, IDisplay, IDisposable
    {
        ...
        private void LoadAdvancedSettings()
        {
            ...
            FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml"));
        ...
        private void UpdateAdvancedSettings()
        {
            if (DateTime.Now.Ticks >= this.LastSettingsCheck.AddMinutes(1.0).Ticks)
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml")))
                {
                    FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml"));
        ...
        public class AdvancedSettings
        {
            ...
            public static GenericSerial.AdvancedSettings Load()
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml")))
                {
                    ...
                    XmlTextReader xmlReader = new XmlTextReader(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml"));
            ...
            public static void Save(GenericSerial.AdvancedSettings ToSave)
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(GenericSerial.AdvancedSettings));
                XmlTextWriter writer = new XmlTextWriter(Config.GetFile(Config.Dir.Config, "CybrDisplay_GenericSerial.xml"), Encoding.UTF8);
