namespace CybrDisplayPlugin.Drivers
{
    ...
    public class MatrixMX : BaseDisplay, IDisplay, IDisposable
    {
        ...
        private void LoadAdvancedSettings()
        {
            ...
            FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml"));
        ...
        private void UpdateAdvancedSettings()
        {
            if (DateTime.Now.Ticks >= this.LastSettingsCheck.AddMinutes(1.0).Ticks)
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml")))
                {
                    FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml"));
        ...
        public class AdvancedSettings
        {
            ...
            public static MatrixMX.AdvancedSettings Load()
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml")))
                {
                    ...
                    XmlTextReader xmlReader = new XmlTextReader(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml"));
            ...
            public static void Save(MatrixMX.AdvancedSettings ToSave)
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(MatrixMX.AdvancedSettings));
                XmlTextWriter writer = new XmlTextWriter(Config.GetFile(Config.Dir.Config, "CybrDisplay_MatrixMX.xml"), Encoding.UTF8);
                writer.Formatting = Formatting.Indented;
