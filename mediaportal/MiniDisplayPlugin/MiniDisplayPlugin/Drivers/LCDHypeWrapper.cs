namespace CybrDisplayPlugin.Drivers
{
    ...
    public class LCDHypeWrapper : BaseDisplay, IDisplay, IDisposable
    {
        ...
        private void CreateLCDHypeWrapper()
        {
            ...
            MethodBuilder builder3 = builder2.DefinePInvokeMethod("DLL_GetInfo", this.dllFile, MethodAttributes.PinvokeImpl | MethodAttributes.HideBySig | MethodAttributes.Static | MethodAttributes.Public, CallingConventions.Standard, typeof(void), new System.Type[] { System.Type.GetType("CybrDisplayPlugin.Drivers.LCDHypeWrapper+DLLInfo&") }, CallingConvention.StdCall, CharSet.Auto);
        ...
        private void LoadAdvancedSettings()
        {
            ...
            FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml"));
        ...
        private void UpdateAdvancedSettings()
        {
            if (DateTime.Now.Ticks >= this.LastSettingsCheck.AddMinutes(1.0).Ticks)
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml")))
                {
                    FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml"));
        ...
        public class AdvancedSettings
        {
            ...
            public static LCDHypeWrapper.AdvancedSettings Load()
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml")))
                {
                    ...
                    XmlTextReader xmlReader = new XmlTextReader(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml"));
            ...
            public static void Save(LCDHypeWrapper.AdvancedSettings ToSave)
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(LCDHypeWrapper.AdvancedSettings));
                XmlTextWriter writer = new XmlTextWriter(Config.GetFile(Config.Dir.Config, "CybrDisplay_LCDHypeWrapper.xml"), Encoding.UTF8);
