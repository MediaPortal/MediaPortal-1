...
namespace ProcessPlugins.ExternalDisplay
{
  ...
  public class MediaPad : IDisplay
  {
    ...
    [DllImport("MediaPadLayer.dll", EntryPoint="clearScreen", CharSet=CharSet.Ansi, SetLastError=true, ExactSpelling=true)]
...
//
    ...
    [DllImport("MediaPadLayer.dll", EntryPoint="getMediapadUID", CharSet=CharSet.Ansi, SetLastError=true, ExactSpelling=true)]
...
//    /// <summary>
//    /// Registers a window to receive the Clear Screen key event, 
...
//    private static extern Status SetIconState(double lcdUid, IconConst icon, IconState state);
    ...
    private static extern Status SetLine(double lcdUid, short line, [MarshalAs(UnmanagedType.VBByRefStr)] ref string text, DisplayMode mode);
