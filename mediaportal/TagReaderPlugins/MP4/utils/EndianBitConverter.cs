...
namespace MediaPortal.TagReader.MP4.MiscUtil.Conversion
{
	...
	public abstract class EndianBitConverter
	{
		...
		/// <summary>
		/// Returns a 64-bit signed integer converted from two bytes at a specified position in a byte array.
		/// </summary>
		/// <param name="value">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		...
		/// <param name="value">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		/// <returns>A decimal  formed by eight bytes beginning at startIndex.</returns>
		...
		void CopyBytes(long value, int bytes, byte[] buffer, int index)
		{
			...
			{
				throw new IndexOutOfRangeException("Buffer not big enough for value");
			}
