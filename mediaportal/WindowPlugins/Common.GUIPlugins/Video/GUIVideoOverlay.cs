...
namespace MediaPortal.GUI.Video
{
  ...
  public class GUIVideoOverlay : GUIInternalOverlayWindow, IRenderLayer
  {
    ...
    private void SetCurrentFile(string fileName)
    {
      ...
      {
        GUIPropertyManager.SetProperty("#Play.Current.VideoCodec.Texture", Util.Utils.MakeFileName(g_Player.MediaInfo.BestVideoStream?.Codec.ToString() ?? string.Empty));
        GUIPropertyManager.SetProperty("#Play.Current.VideoResolution", g_Player.MediaInfo.VideoResolution);
        GUIPropertyManager.SetProperty("#Play.Current.AudioCodec.Texture", Util.Utils.MakeFileName(g_Player.MediaInfo.BestAudioStream?.Codec.ToString() ?? string.Empty));
