    ...
    protected override void LoadSettings()
    {
      ...
      using (Profile.Settings xmlreader = new Profile.MPSettings())
      {
        ...
        for (int i = 0; i < VirtualDirectory.MaxSharesCount; i++)
        {
          ...
          share.Pincode = Util.Utils.DecryptPasssword(xmlreader.GetValueAsString("music", strPincode, string.Empty));
          ...
          share.FtpPassword = Util.Utils.DecryptPasssword(xmlreader.GetValueAsString("music", sharePwd, string.Empty));
