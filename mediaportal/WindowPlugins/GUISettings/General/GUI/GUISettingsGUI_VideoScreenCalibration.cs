...
namespace MediaPortal.GUI.Settings
{
  ...
  public class GUISettingsMovieCalibration : GUIInternalWindow
  {
    ...
    {
      GetID = (int)Window.WINDOW_MOVIE_CALIBRATION; //11
    }

    public override bool Init()
    {
      return Load(GUIGraphicsContext.GetThemedSkinFile(@"\settings_GUI_VideoScreenCalibration.xml"));
    }
    ...
    {
      base.OnPageLoad();
      GUIPropertyManager.SetProperty("#currentmodule", GUILocalizeStrings.Get(100011));
