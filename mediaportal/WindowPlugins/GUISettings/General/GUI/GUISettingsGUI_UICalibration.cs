...
namespace MediaPortal.GUI.Settings
{
  ...
  public class GUISettingsUICalibration : GUIInternalWindow
  {
    ...
    {
      GetID = (int)Window.WINDOW_UI_CALIBRATION; //10
    }

    public override bool Init()
    {
      return Load(GUIGraphicsContext.GetThemedSkinFile(@"\settings_GUI_UICalibration.xml"));
    }
    ...
    {
      base.OnPageLoad();
      GUIPropertyManager.SetProperty("#currentmodule", GUILocalizeStrings.Get(100010));
