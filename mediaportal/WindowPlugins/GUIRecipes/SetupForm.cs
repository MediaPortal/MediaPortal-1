...
namespace GUIRecipes
{
  ...
  public class SetupForm : System.Windows.Forms.Form
  {
    ...
    private MediaPortal.UserInterface.Controls.MPButton button4;
    ...
    private MediaPortal.UserInterface.Controls.MPTextBox textFileCat;
    private MediaPortal.UserInterface.Controls.MPLabel lblNumber;
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.lblNumber = new MediaPortal.UserInterface.Controls.MPLabel();
      this.SuspendLayout();
      // 
      // label1
      // 
