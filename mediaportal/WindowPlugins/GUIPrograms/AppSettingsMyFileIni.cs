...
namespace WindowPlugins.GUIPrograms
{
  public class AppSettingsMyFileIni : AppSettings
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.lblContent = new MediaPortal.UserInterface.Controls.MPLabel();
      this.cbContentProfile = new MediaPortal.UserInterface.Controls.MPComboBox();
    ...
    public override void Form2AppObj(AppItem curApp)
    {
      ...
      // Log.Info(" dw: wrote contentID {0}", curApp.ContentID);
    }
