...
namespace Mpeg2SplitterPackage
{
	...
	{ 
        ...
        public int      e_sec;
        public int      e_hour;
        public double   e_mili;
        public int      type;
        public Int64    s_Mpeg2TimeStamp33Bit;
        public Int64    e_Mpeg2TimeStamp33Bit;
	}; 
    ...
    class Mpeg2Splitter
    {
        ...
        //ER		   TRACE("Warning : MPEG2 bit is not signald\n");
            ...
            scr_base = ((Int64)system_clock_reference_base_0 << 30) | 
		               ((Int64)(system_clock_reference_base_1) << 15) | 
                        (Int64)(system_clock_reference_base_2);
