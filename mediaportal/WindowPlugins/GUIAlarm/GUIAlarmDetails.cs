...
namespace MediaPortal.GUI.Alarm
{
  ...
  public class GUIAlarmDetails : GUIWindow, IDisposable
  {
    ...
    [SkinControl(4)] protected GUISelectButtonControl btnMediaType;
    [SkinControl(24)] protected GUISelectButtonControl btnAlarmType;
...
//					}
    ...
    private void LoadSettings()
    {
      ...
      GUIMessage msg = new GUIMessage(GUIMessage.MessageType.GUI_MSG_ITEM_SELECT, 0, 0, (int) Controls.AlarmTypeButton,
                                      (int) _CurrentAlarm.AlarmOccurrenceType, 0, null);
      ((GUISelectButtonControl) GetControl((int) Controls.AlarmTypeButton)).OnMessage(msg);

      msg = new GUIMessage(GUIMessage.MessageType.GUI_MSG_ITEM_SELECT, 0, 0, (int) Controls.PlayType,
                           (int) _CurrentAlarm.AlarmMediaType, 0, null);
    ...
    private void SaveSettings()
    {
      ...
      DateTime AlarmDate = new DateTime(ctlAlarmYear.Value, ctlAlarmMonth.Value, ctlAlarmDay.Value, ctlAlarmHour.Value,
                                        ctlAlarmMinute.Value, 0);
