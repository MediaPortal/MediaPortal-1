...
namespace MediaPortal.GUI.WeatherOverlay
{
    ...
    public class MyWeatherOverlay : GUIOverlayWindow, IRenderLayer, ISetupForm
    {
        ...
        public override bool Init()
        {
            ...
            GUIFadeLabel lblCurrentTemp = (GUIFadeLabel)GetControl((int)Controls.CONTROL_CURRENT_TEMP);
            GUIFadeLabel lblLocation = (GUIFadeLabel)GetControl((int)Controls.CONTROL_LOCATION);
            GUIFadeLabel lblWeatherDescription = (GUIFadeLabel)GetControl((int)Controls.CONTROL_WEATHER_DESCRIPTION);
            GUIImage imgImage = (GUIImage)GetControl((int)Controls.CONTROL_CURRENT_IMAGE);
            if (LoadWeather(@"weather\curWeather.xml"))
            {
                GUIControl.SetControlLabel(GetID, (int)Controls.CONTROL_CURRENT_TEMP, _nowTemp);
                GUIControl.SetControlLabel(GetID, (int)Controls.CONTROL_LOCATION, _nowLocation);
                GUIControl.SetControlLabel(GetID, (int)Controls.CONTROL_WEATHER_DESCRIPTION, _nowCond);
