...
namespace MediaPortal.GUI.Library
{
  ...
  public class GUIMessage
  {
    public enum MessageType
    {
      ...
      GUI_MSG_VIDEOFILE_DELETED = 110,
      GUI_MSG_VIDEODIRECTORY_DELETED = 111,
      GUI_MSG_VIDEOFILE_RENAMED = 112,
      GUI_MSG_VIDEODIRECTORY_RENAMED = 113,
      GUI_MSG_VIDEOFILE_CREATED = 114,
      GUI_MSG_VIDEODIRECTORY_CREATED = 115,
      GUI_MSG_VIDEODIRECTORY_REFRESH = 116,
      GUI_MSG_VIDEODATABASE_REFRESH = 117,
      PS_ONSTANDBY = 9999
    } ;
