...
namespace MediaPortal.GUI.Library
{
  ...
  public class GUIThumbnailPanel : GUIControl
  {
    ...
    private void RenderText(float fPosX, float fPosY, long dwTextColor, string wszText, bool bScroll)
    {
      ...
      if (!((int)fPosCX >= 0 && (int)fPosCY >= 0 && (int)(fwidth) >= 0 && (int)(fHeight) >= 0))
      {
        return;
      }
    ...
    /// <param name="strLabel"></param>
    /// <param name="strLabel2"></param>
    /// <param name="strThumbnail"></param>
    /// <param name="strIndex"></param>
    /// <param name="tag"></param>
    /// <returns></returns>
    public int GetSelectedItem(ref string strLabel, ref string strLabel2, ref string strThumbnail, ref string strIndex, ref TagReader.MusicTag tag)
    {
      strLabel = "";
      strLabel2 = "";
      strThumbnail = "";
