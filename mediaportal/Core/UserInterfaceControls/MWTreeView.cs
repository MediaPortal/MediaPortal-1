      ...
      if (this.MultiSelect != TreeViewMultiSelect.Classic)
      {
        ...
        if (this.AllowRubberbandSelect)
        {
              ...
              IsMouseMoveSelect)
          {
            ...
            Rectangle rctInvalidate1 = new Rectangle(this.ClientRectangle.Left, ptMouseDown.Y,
                                                     this.ClientRectangle.Width, ptMouseMoveClient.Y - ptMouseDown.Y);
            ...
            Rectangle rctInvalidate2 = new Rectangle(this.ClientRectangle.Left, ptMouseDown.Y,
                                                     this.ClientRectangle.Width, e.Y - ptMouseDown.Y);
          ...
          else if (bRubberbandHasBeenPainted)
          {
            ControlPaint.DrawReversibleFrame(
              new Rectangle(ptMouseDownScreen.X, ptMouseDownScreen.Y, ptMouseMoveScreen.X - ptMouseDownScreen.X,
                            ptMouseMoveScreen.Y - ptMouseDownScreen.Y), this.BackColor, FrameStyle.Dashed);
