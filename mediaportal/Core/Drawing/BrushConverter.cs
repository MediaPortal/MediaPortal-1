...
//			return new LinearGradientBrush(sc, ec, new Point(0, 0.5), new Point(1, 0.5));
    ...
    private Brush ParseLinearGradient(StringTokenizer tokens)
    {
      ...
      Point sp = new Point(Convert.ToDouble(spxy[0], CultureInfo.CurrentCulture),
                           Convert.ToDouble(spxy[1], CultureInfo.CurrentCulture));
      Point ep = new Point(Convert.ToDouble(epxy[0], CultureInfo.CurrentCulture),
                           Convert.ToDouble(epxy[1], CultureInfo.CurrentCulture));
