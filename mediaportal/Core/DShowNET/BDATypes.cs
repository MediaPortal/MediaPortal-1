...
namespace DShowNET.BDA
{
	...
	{
		public ulong                   ExtendedHeaderSize; // Size of this extended header
		public int	                   dwFrameFlags;  //
		public ulong                   ulEvent; //
		public ulong                   ulChannelNumber; //
		public ulong                   ulSubchannelNumber; //
		public ulong                   ulReason; //
	}
	...
	{
		public byte[]	rgbAddress;
	}

	public struct BDA_ETHERNET_ADDRESS_LIST 
	{
		public ulong               ulcAddresses;
	...
	{
		public ulong               ulBdaNodeType;	// The node type as it is used
		// in the BDA template topology

		public Guid                guidFunction;	// GUID from BdaMedia.h describing
		// the node's function (e.g.
		// KSNODE_BDA_RF_TUNER)

		public Guid                guidName;	// GUID that can be use to look up
	...
	{
		public ulong               ulPrimarySectionId;
		public ulong               ulSecondarySectionId;
		public ulong               ulcbSectionLength;
		public ulong[]             argbSectionData;
	}
	...
	{
		public MEDIA_SAMPLE_CONTENT    MediaSampleContent;
		public ulong                   ulcPIDs;
		public ulong[]                 aulPIDs;
	}
	...
	{
		public ulong	ulFormat;
		public ulong	ulbcDesc;
		public ulong[]	ulDesc;
	}

	public struct BDA_PROGRAM_PID_LIST
	{
		public ulong	ulProgramNumber;
		public ulong	ulcPIDs;
		public ulong[]	ulPID;
	}
	...
	public class BDATypes 
	{
		...
		public static int BDA_UNDEFINED_CHANNEL					= -1;

		//  Settings for Tuner Frequency
		//
		public static int BDA_FREQUENCY_NOT_SET					= -1;
		public static int BDA_FREQUENCY_NOT_DEFINED				= 0;
		...
		//
		public static int BDA_RANGE_NOT_SET						= -1;
		public static int BDA_RANGE_NOT_DEFINED					= 0;

		//  Settings for Tuner Channel Bandwidth
		//
		public static int BDA_CHAN_BANDWITH_NOT_SET				= -1;
		public static int BDA_CHAN_BANDWITH_NOT_DEFINED			= 0;

		//  Settings for Tuner Frequency Multiplier
		//
		public static int BDA_FREQUENCY_MULTIPLIER_NOT_SET		= -1;
		public static int BDA_FREQUENCY_MULTIPLIER_NOT_DEFINED	= 0;
	}
