...
namespace System.Windows.Controls
{
  public sealed class ContextMenuService
  {
    ...
    {
      ContextMenuClosingEvent = EventManager.RegisterRoutedEvent("ContextMenuClosing", RoutingStrategy.Bubble,
                                                                 typeof (RoutedEventHandler),
                                                                 typeof (ContextMenuService));
      ContextMenuOpeningEvent = EventManager.RegisterRoutedEvent("ContextMenuOpening", RoutingStrategy.Bubble,
                                                                 typeof (RoutedEventHandler),
                                                                 typeof (ContextMenuService));

      ContextMenuProperty = DependencyProperty.RegisterAttached("ContextMenu", typeof (object),
                                                                typeof (ContextMenuService),
                                                                new FrameworkPropertyMetadata());
      HasDropShadowProperty = DependencyProperty.RegisterAttached("HasDropShadow", typeof (bool),
                                                                  typeof (ContextMenuService),
                                                                  new FrameworkPropertyMetadata(false));
      HorizontalOffsetProperty = DependencyProperty.RegisterAttached("HorizontalOffset", typeof (double),
                                                                     typeof (ContextMenuService),
...
//			IsOpenProperty = DependencyProperty.RegisterAttached("IsOpen", typeof(bool), typeof(ContextMenuService), new FrameworkPropertyMetadata(false));
      PlacementProperty = DependencyProperty.RegisterAttached("Placement", typeof (PlacementMode),
                                                              typeof (ContextMenuService),
