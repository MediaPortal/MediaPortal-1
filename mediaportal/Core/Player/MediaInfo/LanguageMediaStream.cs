...
namespace MediaPortal.Player
{
  public abstract class LanguageMediaStream : MediaStream
  {
    ...
    private static readonly Dictionary<string, LanguageInfo> Lcids = new Dictionary<string, LanguageInfo>
    {
    ...
    {
      LanguageInfo info;
      return Lcids.TryGetValue(source, out info) ? info.Name : "Unknown";
    }

    public int GetLcid(string source)
    {
      LanguageInfo info;
      return Lcids.TryGetValue(source, out info) ? info.Lcid : 0;
    }
