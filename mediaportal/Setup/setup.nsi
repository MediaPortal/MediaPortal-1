...
### AUTO-GENERATED   UNINSTALLATION CODE   END ###
  ...
  !endif
  File "${git_MP}\MediaPortal.Application\SkinProperties\SkinProperties.ico"
  ...
  SetOutPath "$MPdir.Base\"
  !if "${Architecture}" == "x64"
  File "${git_ROOT}\Packages\Sqlite.3.53.3\sqlite\x64\sqlite.dll"
  !else
  File "${git_ROOT}\Packages\Sqlite.3.53.3\sqlite\x86\sqlite.dll"
  !endif
  ; NuGet binaries EXIF
  SetOutPath "$MPdir.Base\"
  ...
  File "${git_ROOT}\Packages\System.Text.Encoding.CodePages.10.0.5\lib\net462\System.Text.Encoding.CodePages.dll"
...
### AUTO-GENERATED   UNINSTALLATION CODE   END ###
  ...
  Delete "$MPdir.Base\System.Buffers.dll"
  Delete "$MPdir.Base\System.Memory.dll"
  Delete "$MPdir.Base\System.Numerics.Vectors.dll"
...
Section -Post
  ...
  ${If} $noDesktopSC != 1
    ...
    CreateShortCut "$DESKTOP\MediaPortal SkinProperties.lnk" "$MPdir.Base\MediaPortal.exe"    "/SkinProperties" "$MPdir.Base\SkinProperties.ico"   0 "" "" "MediaPortal SkinProperties"
  ...
  ;${If} $noStartMenuSC != 1
      ...
      !if "${Architecture}" == "x64"
          ...
          CreateShortCut "${STARTMENU_GROUP}\MediaPortal SkinProperties (x64).lnk"       "$MPdir.Base\MediaPortal.exe"   "/SkinProperties" "$MPdir.Base\SkinProperties.ico"   0 "" "" "MediaPortal SkinProperties"
      ...
      !else
          ...
          CreateShortCut "${STARTMENU_GROUP}\MediaPortal SkinProperties.lnk"             "$MPdir.Base\MediaPortal.exe"   "/SkinProperties" "$MPdir.Base\SkinProperties.ico"   0 "" "" "MediaPortal SkinProperties"
