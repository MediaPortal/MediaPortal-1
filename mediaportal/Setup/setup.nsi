...
### AUTO-GENERATED   UNINSTALLATION CODE   END ###
  ...
  File "${git_ROOT}\Packages\BASS.NET.2.4.14.1\lib\net40\Bass.Net.dll"
  File "${git_ROOT}\Packages\BassRegistration.2.4.14.1\lib\net40\BassRegistration.dll"
  ...
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_aac.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_ac3.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_adx.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_aix.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_ape.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_mpc.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_ofr.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_spx.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bass_tta.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bassalac.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bassdsd.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bassflac.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\basshls.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bassmidi.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\bassopus.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\basswebm.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\basswma.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\basswv.dll"
  File "${git_ROOT}\Packages\BASSCombined.2.4.15\content\x86\Plugins\tags.dll"
  ; taglib-sharp
  SetOutPath "$MPdir.Base\"
