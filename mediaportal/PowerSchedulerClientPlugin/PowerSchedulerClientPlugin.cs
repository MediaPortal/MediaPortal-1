...
namespace MediaPortal.Plugins.Process
{
  ...
  public class PowerSchedulerClientPlugin : IPlugin, ISetupForm, IPluginReceiver
  {
    ...
    private Mediaportal.TV.PowerSchedulerClientPlugin.PowerScheduler _powerScheduler;
    ...
    {
      _powerScheduler = new Mediaportal.TV.PowerSchedulerClientPlugin.PowerScheduler();
    }
