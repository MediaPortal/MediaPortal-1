...
namespace MediaPortal.TV.Recording
{
  ...
  /// -radio
  /// </summary>
  public class DVBGraphBase : MediaPortal.TV.Recording.IGraph
  {
    #region guids
    ...
    public void StoreChannels(int ID, bool radio, bool tv, ref int newChannels, ref int updatedChannels, ref int newRadioChannels, ref int updatedRadioChannels)
    {
      ...
      using (DVBSections sections = new DVBSections())
      {
        ...
        if (count > 0)
        {
          ...
          for (int t = 0; t < count; t++)
          {
            ...
            else Log.Write("DVBGraph:channel {0} is not ready!!!", t);
          }
        }
      }
      ...
      Log.WriteFile(Log.LogType.Capture, "DVBGraph: found {0} channels", transp.channels.Count);
