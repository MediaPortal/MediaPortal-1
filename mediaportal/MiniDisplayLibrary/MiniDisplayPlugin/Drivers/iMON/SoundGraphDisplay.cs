...
namespace MediaPortal.ProcessPlugins.MiniDisplayPlugin.Drivers
{
  ...
  public class SoundGraphDisplay : BaseDisplay
  {
    ...
    public override void Initialize()
    {
      ...
      if (_IDW_IsInitialized() != DSPResult.DSP_SUCCEEDED)
      {
        bool success = DoInit();
        if (!success)
        {
    ...
    private bool DoInit()
    {
      ...
      DSPResult ret = _IDW_Init(initResult);
    ...
    private DSPResult _IDW_Init(IDW_INITRESULT initResult)
    {
      if (IntPtr.Size == 8)
      {
        GCHandle gch = GCHandle.Alloc(initResult, GCHandleType.Pinned);
        try
        {
          return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
            MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
            (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.Init,
            gch.AddrOfPinnedObject(),
            Marshal.SizeOf(typeof(IDW_INITRESULT)),
            true);
        }
        finally
        {
      ...
      {
        return IDW_Init(initResult);
      }
    }

    private DSPResult _IDW_Uninit()
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.UnInit,
          IntPtr.Zero,
          0,
          false);
    ...
    private DSPResult _IDW_IsInitialized()
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.IsInitialized,
          IntPtr.Zero,
          0,
          false);
      }
      ...
      {
        return IDW_IsInitialized();
      }
    }

    private DSPResult _IDW_GetStatus(IDW_STATUS status)
    {
      if (IntPtr.Size == 8)
      {
        GCHandle p = GCHandle.Alloc(status, GCHandleType.Pinned);
        try
        {
          return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
            MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
            (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.GetStatus,
            GCHandle.ToIntPtr(p),
            Marshal.SizeOf(typeof(IDW_STATUS)),
            true);
        }
        finally
        {
      ...
      {
        return IDW_GetStatus(status);
      }
    }

    public static DSPResult SetVfdText(string line1, string line2)
    {
      if (IntPtr.Size == 8)
      {
        byte[] data = new byte[line1.Length * 2 + line2.Length * 2 + 8];

        byte[] data1 = Encoding.Unicode.GetBytes(line1);
        data[0] = (byte)(line1.Length * 2);
        data[1] = (byte)((line1.Length * 2) >> 8);
        Buffer.BlockCopy(data1, 0, data, 2, data1.Length);

        byte[] data2 = Encoding.Unicode.GetBytes(line2);
        data[data1.Length + 4] = (byte)(line2.Length * 2);
        data[data1.Length + 5] = (byte)((line2.Length * 2) >> 8);
        Buffer.BlockCopy(data2, 0, data, data1.Length + 6, data2.Length);

        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetVfdText,
          data,
          data.Length);
      }
      else
      {
        return IDW_SetVfdText(line1, line2);
      }
    }

    public static int SetVfdEqData(DSPEQDATA EqData)
    {
      if (IntPtr.Size == 8)
      {
        return MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetVfdEqData,
          EqData.BandData);
      }
      else
      {
        return IDW_SetVfdEqData(EqData);
      }
    }

    public static int SetLcdEqData(DSPEQDATA EqDataLeft, DSPEQDATA EqDataRight)
    {
      if (IntPtr.Size == 8)
      {
        return MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdEqData,
          EqDataLeft.BandData, EqDataRight.BandData);
      }
      else
      {
        return IDW_SetLcdEqData(EqDataLeft, EqDataRight);
      }
    }

    public static DSPResult SetLcdText(string line)
    {
      if (IntPtr.Size == 8)
      {
        byte[] data = new byte[line.Length * 2 + 4];

        byte[] data1 = Encoding.Unicode.GetBytes(line);
        data[0] = (byte)(line.Length * 2);
        data[1] = (byte)((line.Length * 2) >> 8);
        Buffer.BlockCopy(data1, 0, data, 2, data1.Length);

        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdText,
          data,
          data.Length);
      }
      else
      {
        return IDW_SetLcdText(line);
      }
    }

    public static DSPResult SetLcdAllIcons([MarshalAs(UnmanagedType.Bool)] bool on)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdAllIcons,
          on ? 1 : 0, 0);
      }
      else
      {
        return IDW_SetLcdAllIcons(on);
      }
    }

    public static DSPResult SetLcdOrangeIcon(byte iconData1, byte iconData2)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdOrangeIcon,
          iconData1, iconData2);
      }
      else
      {
        return IDW_SetLcdOrangeIcon(iconData1, iconData2);
      }
    }
        
    public static DSPResult SetLcdMediaTypeIcon(byte iconData)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdMediaTypeIcon,
          iconData, 0);
      }
      else
      {
        return IDW_SetLcdMediaTypeIcon(iconData);
      }
    }

    public static DSPResult SetLcdSpeakerIcon(byte iconData1, byte iconData2)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdSpeakerIcon,
          iconData1, iconData2);
      }
      else
      {
        return IDW_SetLcdSpeakerIcon(iconData1, iconData2);
      }
    }

    public static DSPResult SetLcdVideoCodecIcon(byte iconData)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdVideoCodecIcon,
          iconData, 0);
      }
      else
      {
        return IDW_SetLcdVideoCodecIcon(iconData);
      }
    }

    public static DSPResult SetLcdAudioCodecIcon(byte iconData)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdAudioCodecIcon,
          iconData, 0);
      }
      else
      {
        return IDW_SetLcdAudioCodecIcon(iconData);
      }
    }

    public static DSPResult SetLcdAspectRatioIcon(byte iconData)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdAspectRatioIcon,
          iconData, 0);
      }
      else
      {
        return IDW_SetLcdAspectRatioIcon(iconData);
      }
    }

    public static DSPResult SetLcdEtcIcon(byte iconData)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdEtcIcon,
          iconData, 0);
      }
      else
      {
        return IDW_SetLcdEtcIcon(iconData);
      }
    }

    public static DSPResult SetLcdProgress(int currentPosition, int total)
    {
      if (IntPtr.Size == 8)
      {
        return (DSPResult)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.Instance.Execute(
          MiniDisplayPlugin.Drivers.MPx86ProxyHandler.CommandEnum.ImonDisplayWrapper,
          (byte)MiniDisplayPlugin.Drivers.MPx86ProxyHandler.ImonDisplayWrapperCommandEnum.SetLcdProgress,
          currentPosition, total);
      }
      else
      {
        return IDW_SetLcdProgress(currentPosition, total);
      }
    }
