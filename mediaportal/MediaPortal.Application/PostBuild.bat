...
xcopy %1\..\Packages\MP-1-MediaInfolib.1.0.1\MediaInfo.dll . /Y /D
xcopy %1\..\Packages\MP-1-MediaInfolib.1.0.1\libeay32.dll . /Y /D
xcopy %1\..\Packages\MP-1-MediaInfolib.1.0.1\ssleay32.dll . /Y /D
xcopy %1\..\Packages\MP-1-MediaInfolib.1.0.1\libcurl.dll . /Y /D
