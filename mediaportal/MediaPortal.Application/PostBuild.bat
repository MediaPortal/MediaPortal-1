...
if /I "%3" EQU "x64" (
  xcopy %1\..\Packages\Sqlite.3.49.1\sqlite\x64\sqlite.dll . /Y /D
) ELSE (
  xcopy %1\..\Packages\Sqlite.3.49.1\sqlite\x86\sqlite.dll . /Y /D
)
...
REM taglib-sharp
xcopy %1\..\Packages\MediaPortal.TagLib.2.3.1\lib\net40\TagLibSharp.dll ./Y /D
