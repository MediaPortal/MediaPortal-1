...
namespace MediaPortal.Tests.Core.Player
{
    public class DirectShowPlayerTestHelper : IDisposable
    {
        ...
        private D3DEnumeration _enumerationSettings;
        ...
        private void PrepareGraphicsContext(Form form)
        {
            ...
            GUIGraphicsContext.VolumeHandler = new VolumeHandler();
            GUIGraphicsContext.VolumeHandler.Volume = 1;
            ...
            presentParams.DeviceWindow = form;
        ...
        private class FakeLocalizationProvider : ILocalizationProvider
        {
            ...
            {
                get { return new[] { Thread.CurrentThread.CurrentCulture }; }
            }
