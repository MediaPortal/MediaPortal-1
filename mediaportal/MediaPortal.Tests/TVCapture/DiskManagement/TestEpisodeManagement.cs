...
namespace MediaPortal.Tests.Disk
{
  ...
  public class TestEpisodeManagement
  {
    ...
    public void FilterEpisodes()
    {
      ...
      rec = new TVRecorded();
      rec.Title = "title1";
      rec.Start = 20051223200000;
      recordings.Add(rec);
      rec = new TVRecorded();
      rec.Title = "title2";
      rec.Start = 20051224200000;
      recordings.Add(rec);
      rec = new TVRecorded();
      rec.Title = "title1";
      rec.Start = 20051225200000;
      recordings.Add(rec);
      rec = new TVRecorded();
      rec.Title = "title3";
      rec.Start = 20051226200000;
      recordings.Add(rec);
      rec = new TVRecorded();
      rec.Title = "title4";
      rec.Start = 20051227200000;
      recordings.Add(rec);
      rec = new TVRecorded();
      rec.Title = "title1";
      rec.Start = 20051228200000;
      recordings.Add(rec);
    ...
    public void GetOldestEpisode()
    {
      ...
      rec = new TVRecorded();
      rec.Title = "title4";
      rec.Start = 20051222200000;
      episodes.Add(rec); //oldest
      rec = new TVRecorded();
      rec.Title = "title5";
      rec.Start = 20051227200000;
      episodes.Add(rec);
