...
namespace MediaPortal.Configuration
{
  ...
  public class SettingsForm : Form
  {
    ...
    public SettingsForm()
    {
      ...
      //Add section for evr configuration
      AddChildSection(filterSection, new EVRConfig());
    ...
    private bool AllFilledIn()
    {
      ...
      using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings(Config.GetFile(Config.Dir.Config, "MediaPortal.xml")))
      {
        ...
        if (!string.IsNullOrEmpty(asuser))
        {
          ...
          {
            MessageBox.Show("No password specified for current Audioscrobbler user", "MediaPortal Settings", MessageBoxButtons.OK,
                         MessageBoxIcon.Exclamation);
            return false;
          }
        }
        ...
        {
          MessageBox.Show("Please configure the Audioscrobbler plugin to use Last.fm radio", "MediaPortal Settings", MessageBoxButtons.OK,
                         MessageBoxIcon.Exclamation);
          return false;
        }
      }
