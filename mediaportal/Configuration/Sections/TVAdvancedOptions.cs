...
namespace MediaPortal.Configuration.Sections
{
  public class TVAdvancedOptions : SectionSettings
  {
    ...
    public override void LoadSettings()
    {
      ...
      mpDoNotAllowSlowMotionDuringZappingCheckBox.Checked = AdvancedSettings.DoNotAllowSlowMotionDuringZapping;
    }
    ...
    public override void SaveSettings()
    {
      ...
      AdvancedSettings.DoNotAllowSlowMotionDuringZapping = mpDoNotAllowSlowMotionDuringZappingCheckBox.Checked;
    }
