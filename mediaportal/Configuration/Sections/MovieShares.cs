  ...
  public class MovieShares : MediaPortal.Configuration.Sections.Shares
  {
    ...
    public override void LoadSettings()
    {
      using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings(Config.Get(Config.Dir.Config) + "MediaPortal.xml"))
      {
        ...
        RememberLastFolder = xmlreader.GetValueAsBool("movies", "rememberlastfolder", false);
    ...
    public override void SaveSettings()
    {
      using (MediaPortal.Profile.Settings xmlwriter = new MediaPortal.Profile.Settings(Config.Get(Config.Dir.Config) + "MediaPortal.xml"))
      {
        ...
        for (int index = 0; index < MaximumShares; index++)
        {
          ...
          xmlwriter.SetValue("movies", sharePin, MediaPortal.Util.Utils.EncryptPin(sharePinData));
        ...
        xmlwriter.SetValueAsBool("movies", "rememberlastfolder", RememberLastFolder);
      }
    }
