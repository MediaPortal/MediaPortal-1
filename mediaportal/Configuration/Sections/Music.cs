...
namespace MediaPortal.Configuration.Sections
{
    public class Music : MediaPortal.Configuration.SectionSettings
    {
        ...
        private TrackBar BufferingTrkBar;
        private Label label12;
        private TrackBar CrossFadeTrkBar;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            BufferingTrkBar_Scroll(null, null);
            CrossFadeTrkBar_Scroll(null, null);
        ...
        public override void LoadSettings()
        {
            using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings(Config.Get(Config.Dir.Config) + "MediaPortal.xml"))
            {
                ...
                else if (crossFadeMS > CrossFadeTrkBar.Maximum)
                    crossFadeMS = CrossFadeTrkBar.Maximum;

                CrossFadeTrkBar.Value = crossFadeMS;

                int bufferingMS = xmlreader.GetValueAsInt("audioplayer", "buffering", 5000);

                if (bufferingMS < BufferingTrkBar.Minimum)
                    bufferingMS = BufferingTrkBar.Minimum;

                else if (bufferingMS > BufferingTrkBar.Maximum)
                    bufferingMS = BufferingTrkBar.Maximum;

                BufferingTrkBar.Value = bufferingMS;
        ...
        public override void SaveSettings()
        {
            using (MediaPortal.Profile.Settings xmlwriter = new MediaPortal.Profile.Settings(Config.Get(Config.Dir.Config) + "MediaPortal.xml"))
            {
                ...
                xmlwriter.SetValue("audioplayer", "crossfade", CrossFadeTrkBar.Value);
                xmlwriter.SetValue("audioplayer", "buffering", BufferingTrkBar.Value);
        ...
        private void InitializeComponent()
        {
            ...
            this.BufferingTrkBar = new System.Windows.Forms.TrackBar();
            this.label12 = new System.Windows.Forms.Label();
            this.CrossFadeTrkBar = new System.Windows.Forms.TrackBar();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.BufferingTrkBar)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.CrossFadeTrkBar)).BeginInit();
            this.mpGroupBox1.SuspendLayout();
            ...
            this.PlaybackSettingsGrpBox.Controls.Add(this.BufferingTrkBar);
            this.PlaybackSettingsGrpBox.Controls.Add(this.label12);
            this.PlaybackSettingsGrpBox.Controls.Add(this.CrossFadeTrkBar);
            ...
            this.PlaybackSettingsGrpBox.Location = new System.Drawing.Point(16, 141);
            this.PlaybackSettingsGrpBox.Name = "PlaybackSettingsGrpBox";
            this.PlaybackSettingsGrpBox.Size = new System.Drawing.Size(432, 218);
            ...
            // BufferingSecondsLbl
            // 
            this.BufferingSecondsLbl.Location = new System.Drawing.Point(341, 172);
            ...
            // CrossFadeSecondsLbl
            // 
            this.CrossFadeSecondsLbl.Location = new System.Drawing.Point(341, 117);
            ...
            // BufferingTrkBar
            // 
            this.BufferingTrkBar.AutoSize = false;
            this.BufferingTrkBar.BackColor = System.Drawing.SystemColors.ControlLightLight;
            this.BufferingTrkBar.LargeChange = 500;
            this.BufferingTrkBar.Location = new System.Drawing.Point(82, 167);
            this.BufferingTrkBar.Maximum = 8000;
            this.BufferingTrkBar.Minimum = 1000;
            this.BufferingTrkBar.Name = "BufferingTrkBar";
            this.BufferingTrkBar.Size = new System.Drawing.Size(260, 25);
            this.BufferingTrkBar.SmallChange = 100;
            this.BufferingTrkBar.TabIndex = 8;
            this.BufferingTrkBar.TickFrequency = 800;
            this.BufferingTrkBar.TickStyle = System.Windows.Forms.TickStyle.None;
            this.BufferingTrkBar.Value = 5000;
            this.BufferingTrkBar.Scroll += new System.EventHandler(this.BufferingTrkBar_Scroll);
            // 
            // label12
            // 
            ...
            // CrossFadeTrkBar
            // 
            this.CrossFadeTrkBar.AutoSize = false;
            this.CrossFadeTrkBar.BackColor = System.Drawing.SystemColors.ControlLightLight;
            this.CrossFadeTrkBar.LargeChange = 500;
            this.CrossFadeTrkBar.Location = new System.Drawing.Point(82, 114);
            this.CrossFadeTrkBar.Maximum = 16000;
            this.CrossFadeTrkBar.Name = "CrossFadeTrkBar";
            this.CrossFadeTrkBar.Size = new System.Drawing.Size(260, 25);
            this.CrossFadeTrkBar.SmallChange = 100;
            this.CrossFadeTrkBar.TabIndex = 5;
            this.CrossFadeTrkBar.TickFrequency = 1600;
            this.CrossFadeTrkBar.TickStyle = System.Windows.Forms.TickStyle.None;
            this.CrossFadeTrkBar.Value = 4000;
            this.CrossFadeTrkBar.Scroll += new System.EventHandler(this.CrossFadeTrkBar_Scroll);
            // 
            // mpLabel1
            // 
            ...
            this.CrossFadingLbl.Location = new System.Drawing.Point(15, 117);
            ...
            this.mpGroupBox1.Name = "mpGroupBox1";
            this.mpGroupBox1.Size = new System.Drawing.Size(432, 121);
            this.mpGroupBox1.TabIndex = 0;
            this.mpGroupBox1.TabStop = false;
            this.mpGroupBox1.Text = "General Settings";
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.BufferingTrkBar)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.CrossFadeTrkBar)).EndInit();
            this.mpGroupBox1.ResumeLayout(false);
            this.mpGroupBox1.PerformLayout();
        ...
        private void CrossFadeTrkBar_Scroll(object sender, EventArgs e)
        {
            float xFadeSecs = 0;

            if (CrossFadeTrkBar.Value > 0)
                xFadeSecs = (float)CrossFadeTrkBar.Value / 1000f;

            CrossFadeSecondsLbl.Text = string.Format("{0:f2} Seconds", xFadeSecs);
        }

        private void BufferingTrkBar_Scroll(object sender, EventArgs e)
        {
            float bufferingSecs = 0;

            if (BufferingTrkBar.Value > 0)
                bufferingSecs = (float)BufferingTrkBar.Value / 1000f;
        ...
        private void GaplessPlaybackChkBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            CrossFadeTrkBar.Enabled = !gaplessEnabled;
