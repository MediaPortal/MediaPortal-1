...
namespace MediaPortal.Configuration.Sections
{
	public class Weather : MediaPortal.Configuration.SectionSettings
	{
			...
			using (AMS.Profile.Xml xmlreader = new AMS.Profile.Xml("MediaPortal.xml"))
			{
				...
				for(int index = 0; index < MaximumCities; index++)
				{
					...
					if(cityNameData.Length > 0 && cityCodeData.Length > 0)
						citiesListView.Items.Add(new ListViewItem(new string[] { cityNameData, cityCodeData }));
				}
			}			
		}
		...
		private void InitializeComponent()
		{
			...
			this.searchButton.Location = new System.Drawing.Point(96, 126);
			...
			this.removeButton.Location = new System.Drawing.Point(16, 126);
		...
		private void searchButton_Click(object sender, System.EventArgs e)
		{
			...
			if(searchForm.ShowDialog(this) == DialogResult.OK)
			{
				...
				{
					citiesListView.Items.Add(new ListViewItem(new string[] { city.Name, city.Id }));
				}
			}
		}
