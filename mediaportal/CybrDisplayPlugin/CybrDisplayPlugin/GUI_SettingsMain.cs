namespace CybrDisplayPlugin
{
    ...
    public class GUI_SettingsMain : GUIWindow
    {
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsMain.OnAdded(): Window {0} added to window manager", new object[] { this.GetID });
            base.OnAdded();
        }
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsMain.OnPageLoad(): called", new object[0]);
            ...
            this.SetContrast();
            this.SetBrightness();
            GUIPropertyManager.SetProperty("#currentmodule", "CybrDisplay Setup");
