namespace CybrDisplayPlugin
{
    ...
    public class GUI_SettingsEqualizer : GUIWindow
    {
        ...
        {
            Log.Info("CybrDisplay.GUI_Settings_Equalizer.OnAdded(): Window {0} added to window manager", new object[] { this.GetID });
            base.OnAdded();
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            GUIPropertyManager.SetProperty("#currentmodule", "CybrDisplay Equalizer Setup");
        }
