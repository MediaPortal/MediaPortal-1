namespace CybrDisplayPlugin
{
    ...
    public class GUI_SettingsDisplayControl : GUIWindow
    {
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsDisplayControl.OnAdded(): Window {0} added to window manager", new object[] { this.GetID });
            base.OnAdded();
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            this.SetIdleDelay();
            GUIControl.FocusControl(this.GetID, this.btnDisplayVideo.GetID);
            GUIPropertyManager.SetProperty("#currentmodule", "CybrDisplay Display Control Options");
        }
