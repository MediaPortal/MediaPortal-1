namespace CybrDisplayPlugin
{
    ...
    public class GUI_SettingsBacklight : GUIWindow
    {
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsBacklight.OnAdded(): Window {0} added to window manager", new object[] { this.GetID });
            base.OnAdded();
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            GUIPropertyManager.SetProperty("#currentmodule", "CybrDisplay BackLight Options");
        }
        ...
        {
            Log.Info("CybrDisplay.GUI_SettingsBacklight.SetBlue(): setting Blue = {0}\n", new object[] { this.BackLightOptions.BackLightBlue });
