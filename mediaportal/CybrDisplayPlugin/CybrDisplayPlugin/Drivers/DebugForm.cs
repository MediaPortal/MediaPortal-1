namespace CybrDisplayPlugin.Drivers
{
    ...
    public class DebugForm : Form, IDisplay, IDisposable
    {
        ...
        private void LoadAdvancedSettings()
        {
            ...
            FileInfo info = new FileInfo(Config.GetFile(Config.Dir.Config, "CybrDisplay_DebugForm.xml"));
        ...
        public class AdvancedSettings
        {
            ...
            public static DebugForm.AdvancedSettings Load()
            {
                ...
                if (File.Exists(Config.GetFile(Config.Dir.Config, "CybrDisplay_DebugForm.xml")))
                {
                    ...
                    XmlTextReader xmlReader = new XmlTextReader(Config.GetFile(Config.Dir.Config, "CybrDisplay_DebugForm.xml"));
            ...
            public static void Save(DebugForm.AdvancedSettings ToSave)
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(DebugForm.AdvancedSettings));
                XmlTextWriter writer = new XmlTextWriter(Config.GetFile(Config.Dir.Config, "CybrDisplay_DebugForm.xml"), Encoding.UTF8);
