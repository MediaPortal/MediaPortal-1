...
namespace MediaPortal.Player.DSP
{
  public class DSPPluginInfo
  {
    ...
    private PluginType _DSPPluginType = DSPPluginInfo.PluginType.Unknown;
    ...
    public DSPPluginInfo(DSPPluginInfo.PluginType pluginType, string path, string name)
    {
    ...
    public PluginType DSPPluginType
    {
      ...
      public override string ToString()
      {
        ...
        {
          case DSPPluginInfo.PluginType.VST:
            sPluginType = " (VST)";
            break;

          case DSPPluginInfo.PluginType.Winamp:
            sPluginType = " (Winamp)";
            break;
        }
