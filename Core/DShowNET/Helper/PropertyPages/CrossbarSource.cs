...
namespace DShowNET.Helper
{
  ...
  public class CrossbarSource : Source
  {
    ...
    public bool IsTuner
    {
      get
      {
        if (this.ConnectorType == PhysicalConnectorType.Video_Tuner)
        {
          return true;
        }
        return false;
    ...
    public bool IsComposite
    {
      get
      {
        if (this.ConnectorType == PhysicalConnectorType.Video_Composite)
        {
          return true;
        }
        return false;
    ...
    public bool IsSVHS
    {
      get
      {
        if (this.ConnectorType == PhysicalConnectorType.Video_SVideo)
        {
          return true;
        }
        return false;
    ...
    public bool IsRgb
    {
      get
      {
        if (this.ConnectorType == PhysicalConnectorType.Video_RGB)
        {
          return true;
        }
        return false;
