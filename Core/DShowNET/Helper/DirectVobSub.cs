  ...
  public struct NORMALIZEDRECT
  {
	...
	public interface IDirectVobSub
	{
		...
		int get_ExtendPicture(
			...
			out int vertical, // 0 - disabled, 1 - 16:9, 2 - 4:3, 0x80 - crop (use crop together with 16:9 or 4:3, eg 0x81 will crop to 16:9 if the picture was taller)
			out int resx2, // 0 - disabled, 1 - enabled, 2 - depends on the original resolution
			out int resx2minw, // resolution doubler will be used if width*height <= resx2minw*resx2minh (resx2minw*resx2minh equals to 384*288 by default)
			out int resx2minh 
			);
