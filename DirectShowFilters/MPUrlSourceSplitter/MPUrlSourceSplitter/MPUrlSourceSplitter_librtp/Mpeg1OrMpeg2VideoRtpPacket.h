...
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_MPEG2_HEADER_EXTENSION       (1 << (RTP_PACKET_FLAG_LAST + 0))
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_ACTIVE_N_BIT                 (1 << (RTP_PACKET_FLAG_LAST + 1))
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_NEW_PICTURE_HEADER           (1 << (RTP_PACKET_FLAG_LAST + 2))
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_SEQUENCE_HEADER              (1 << (RTP_PACKET_FLAG_LAST + 3))
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_BEGINING_OF_SLICE            (1 << (RTP_PACKET_FLAG_LAST + 4))
#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_PAYLOAD_END_OF_SLICE                 (1 << (RTP_PACKET_FLAG_LAST + 5))

#define MPEG1_OR_MPEG2_VIDEO_RTP_PACKET_FLAG_LAST                                 (RTP_PACKET_FLAG_LAST + 6)
...
public:
  ...
  CMpeg1OrMpeg2VideoRtpPacket(HRESULT *result);
