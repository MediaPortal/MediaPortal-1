...
#ifndef __SESSION_INFORMATION_DEFINED
#define __SESSION_INFORMATION_DEFINED

#include "SessionTag.h"

#define TAG_SESSION_INFORMATION                             L"i"

class CSessionInformation : public CSessionTag
{
public:
  ...
  const wchar_t *GetSessionInformation(void);
