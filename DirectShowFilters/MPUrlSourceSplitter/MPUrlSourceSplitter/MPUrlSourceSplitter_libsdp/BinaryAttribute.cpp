...
void CBinaryAttribute::Clear(void)
{
  __super::Clear();
}

unsigned int CBinaryAttribute::Parse(const wchar_t *buffer, unsigned int length)
{
  ...
  if (result != 0)
  {
    ...
    this->instanceTag = Duplicate(TAG_ATTRIBUTE_INSTANCE_BINARY);
