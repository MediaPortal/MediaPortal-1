...
CUdpStreamFragmentCollection::~CUdpStreamFragmentCollection(void)
{
}

/* get methods */

CUdpStreamFragment *CUdpStreamFragmentCollection::GetItem(unsigned int index)
{
  return (CUdpStreamFragment *)__super::GetItem(index);
}
