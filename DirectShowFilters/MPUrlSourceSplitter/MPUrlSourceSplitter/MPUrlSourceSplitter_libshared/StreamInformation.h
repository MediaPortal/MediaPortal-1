...
#ifndef __STREAM_INFORMATION_DEFINED
#define __STREAM_INFORMATION_DEFINED
...
#define STREAM_INFORMATION_FLAG_NONE                                  FLAGS_NONE

// specifies that received data are container (e.g. avi, mkv, flv, ...)
#define STREAM_INFORMATION_FLAG_CONTAINER                             (1 << (FLAGS_LAST + 0))
// specifies that received data are demuxed packets ready to output pins
#define STREAM_INFORMATION_FLAG_PACKETS                               (1 << (FLAGS_LAST + 1))

#define STREAM_INFORMATION_FLAG_LAST                                  (FLAGS_LAST + 2)

class CStreamInformation : public CFlags
{
public:
  CStreamInformation(HRESULT *result);
  ~CStreamInformation(void);
