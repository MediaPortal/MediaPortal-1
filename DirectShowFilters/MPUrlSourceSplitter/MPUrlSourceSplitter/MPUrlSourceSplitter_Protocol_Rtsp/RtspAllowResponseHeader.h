...
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_NONE                          RTSP_RESPONSE_HEADER_FLAG_NONE

#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_DESCRIBE               (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 0))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_ANNOUNCE               (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 1))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_GET_PARAMETER          (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 2))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_OPTIONS                (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 3))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_PAUSE                  (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 4))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_PLAY                   (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 5))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_RECORD                 (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 6))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_REDIRECT               (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 7))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_SETUP                  (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 8))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_SET_PARAMETER          (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 9))
#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_METHOD_TEARDOWN               (1 << (RTSP_RESPONSE_HEADER_FLAG_LAST + 10))

#define RTSP_ALLOW_RESPONSE_HEADER_FLAG_LAST                          (RTSP_RESPONSE_HEADER_FLAG_LAST + 11)

class CRtspAllowResponseHeader : public CRtspResponseHeader
{
public:
  CRtspAllowResponseHeader(HRESULT *result);
