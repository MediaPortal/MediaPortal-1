...
#ifndef __RTSP_REFERER_REQUEST_HEADER_DEFINED
#define __RTSP_REFERER_REQUEST_HEADER_DEFINED

#include "RtspRequestHeader.h"

#define RTSP_REFERER_REQUEST_HEADER_NAME                              L"Referer"

#define RTSP_REFERER_REQUEST_HEADER_FLAG_NONE                         RTSP_REQUEST_HEADER_FLAG_NONE

#define RTSP_REFERER_REQUEST_HEADER_FLAG_LAST                         (RTSP_REQUEST_HEADER_FLAG_LAST + 0)

class CRtspRefererRequestHeader : public CRtspRequestHeader
{
public:
  CRtspRefererRequestHeader(HRESULT *result);
  virtual ~CRtspRefererRequestHeader(void);
  ...
  // gets referer
  // @return : referer or NULL if not specified
