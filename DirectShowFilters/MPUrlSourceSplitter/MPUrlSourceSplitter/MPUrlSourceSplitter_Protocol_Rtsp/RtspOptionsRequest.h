...
#ifndef __RTSP_OPTIONS_REQUEST_DEFINED
#define __RTSP_OPTIONS_REQUEST_DEFINED

#include "RtspRequest.h"

#define RTSP_OPTIONS_METHOD                                           L"OPTIONS"

class CRtspOptionsRequest : public CRtspRequest
{
public:
  CRtspOptionsRequest(void);
  virtual ~CRtspOptionsRequest(void);
  ...
  virtual CRtspOptionsRequest *Clone(void);

protected:

  CRtspOptionsRequest(bool createDefaultHeaders);
