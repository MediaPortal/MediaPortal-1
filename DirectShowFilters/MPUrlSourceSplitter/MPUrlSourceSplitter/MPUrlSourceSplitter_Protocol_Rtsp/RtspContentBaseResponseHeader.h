...
#ifndef __RTSP_CONTENT_BASE_RESPONSE_HEADER_DEFINED
#define __RTSP_CONTENT_BASE_RESPONSE_HEADER_DEFINED

#include "RtspResponseHeader.h"

#define RTSP_CONTENT_BASE_RESPONSE_HEADER_TYPE                        L"Content-Base"

class CRtspContentBaseResponseHeader : public CRtspResponseHeader
{
public:
  CRtspContentBaseResponseHeader(void);
  virtual ~CRtspContentBaseResponseHeader(void);
  ...
  virtual CRtspContentBaseResponseHeader *Clone(void);
