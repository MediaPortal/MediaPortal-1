...
// special flag for HDHomeRun RTSP server (HDHomeRun/1.0 RTSP server doesn't compute RTP packet timestamps)
#define RTSP_CURL_INSTANCE_FLAG_SERVER_HDHOMERUN                      (1 << (CURL_INSTANCE_FLAG_LAST + 7))

#define RTSP_CURL_INSTANCE_FLAG_PENDING_REQUEST_ASYNC                 (1 << (CURL_INSTANCE_FLAG_LAST + 8))

#define RTSP_CURL_INSTANCE_FLAG_LAST                                  (CURL_INSTANCE_FLAG_LAST + 9)
...
#define SERVER_HDHOMERUN                                              L"HDHomeRun/1.0"
