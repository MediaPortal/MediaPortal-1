...
#ifndef __RTSP_SETUP_REQUEST_DEFINED
#define __RTSP_SETUP_REQUEST_DEFINED

#include "RtspRequest.h"
#include "RtspTransportRequestHeader.h"

#define RTSP_SETUP_METHOD                                             L"SETUP"

class CRtspSetupRequest : public CRtspRequest
{
public:
  CRtspSetupRequest(void);
  virtual ~CRtspSetupRequest(void);
  ...
  // gets RTSP transport request header
  // @return : RTSP transport request header
  virtual CRtspTransportRequestHeader *GetTransportRequestHeader(void);
  ...
  virtual CRtspSetupRequest *Clone(void);

protected:

  CRtspSetupRequest(bool createDefaultHeaders);
