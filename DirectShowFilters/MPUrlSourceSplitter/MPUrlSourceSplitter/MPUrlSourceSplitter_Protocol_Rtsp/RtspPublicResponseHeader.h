...
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_DESCRIBE              (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 1))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_ANNOUNCE              (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 2))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_GET_PARAMETER         (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 3))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_OPTIONS               (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 4))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_PAUSE                 (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 5))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_PLAY                  (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 6))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_RECORD                (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 7))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_REDIRECT              (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 8))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_SETUP                 (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 9))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_SET_PARAMETER         (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 10))
#define RTSP_PUBLIC_RESPONSE_HEADER_FLAG_METHOD_TEARDOWN              (1 << (MAX_RTSP_RESPONSE_HEADER_FLAG + 11))
