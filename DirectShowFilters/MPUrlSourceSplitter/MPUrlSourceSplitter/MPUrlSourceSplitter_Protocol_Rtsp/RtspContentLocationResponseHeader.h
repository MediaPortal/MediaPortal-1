...
#ifndef __RTSP_CONTENT_LOCATION_RESPONSE_HEADER_DEFINED
#define __RTSP_CONTENT_LOCATION_RESPONSE_HEADER_DEFINED

#include "RtspResponseHeader.h"

#define RTSP_CONTENT_LOCATION_RESPONSE_HEADER_TYPE                    L"Content-Location"

class CRtspContentLocationResponseHeader : public CRtspResponseHeader
{
public:
  CRtspContentLocationResponseHeader(void);
  virtual ~CRtspContentLocationResponseHeader(void);

  /* get methods */

  // gets content location header URI
  // @return : content location header URI or NULL if not specified
  ...
  virtual CRtspContentLocationResponseHeader *Clone(void);
