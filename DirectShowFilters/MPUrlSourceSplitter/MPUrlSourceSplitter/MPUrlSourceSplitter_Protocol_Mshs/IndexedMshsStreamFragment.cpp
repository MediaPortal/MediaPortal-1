...
CIndexedMshsStreamFragment::~CIndexedMshsStreamFragment(void)
{
}

/* get methods */

CMshsStreamFragment *CIndexedMshsStreamFragment::GetItem(void)
{
  return (CMshsStreamFragment *)__super::GetItem();
}
