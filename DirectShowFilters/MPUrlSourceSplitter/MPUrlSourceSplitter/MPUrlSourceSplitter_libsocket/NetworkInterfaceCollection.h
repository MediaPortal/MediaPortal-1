...
#ifndef __NETWORK_INTERFACE_COLLECTION_DEFINED
#define __NETWORK_INTERFACE_COLLECTION_DEFINED
...
protected:
  ...
  const wchar_t *GetKey(CNetworkInterface *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CNetworkInterface *Clone(CNetworkInterface *item);
};
