...
CIndexedAfhsSegmentFragment::~CIndexedAfhsSegmentFragment(void)
{
}

/* get methods */

CAfhsSegmentFragment *CIndexedAfhsSegmentFragment::GetItem(void)
{
  return (CAfhsSegmentFragment *)__super::GetItem();
}
