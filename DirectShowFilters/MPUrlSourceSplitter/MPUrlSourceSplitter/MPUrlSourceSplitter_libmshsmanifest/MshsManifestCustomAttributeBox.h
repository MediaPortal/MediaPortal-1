...
#ifndef __MSHS_MANIFEST_CUSTOM_ATTRIBUTE_BOX_DEFINED
#define __MSHS_MANIFEST_CUSTOM_ATTRIBUTE_BOX_DEFINED

#include "Box.h"

#define MSHS_MANIFEST_CUSTOM_ATTRIBUTE_BOX_TYPE                       L"msca"

#define MSHS_MANIFEST_CUSTOM_ATTRIBUTE_BOX_FLAG_NONE                  BOX_FLAG_NONE

#define MSHS_MANIFEST_CUSTOM_ATTRIBUTE_BOX_FLAG_LAST                  (BOX_FLAG_LAST + 0)

class CMshsManifestCustomAttributeBox : public CBox
{
public:
  // creats new instance of CMshsManifestCustomAttributeBox class
  CMshsManifestCustomAttributeBox(HRESULT *result);
  // desctructor
  virtual ~CMshsManifestCustomAttributeBox(void);
