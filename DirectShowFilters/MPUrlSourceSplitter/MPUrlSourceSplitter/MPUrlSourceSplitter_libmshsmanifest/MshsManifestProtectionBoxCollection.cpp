...
CMshsManifestProtectionBoxCollection::CMshsManifestProtectionBoxCollection(HRESULT *result)
  : CCollection(result)
{
}

CMshsManifestProtectionBoxCollection::~CMshsManifestProtectionBoxCollection(void)
{
}
...
CMshsManifestProtectionBox *CMshsManifestProtectionBoxCollection::Clone(CMshsManifestProtectionBox *item)
{
  return NULL;
}
