...
CMshsManifestStreamBoxCollection::CMshsManifestStreamBoxCollection(HRESULT *result)
  : CCollection(result)
{
}

CMshsManifestStreamBoxCollection::~CMshsManifestStreamBoxCollection(void)
{
}
...
CMshsManifestStreamBox *CMshsManifestStreamBoxCollection::Clone(CMshsManifestStreamBox *item)
{
  return NULL;
}
