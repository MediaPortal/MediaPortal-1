...
CAttribute *CAttributeFactory::CreateAttribute(unsigned int version, const wchar_t *buffer, unsigned int length)
{
  ...
  if (SUCCEEDED(continueParsing))
  {
    ...
    if (SUCCEEDED(continueParsing))
    {
      ...
      CREATE_SPECIFIC_ATTRIBUTE(attribute, BYTE_RANGE_ATTRIBUTE_NAME, CByteRangeAttribute, continueParsing, result, version);
      CREATE_SPECIFIC_ATTRIBUTE(attribute, ASSOCIATED_LANGUAGE_ATTRIBUTE_NAME, CAssociatedLanguageAttribute, continueParsing, result, version);
      CREATE_SPECIFIC_ATTRIBUTE(attribute, INSTREAM_ID_ATTRIBUTE_NAME, CInstreamIdAttribute, continueParsing, result, version);
