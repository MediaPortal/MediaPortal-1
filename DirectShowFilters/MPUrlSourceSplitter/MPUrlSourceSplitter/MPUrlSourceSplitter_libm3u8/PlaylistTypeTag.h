...
#ifndef __PLAYLIST_TYPE_TAG_DEFINED
#define __PLAYLIST_TYPE_TAG_DEFINED

#include "Tag.h"

#define PLAYLIST_TYPE_TAG_FLAG_NONE                                   TAG_FLAG_NONE

#define PLAYLIST_TYPE_TAG_FLAG_EVENT                                  (1 << (TAG_FLAG_LAST + 0))                                   
#define PLAYLIST_TYPE_TAG_FLAG_VOD                                    (1 << (TAG_FLAG_LAST + 1))

#define PLAYLIST_TYPE_TAG_FLAG_LAST                                   (TAG_FLAG_LAST + 2)

#define TAG_PLAYLIST_TYPE                                             L"EXT-X-PLAYLIST-TYPE"

#define PLAYLIST_TYPE_EVENT                                           L"EVENT"
#define PLAYLIST_TYPE_VOD                                             L"VOD"

class CPlaylistTypeTag : public CTag
{
public:
  CPlaylistTypeTag(HRESULT *result);
  virtual ~CPlaylistTypeTag(void);
