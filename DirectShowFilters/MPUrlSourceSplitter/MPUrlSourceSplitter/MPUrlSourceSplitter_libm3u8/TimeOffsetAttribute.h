...
#ifndef __TIME_OFFSET_ATTRIBUTE_DEFINED
#define __TIME_OFFSET_ATTRIBUTE_DEFINED

#include "Attribute.h"

#define TIME_OFFSET_ATTRIBUTE_FLAG_NONE                               ATTRIBUTE_FLAG_NONE

#define TIME_OFFSET_ATTRIBUTE_FLAG_LAST                               (ATTRIBUTE_FLAG_LAST + 0)
...
{
public:
  CTimeOffsetAttribute(HRESULT *result);
  virtual ~CTimeOffsetAttribute(void);
