...
#ifndef __SESSION_DATA_TAG_DEFINED
#define __SESSION_DATA_TAG_DEFINED

#include "Tag.h"

#define SESSION_DATA_TAG_FLAG_NONE                                    TAG_FLAG_NONE

#define SESSION_DATA_TAG_FLAG_LAST                                    (TAG_FLAG_LAST + 0)

#define TAG_SESSION_DATA                                              L"EXT-X-SESSION-DATA"

class CSessionDataTag : public CTag
{
public:
  CSessionDataTag(HRESULT *result);
  virtual ~CSessionDataTag(void);
