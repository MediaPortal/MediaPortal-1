...
#ifndef __CODECS_ATTRIBUTE_DEFINED
#define __CODECS_ATTRIBUTE_DEFINED

#include "Attribute.h"

#define CODECS_ATTRIBUTE_FLAG_NONE                                    ATTRIBUTE_FLAG_NONE

#define CODECS_ATTRIBUTE_FLAG_LAST                                    (ATTRIBUTE_FLAG_LAST + 0)

#define CODECS_ATTRIBUTE_NAME                                         L"CODECS"

class CCodecsAttribute : public CAttribute
{
public:
  CCodecsAttribute(HRESULT *result);
  virtual ~CCodecsAttribute(void);
