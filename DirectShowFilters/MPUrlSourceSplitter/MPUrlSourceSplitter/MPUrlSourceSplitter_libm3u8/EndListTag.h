...
#ifndef __END_LIST_TAG_DEFINED
#define __END_LIST_TAG_DEFINED

#include "Tag.h"

#define END_LIST_TAG_FLAG_NONE                                        TAG_FLAG_NONE

#define END_LIST_TAG_FLAG_LAST                                        (TAG_FLAG_LAST + 0)

#define TAG_END_LIST                                                  L"EXT-X-ENDLIST"

class CEndListTag : public CTag
{
public:
  CEndListTag(HRESULT *result);
  virtual ~CEndListTag(void);
