...
#ifndef __ALLOW_CACHE_TAG_DEFINED
#define __ALLOW_CACHE_TAG_DEFINED

#include "Tag.h"

#define ALLOW_CACHE_TAG_FLAG_NONE                                     TAG_FLAG_NONE

#define ALLOW_CACHE_TAG_FLAG_YES                                      (1 << (TAG_FLAG_LAST + 0))
#define ALLOW_CACHE_TAG_FLAG_NO                                       (1 << (TAG_FLAG_LAST + 1))

#define ALLOW_CACHE_TAG_FLAG_LAST                                     (TAG_FLAG_LAST + 2)

#define TAG_ALLOW_CACHE                                               L"EXT-X-ALLOW-CACHE"

#define ALLOW_CACHE_YES                                               L"YES"
#define ALLOW_CACHE_NO                                                L"NO"

class CAllowCacheTag : public CTag
{
public:
  CAllowCacheTag(HRESULT *result);
  virtual ~CAllowCacheTag(void);
