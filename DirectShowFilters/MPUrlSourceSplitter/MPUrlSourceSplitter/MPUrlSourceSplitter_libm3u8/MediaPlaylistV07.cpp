...
CMediaPlaylistV07::~CMediaPlaylistV07(void)
{
}

/* get methods */

unsigned int CMediaPlaylistV07::GetVersion(void)
{
  return PLAYLIST_VERSION_07;
}
...
HRESULT CMediaPlaylistV07::CheckPlaylistVersion(void)
{
  return (PLAYLIST_VERSION_07 == this->detectedVersion) ? S_OK : E_M3U8_NOT_SUPPORTED_PLAYLIST_VERSION;
}

HRESULT CMediaPlaylistV07::ParseTagsAndPlaylistItemsInternal(void)
{
  ...
  if (SUCCEEDED(result))
  {
    ...
    unsigned int mediaSequence = (mediaSequenceTag != NULL) ? mediaSequenceTag->GetSequenceNumber() : MEDIA_SEQUENCE_ID_V07_DEFAULT;
