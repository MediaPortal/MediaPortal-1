...
#ifndef __STREAM_VARIANT_TAG_DEFINED
#define __STREAM_VARIANT_TAG_DEFINED

#include "Tag.h"

#define STREAM_VARIANT_TAG_FLAG_NONE                                  TAG_FLAG_NONE

#define STREAM_VARIANT_TAG_FLAG_LAST                                  (TAG_FLAG_LAST + 0)

#define TAG_STREAM_VARIANT                                            L"EXT-X-STREAM-INF"

class CStreamVariantTag : public CTag
{
public:
  CStreamVariantTag(HRESULT *result);
  virtual ~CStreamVariantTag(void);
