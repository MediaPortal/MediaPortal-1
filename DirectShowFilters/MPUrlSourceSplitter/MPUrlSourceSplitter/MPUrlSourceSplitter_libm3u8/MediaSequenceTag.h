...
#ifndef __MEDIA_SEQUENCE_TAG_DEFINED
#define __MEDIA_SEQUENCE_TAG_DEFINED

#include "Tag.h"

#define MEDIA_SEQUENCE_TAG_FLAG_NONE                                  TAG_FLAG_NONE

#define MEDIA_SEQUENCE_TAG_FLAG_LAST                                  (TAG_FLAG_LAST + 0)

#define TAG_MEDIA_SEQUENCE                                            L"EXT-X-MEDIA-SEQUENCE"
...
{
public:
  CMediaSequenceTag(HRESULT *result);
  virtual ~CMediaSequenceTag(void);
