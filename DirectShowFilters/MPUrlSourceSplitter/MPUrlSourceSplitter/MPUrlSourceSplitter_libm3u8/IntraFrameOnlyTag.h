...
#ifndef __INTRA_FRAME_ONLY_TAG_DEFINED
#define __INTRA_FRAME_ONLY_TAG_DEFINED

#include "Tag.h"

#define INTRA_FRAME_ONLY_TAG_FLAG_NONE                                TAG_FLAG_NONE

#define INTRA_FRAME_ONLY_TAG_FLAG_LAST                                (TAG_FLAG_LAST + 0)

#define TAG_INTRA_FRAME_ONLY                                          L"EXT-X-I-FRAMES-ONLY"

class CIntraFrameOnlyTag : public CTag
{
public:
  CIntraFrameOnlyTag(HRESULT *result);
  virtual ~CIntraFrameOnlyTag(void);
