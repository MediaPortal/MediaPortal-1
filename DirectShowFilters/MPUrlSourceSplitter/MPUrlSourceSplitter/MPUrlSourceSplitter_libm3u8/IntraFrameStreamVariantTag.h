...
#ifndef __INTRA_FRAME_STREAM_VARIANT_TAG_DEFINED
#define __INTRA_FRAME_STREAM_VARIANT_TAG_DEFINED

#include "Tag.h"

#define INTRA_FRAME_STREAM_VARIANT_TAG_FLAG_NONE                      TAG_FLAG_NONE

#define INTRA_FRAME_STREAM_VARIANT_TAG_FLAG_LAST                      (TAG_FLAG_LAST + 0)

#define TAG_INTRA_FRAME_STREAM_VARIANT                                L"EXT-X-I-FRAME-STREAM-INF"

class CIntraFrameStreamVariantTag : public CTag
{
public:
  CIntraFrameStreamVariantTag(HRESULT *result);
  virtual ~CIntraFrameStreamVariantTag(void);
