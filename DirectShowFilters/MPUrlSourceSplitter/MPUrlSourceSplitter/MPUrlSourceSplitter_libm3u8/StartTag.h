...
#ifndef __START_TAG_DEFINED
#define __START_TAG_DEFINED

#include "Tag.h"

#define START_TAG_FLAG_NONE                                           TAG_FLAG_NONE

#define START_TAG_FLAG_LAST                                           (TAG_FLAG_LAST + 0)

#define TAG_START                                                     L"EXT-X-START"

class CStartTag : public CTag
{
public:
  CStartTag(HRESULT *result);
  virtual ~CStartTag(void);
