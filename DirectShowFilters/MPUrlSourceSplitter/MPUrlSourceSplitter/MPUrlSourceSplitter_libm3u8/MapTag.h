...
#ifndef __MAP_TAG_DEFINED
#define __MAP_TAG_DEFINED

#include "Tag.h"

#define MAP_TAG_FLAG_NONE                                             TAG_FLAG_NONE

#define MAP_TAG_FLAG_LAST                                             (TAG_FLAG_LAST + 0)

#define TAG_MAP                                                       L"EXT-X-MAP"

class CMapTag : public CTag
{
public:
  CMapTag(HRESULT *result);
  virtual ~CMapTag(void);
