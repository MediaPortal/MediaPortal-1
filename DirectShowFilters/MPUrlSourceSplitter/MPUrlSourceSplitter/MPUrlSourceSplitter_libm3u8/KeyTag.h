...
#ifndef __KEY_TAG_DEFINED
#define __KEY_TAG_DEFINED

#include "Tag.h"

#define KEY_TAG_FLAG_NONE                                             TAG_FLAG_NONE

#define KEY_TAG_FLAG_LAST                                             (TAG_FLAG_LAST + 0)

#define TAG_KEY                                                       L"EXT-X-KEY"

class CKeyTag : public CTag
{
public:
  CKeyTag(HRESULT *result);
  virtual ~CKeyTag(void);
