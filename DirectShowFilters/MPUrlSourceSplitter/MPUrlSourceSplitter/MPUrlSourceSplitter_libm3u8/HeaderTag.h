...
#ifndef __HEADER_TAG_DEFINED
#define __HEADER_TAG_DEFINED

#include "Tag.h"

#define HEADER_TAG_FLAG_NONE                                          TAG_FLAG_NONE

#define HEADER_TAG_FLAG_LAST                                          (TAG_FLAG_LAST + 0)

#define TAG_HEADER                                                    L"EXTM3U"

class CHeaderTag : public CTag
{
public:
  CHeaderTag(HRESULT *result);
  virtual ~CHeaderTag(void);
