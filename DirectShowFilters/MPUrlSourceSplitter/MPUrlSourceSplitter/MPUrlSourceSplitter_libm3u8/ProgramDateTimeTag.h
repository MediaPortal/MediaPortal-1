...
#ifndef __PROGRAM_DATE_TIME_TAG_DEFINED
...
#define PROGRAM_DATE_TIME_TAG_FLAG_LAST                               (TAG_FLAG_LAST + 0)

#define TAG_PROGRAM_DATE_TIME                                         L"EXT-X-PROGRAM-DATE-TIME"

class CProgramDateTimeTag : public CTag
{
public:
  CProgramDateTimeTag(HRESULT *result);
