...
#ifndef __GROUP_ID_ATTRIBUTE_DEFINED
#define __GROUP_ID_ATTRIBUTE_DEFINED

#include "Attribute.h"

#define GROUP_ID_ATTRIBUTE_FLAG_NONE                                  ATTRIBUTE_FLAG_NONE

#define GROUP_ID_ATTRIBUTE_FLAG_LAST                                  (ATTRIBUTE_FLAG_LAST + 0)

#define GROUP_ID_ATTRIBUTE_NAME                                       L"GROUP-ID"

class CGroupIdAttribute : public CAttribute
{
public:
  CGroupIdAttribute(HRESULT *result);
  virtual ~CGroupIdAttribute(void);
