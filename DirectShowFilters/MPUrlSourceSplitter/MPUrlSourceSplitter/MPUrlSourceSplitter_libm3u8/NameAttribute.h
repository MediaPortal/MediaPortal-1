...
#ifndef __NAME_ATTRIBUTE_DEFINED
#define __NAME_ATTRIBUTE_DEFINED

#include "Attribute.h"

#define NAME_ATTRIBUTE_FLAG_NONE                                      ATTRIBUTE_FLAG_NONE

#define NAME_ATTRIBUTE_FLAG_LAST                                      (ATTRIBUTE_FLAG_LAST + 0)

#define NAME_ATTRIBUTE_NAME                                           L"NAME"

class CNameAttribute : public CAttribute
{
public:
  CNameAttribute(HRESULT *result);
  virtual ~CNameAttribute(void);
