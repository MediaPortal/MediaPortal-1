...
#ifndef __DISCONTINUITY_TAG_DEFINED
#define __DISCONTINUITY_TAG_DEFINED

#include "Tag.h"

#define DISCONTINUITY_TAG_FLAG_NONE                                   TAG_FLAG_NONE

#define DISCONTINUITY_TAG_FLAG_LAST                                   (TAG_FLAG_LAST + 0)

#define TAG_DISCONTINUITY                                             L"EXT-X-DISCONTINUITY"

class CDiscontinuityTag : public CTag
{
public:
  CDiscontinuityTag(HRESULT *result);
  virtual ~CDiscontinuityTag(void);
