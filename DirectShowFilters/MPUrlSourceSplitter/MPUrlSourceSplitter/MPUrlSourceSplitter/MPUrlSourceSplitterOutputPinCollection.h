...
#ifndef __MP_URL_SOURCE_SPLITTER_OUTPUT_PIN_COLLECTION_DEFINED
#define __MP_URL_SOURCE_SPLITTER_OUTPUT_PIN_COLLECTION_DEFINED
...
protected:
  ...
  CMPUrlSourceSplitterOutputPin *Clone(CMPUrlSourceSplitterOutputPin *item);
};
