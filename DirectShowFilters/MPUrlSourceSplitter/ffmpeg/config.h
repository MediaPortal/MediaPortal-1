...
#define FFMPEG_CONFIGURATION "--extra-ldflags=' -static -L../thirdparty/32/lib' --extra-cflags='-fno-tree-vectorize -D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -I../thirdparty/32/include -mmmx -msse -msse2 -mfpmath=sse -mstackrealign' --pkg-config-flags='--static --define-variable=prefix=../thirdparty/32' --disable-network --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-swresample --disable-swscale --disable-postproc --disable-avfilter --enable-avresample --disable-static --disable-debug --disable-encoders --disable-bsfs --disable-devices --enable-shared --enable-gpl --enable-version3 --enable-w32threads --enable-runtime-cpudetect --enable-demuxers --disable-demuxer=matroska --disable-filters --disable-protocols --enable-protocol=file --disable-muxers --disable-hwaccels --enable-hwaccel=h264_dxva2 --enable-hwaccel=vc1_dxva2 --enable-hwaccel=wmv3_dxva2 --enable-hwaccel=mpeg2_dxva2 --arch=x86 --cpu=i686 --target-os=mingw32 --build-suffix=-mpurlsourcesplitter --cpu=i686"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 10.3.0 (Rev2, Built by MSYS2 project)"
#define OS_NAME mingw32
#define av_restrict restrict
#define EXTERN_PREFIX "_"
#define EXTERN_ASM _
#define BUILDSUF "-mpurlsourcesplitter"
#define SLIBSUF ".dll"
