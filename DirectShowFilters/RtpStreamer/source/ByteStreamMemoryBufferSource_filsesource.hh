...
#ifndef _BYTE_STREAM_MEMORY_SOURCE_HH
#define _BYTE_STREAM_MEMORY_SOURCE_HH

#ifndef _FRAMED_FILE_SOURCE_HH
#include "FramedFileSource.hh"
#endif

class ByteStreamMemoryBufferSource: public FramedFileSource {
public:
...
protected:
  ...
  static void fileReadableHandler(ByteStreamMemoryBufferSource* source, int mask);
  void doReadFromFile();
