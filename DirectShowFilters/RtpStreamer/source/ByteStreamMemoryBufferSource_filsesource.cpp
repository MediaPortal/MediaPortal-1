...
ByteStreamMemoryBufferSource*
ByteStreamMemoryBufferSource::createNew(UsageEnvironment& env, char const* fileName,
  ...
  ByteStreamMemoryBufferSource* newSource
    = new ByteStreamMemoryBufferSource(env, fid, deleteFidOnClose,
...
ByteStreamMemoryBufferSource*
ByteStreamMemoryBufferSource::createNew(UsageEnvironment& env, FILE* fid,
...
void ByteStreamMemoryBufferSource::seekToByteAbsolute(u_int64_t byteNumber) {
...
ByteStreamMemoryBufferSource::ByteStreamMemoryBufferSource(UsageEnvironment& env, FILE* fid,
					   Boolean deleteFidOnClose,
					   unsigned preferredFrameSize,
					   unsigned playTimePerFrame)
...
void ByteStreamMemoryBufferSource::doStopGettingFrames() {
#ifndef READ_FROM_FILES_SYNCHRONOUSLY
  envir().taskScheduler().turnOffBackgroundReadHandling(fileno(fFid));
...
void ByteStreamMemoryBufferSource::fileReadableHandler(ByteStreamMemoryBufferSource* source, int /*mask*/) {
...
void ByteStreamMemoryBufferSource::doReadFromFile() {
