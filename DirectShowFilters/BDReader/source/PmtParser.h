...
#define SERVICE_TYPE_VIDEO_VC1		    0xea
#define SERVICE_TYPE_AUDIO_UNKNOWN	    -1
#define SERVICE_TYPE_AUDIO_NOT_INIT	    -2
#define SERVICE_TYPE_NO_AUDIO           -3
...
#define SERVICE_TYPE_AUDIO_LPCM       0x80 
#define SERVICE_TYPE_AUDIO_DTS        0x82 
#define SERVICE_TYPE_AUDIO_MLP        0x83 
#define SERVICE_TYPE_AUDIO_DD_PLUS    0x84 
#define SERVICE_TYPE_AUDIO_DTS_HD     0x85 
#define SERVICE_TYPE_AUDIO_TS_HD_XLL  0x86 
//#define SERVICE_TYPE_AUDIO_DD_PLUS    0xa1 // MPC has these two defined twice...
//#define SERVICE_TYPE_AUDIO_DTS_HD     0xa2 

#define SERVICE_TYPE_DVB_SUBTITLES1 0x5
#define SERVICE_TYPE_DVB_SUBTITLES2 0x6

#define SERVICE_TYPE_PGS_SUBTITLES  0x90 // Presentation graphics stream
#define SERVICE_TYPE_IGS            0x91 // Interactive graphics stream
#define SERVICE_TYPE_TEXT_SUBTITLES 0x92 // Text subtitles
