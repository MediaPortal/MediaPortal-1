...
public:
	...
	//	Cstr/Dstr
	CSkyEpgParser(CSkyManager* parentSkyManager);
	~CSkyEpgParser();
...
private:
	...
	CSkyEpgTitleDecoder* skyEpgTitleDecoder;
	CSkyEpgSummaryDecoder* skyEpgSummaryDecoder;

	map<unsigned short, CSectionDecoder*> epgSectionDecoders;
};
