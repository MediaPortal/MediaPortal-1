...
// {e39e7902-650c-431c-81f1-5330154b75c4}
DEFINE_GUID(IID_IGRABBER_SI_SCTE,
            0xe39e7902, 0x650c, 0x431c, 0x81, 0xf1, 0x53, 0x30, 0x15, 0x4b, 0x75, 0xc4);
...
DECLARE_INTERFACE_(IGrabberSiScte, IGrabberSiAtsc)
{
  ...
  STDMETHOD_(unsigned short, GetSvctVirtualChannelCount)(THIS)PURE;
  STDMETHOD_(bool, GetSvctVirtualChannel)(THIS_ unsigned short index,
  ...
  STDMETHOD_(unsigned short, GetSvctDefinedChannelCount)(THIS)PURE;
  STDMETHOD_(bool, GetSvctDefinedChannel)(THIS_ unsigned short index,
                                          unsigned char* transmissionMedium,
                                          unsigned short* vctId,
