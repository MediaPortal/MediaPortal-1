...
class ICallBackSdt : public ICallBackTableParser
{
  public:
    virtual ~ICallBackSdt() {}

    virtual void OnSdtReceived(unsigned char tableId,
                                ...
                                const char* defaultAuthority) = 0;
    virtual void OnSdtChanged(unsigned char tableId,
                                unsigned short originalNetworkId,
                                unsigned short transportStreamId,
                                unsigned short serviceId,
                                bool eitScheduleFlag,
                                ...
                                unsigned short epgServiceId,
                                const char* defaultAuthority) = 0;
    virtual void OnSdtRemoved(unsigned char tableId,
                                unsigned short originalNetworkId,
                                unsigned short transportStreamId,
                                unsigned short serviceId,
                                bool eitScheduleFlag,
