...
class ICallBackSiMpeg
  : public ICallBackCat, public ICallBackPat, public ICallBackPmt
{
  public:
    virtual ~ICallBackSiMpeg() {}

    virtual void OnFreesatPids(unsigned short pidEitSchedule,
