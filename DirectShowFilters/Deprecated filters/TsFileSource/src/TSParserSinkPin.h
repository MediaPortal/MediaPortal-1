...
#ifndef TSParserSinkPin_H
#define TSParserSinkPin_H
...
/**********************************************
 *
 *  CTSParserSinkPin Class
 *
 **********************************************/

class CTSParserSinkPin : public CRenderedInputPin, public TSThread
{
public:
	CTSParserSinkPin(CTSParserSink *pTSParserSink, LPUNKNOWN pUnk, CBaseFilter *pFilter, CCritSec *pLock, HRESULT *phr);
	~CTSParserSinkPin();
...
private:
	CTSParserSink * const m_pTSParserSink;
