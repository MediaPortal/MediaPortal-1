...
namespace MediaPortal
{
    ...
    typeof(RoutedPropertyChangedEventHandler<double>), typeof(GUIFadelabel));
        ...
        public static readonly RoutedEvent ScrollPositionChangedEvent = EventManager.RegisterRoutedEvent(
    "ScrollPositionChanged", RoutingStrategy.Bubble,
    typeof(RoutedPropertyChangedEventHandler<double>), typeof(GUIFadelabel));

        public event RoutedPropertyChangedEventHandler<double> ScrollPositionChanged
        {
