...
namespace MediaPortal
{
  ...
  public class GUIFadelabel : UserControl, IGUIControl
  {
    ...
    public static readonly DependencyProperty FrameTimeProperty =DependencyProperty.Register("FrameTime", typeof(double), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnFrameTimeChanged)));
    ...
    public static readonly RoutedEvent FrameTimeChangedEvent = EventManager.RegisterRoutedEvent("FrameTimeChanged", RoutingStrategy.Bubble,typeof(RoutedPropertyChangedEventHandler<double>), typeof(GUIFadelabel));
    ...
    protected static readonly DependencyProperty ScrollPositionProperty =DependencyProperty.Register("ScrollPosition", typeof(double), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnScrollPositionChanged)));
    ...
    protected static readonly RoutedEvent ScrollPositionChangedEvent = EventManager.RegisterRoutedEvent("ScrollPositionChanged", RoutingStrategy.Bubble,typeof(RoutedPropertyChangedEventHandler<double>), typeof(GUIFadelabel));
    ...
    public static readonly DependencyProperty IDProperty =DependencyProperty.Register("ID", typeof(int), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnIDChanged)));
    ...
    public static readonly RoutedEvent IDChangedEvent = EventManager.RegisterRoutedEvent("IDChanged", RoutingStrategy.Bubble,typeof(RoutedPropertyChangedEventHandler<int>), typeof(GUIFadelabel));
    ...
    public static readonly DependencyProperty OnUpProperty =DependencyProperty.Register("OnUp", typeof(int), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnUpChanged)));
    ...
    public static readonly DependencyProperty OnDownProperty =DependencyProperty.Register("OnDown", typeof(int), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnDownChanged)));
    ...
    public static readonly DependencyProperty OnLeftProperty =DependencyProperty.Register("OnLeft", typeof(int), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnLeftChanged)));
    ...
    public static readonly DependencyProperty OnRightProperty =DependencyProperty.Register("OnRight", typeof(int), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnRightChanged)));
    ...
    public static readonly DependencyProperty LabelProperty =DependencyProperty.Register("Label", typeof(string), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnLabelChanged)));
    ...
    public static readonly DependencyProperty HyperlinkProperty =DependencyProperty.Register("Hyperlink", typeof(string), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnHyperlinkChanged)));
    ...
    public static readonly DependencyProperty TextureProperty =DependencyProperty.Register("Texture", typeof(string), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnTextureChanged)));
    ...
    public static readonly DependencyProperty AlignProperty =DependencyProperty.Register("Align", typeof(TextAlignment), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnAlignChanged)));
    ...
    public static readonly DependencyProperty DisabledColorProperty =DependencyProperty.Register("DisabledColor", typeof(Brush), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnDisabledColorChanged)));
    ...
    public static readonly DependencyProperty PosYProperty =DependencyProperty.Register("PosY", typeof(double), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnPosYChanged)));
    ...
    public static readonly DependencyProperty PosXProperty =DependencyProperty.Register("PosX", typeof(double), typeof(GUIFadelabel),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnPosXChanged)));
