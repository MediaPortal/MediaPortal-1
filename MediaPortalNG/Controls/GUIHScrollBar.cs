...
namespace MediaPortal
{
  ...
  public class GUIHVScrollBar : ScrollBar, IGUIControl
  {
    ...
    public GUIHVScrollBar()
    {
      ...
      this.Loaded += new RoutedEventHandler(GUIHScrollBar_Loaded);

    }

    void GUIHScrollBar_Unloaded(object sender, RoutedEventArgs e)
    {
    }


    void GUIHScrollBar_Loaded(object sender, RoutedEventArgs e)
    {
    }
    ...
    public static readonly DependencyProperty IDProperty =DependencyProperty.Register("ID", typeof(int), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnIDChanged)));

    private static void OnIDChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
    {
      GUIHVScrollBar control = (GUIHVScrollBar)obj;
    ...
    public static readonly RoutedEvent IDChangedEvent = EventManager.RegisterRoutedEvent("IDChanged", RoutingStrategy.Bubble,typeof(RoutedPropertyChangedEventHandler<int>), typeof(GUIHVScrollBar));
    ...
    public static readonly DependencyProperty OnUpProperty =DependencyProperty.Register("OnUp", typeof(int), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnUpChanged)));
    ...
    public static readonly DependencyProperty OnDownProperty =DependencyProperty.Register("OnDown", typeof(int), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnDownChanged)));
    ...
    public static readonly DependencyProperty OnLeftProperty =DependencyProperty.Register("OnLeft", typeof(int), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnLeftChanged)));
    ...
    public static readonly DependencyProperty OnRightProperty =DependencyProperty.Register("OnRight", typeof(int), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnOnRightChanged)));
    ...
    public static readonly DependencyProperty LabelProperty =DependencyProperty.Register("Label", typeof(string), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnLabelChanged)));
    ...
    public static readonly DependencyProperty HyperlinkProperty =DependencyProperty.Register("Hyperlink", typeof(string), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnHyperlinkChanged)));
    ...
    public static readonly DependencyProperty TextureProperty =DependencyProperty.Register("Texture", typeof(string), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnTextureChanged)));
    ...
    public static readonly DependencyProperty AlignProperty =DependencyProperty.Register("Align", typeof(TextAlignment), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnAlignChanged)));
    ...
    public static readonly DependencyProperty DisabledColorProperty =DependencyProperty.Register("DisabledColor", typeof(Brush), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnDisabledColorChanged)));
    ...
    public static readonly DependencyProperty PosYProperty =DependencyProperty.Register("PosY", typeof(double), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnPosYChanged)));
    ...
    public static readonly DependencyProperty PosXProperty =DependencyProperty.Register("PosX", typeof(double), typeof(GUIHVScrollBar),new FrameworkPropertyMetadata(new PropertyChangedCallback(OnPosXChanged)));
