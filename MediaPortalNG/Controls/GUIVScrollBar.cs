...
namespace MediaPortal
{
    ...
    public class GUIVScrollBar : ScrollBar, IGUIControl
    {
        ...
        public GUIVScrollBar()
        {
            ...
            this.Loaded += new RoutedEventHandler(GUIVscrollBar_Loaded);

        }

        void GUIVscrollBar_Unloaded(object sender, RoutedEventArgs e)
        {
        }


        void GUIVscrollBar_Loaded(object sender, RoutedEventArgs e)
        {
        }
        ...
        DependencyProperty.Register("ID", typeof(int), typeof(GUIVScrollBar),
        ...
        {
            GUIVScrollBar control = (GUIVScrollBar)obj;
    ...
    typeof(RoutedPropertyChangedEventHandler<int>), typeof(GUIVScrollBar));
        ...
        DependencyProperty.Register("OnUP", typeof(int), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("OnDOWN", typeof(int), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("OnLEFT", typeof(int), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("OnRIGHT", typeof(int), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("Label", typeof(string), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("Hyperlink", typeof(string), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("Texture", typeof(string), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("Align", typeof(TextAlignment), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("DisabledColor", typeof(Brush), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("PosY", typeof(double), typeof(GUIVScrollBar),
        ...
        DependencyProperty.Register("PosX", typeof(double), typeof(GUIVScrollBar),
