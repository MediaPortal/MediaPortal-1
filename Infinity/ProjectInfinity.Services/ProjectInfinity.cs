...
namespace ProjectInfinity
{
    ...
    public class ProjectInfinity : Application
    {
        ...
        /// </summary>
        [MessagePublication(typeof(Messaging.SystemMessages.Startup))]
        ...
        /// main screen.
        /// </summary>
        [MessagePublication(typeof(Messaging.SystemMessages.StartupComplete))]
        ...
        [MessagePublication(typeof(Messaging.SystemMessages.SessionEnding))]
        ...
        /// </summary>
        /// <remarks>This is a cancelable event.</remarks>
        [MessagePublication(typeof(Messaging.SystemMessages.BeforeShutdown))]
        public event CancelEventHandler BeforeShutdown;

        [MessagePublication(typeof(Messaging.SystemMessages.Shutdown))]
        new public event EventHandler Shutdown;

        [MessagePublication(typeof(Messaging.SystemMessages.ShutdownComplete))]
        public event EventHandler ShutdownComplete;

        /// <summary>
        /// Occurs when ProjectInfinity becomes the foreground application.
        /// </summary>
        [MessagePublication(typeof(Messaging.SystemMessages.Activated))]
        new public event EventHandler Activated;

        /// <summary>
        /// Occurs when ProjectInfinity stops being the foreground application.
        /// </summary>
        [MessagePublication(typeof(Messaging.SystemMessages.Deactivated))]
