...
namespace MsSqlLibrary
{
    class ImportDAL
    {
        ...
        #region public static IMeedioItem GetImportProperties(IDbCommand Command, int ImportID)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Command"></param>
        ...
        /// <returns></returns>
        public static IMeedioItem GetImportProperties(IDbCommand Command, int ImportID)
        {
        ...
        #region private static IMeedioItem FillImportProperties(IDataReader Reader)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Reader"></param>
        /// <returns></returns>
        private static IMeedioItem FillImportProperties(IDataReader Reader)
        {
            IMeedioItem Properties = new MeedioItem() as IMeedioItem;
            try
            {
                while (Reader.Read())
                {
