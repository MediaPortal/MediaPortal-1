...
namespace MyWeather.Grabbers
{
    ...
    public class TestCatcher : IWeatherCatcher
    {
        ...
        {
            city.forecast = new List<DayForeCast>();
            city.forecast.Add(new DayForeCast(0));
            city.forecast.Add(new DayForeCast(1));
            city.forecast.Add(new DayForeCast(2));
            city.forecast.Add(new DayForeCast(3));
            city.currCondition = new CurrentCondition();
            city.currCondition.FillWithDummyData();
