...
namespace MyVideos
{
    public class VideoHomeViewModel : INotifyPropertyChanged
    {
        ...
        {
            get { return ServiceScope.Get<ILocalisation>().ToString("myvideos", 0); } // View
        }
    ...
    public class SortCommand : BaseCommand
    {
        ...
        public override void Execute(object parameter)
        {
            ...
            dlgMenu.SubTitle = "";
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 11)/*Name*/));
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 12)/*Date*/));
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 13)/*Size*/));
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 14)/*Year*/));
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 15)/*Rating*/));
            dlgMenu.Items.Add(new DialogMenuItem(ServiceScope.Get<ILocalisation>().ToString("myvideos", 16)/*DVD*/));
        }
    }
