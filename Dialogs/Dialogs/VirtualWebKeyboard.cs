...
namespace MediaPortal.Dialogs
{
  ...
  public class VirtualWebKeyboard : GUIWindow, IRenderLayer
  {
      ...
      public Key(Xkey key, int iwidth)
      {
        ...
        switch (xKey)
        {
          ...
          case Xkey.XK_PREWWW:
            strName = "www.";
            break;
          case Xkey.XK_POSTCOM:
            strName = ".com";
            break;
          case Xkey.XK_POSTNET:
            strName = ".net";
            break;
        }
      }
    ...
    public VirtualWebKeyboard()
    {
      GetID = (int)GUIWindow.Window.WINDOW_VIRTUAL_WEB_KEYBOARD;
    ...
    void InitBoard()
    {
      ...
      keyRow.Add(new Key(Xkey.XK_PREWWW, (KEY_WIDTH * 3) + (GAP_WIDTH * 1)));
      ...
      keyRow.Add(new Key(Xkey.XK_POSTCOM, (KEY_WIDTH * 3) + (GAP_WIDTH * 1)));
      ...
      keyRow.Add(new Key(Xkey.XK_POSTNET, (KEY_WIDTH * 3) + (GAP_WIDTH * 1)));
      ...
      keyRow.Add(new Key(Xkey.XK_SPACE, (KEY_WIDTH * 7) + (GAP_WIDTH * 5)));
      ...
      if (((uint)xk) < 0x10000 && xk != Xkey.XK_ARROWLEFT && xk != Xkey.XK_ARROWRIGHT)
      {
      ...
      else switch (xk)
        {
          ...
          case Xkey.XK_OK:
            ...
            break;
          case Xkey.XK_PREWWW:
            m_strData = m_strData.Insert(m_iPos, "www.");
            m_iPos = m_iPos + 4;
            break;
          case Xkey.XK_POSTCOM:
            m_strData = m_strData.Insert(m_iPos, ".com");
            m_iPos = m_iPos + 4;
            break;
          case Xkey.XK_POSTNET:
            m_strData = m_strData.Insert(m_iPos, ".net");
            m_iPos = m_iPos + 4;
            break;
        }
    }
