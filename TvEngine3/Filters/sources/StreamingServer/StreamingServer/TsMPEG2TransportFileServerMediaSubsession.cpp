...
TsMPEG2TransportFileServerMediaSubsession::createNew(UsageEnvironment& env,
						   char const* fileName,
...
FramedSource* TsMPEG2TransportFileServerMediaSubsession
::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate) {
  ...
  TsStreamFileSource* fileSource
    = TsStreamFileSource::createNew(envir(), fFileName, inputDataChunkSize);
...
RTPSink* TsMPEG2TransportFileServerMediaSubsession
