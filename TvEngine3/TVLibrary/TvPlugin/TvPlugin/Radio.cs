  ...
  public class Radio : WindowPluginBase, IComparer<GUIListItem>, ISetupForm, IShowPlugin
  {
    ...
    public static void Play ()
    {
      ...
      if ((_currentChannel.IsWebstream()) ||
          (_currentChannel.NextProgram == null || _currentChannel.NextProgram == null ||
           string.IsNullOrEmpty(_currentChannel.CurrentProgram.Title) ||
           string.IsNullOrEmpty(_currentChannel.NextProgram.Title)))
      {
