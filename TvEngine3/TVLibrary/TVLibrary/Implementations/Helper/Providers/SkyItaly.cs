...
namespace TvLibrary.Implementations.Helper.Providers
{
    ...
    : Provider
  {
    ...
    /// Singleton instance
    /// </summary>
    private static readonly SkyItaly _instance = new SkyItaly();

    private const uint INTERNAL_ID = 0x02;

    private const int SKY_ITALY_DEFAULT_TRANSPONDER_FREQUENCY = 11881000;
    private const string SKY_ITALY_DEFAULT_TRANSPONDER_POLARISATION = "Vertical";
    private const int SKY_ITALY_DEFAULT_TRANSPONDER_SYMBOL_RATE = 27500;
    private const string SKY_ITALY_DEFAULT_TRANSPONDER_INNER_FEC = "3/4";
    private const int SKY_ITALY_DEFAULT_NETWORK_ID = 0xFBFF;
    ...
    /// <summary>
    /// Gets the internal id for Sky Italy
    /// </summary>
    ...
    /// Gets the instance
    /// </summary>
    public static SkyItaly Instance
    {
      get
      {
        return _instance;
    ...
    /// <summary>
    /// Gets if the EPG should be grabbed for Sky Italy
    /// </summary>
    public bool EPGGrabbingEnabled
    {
      get
      {
        return GetSetting<bool>("SkyItalyGrabEPG", false);
      }
      set
      {
        SetSetting("SkyItalyGrabEPG", value);
      }
    }
    ...
    public DateTime LastEPGGrabTime
    {
      get
      {
        ...
        DateTime.TryParse(GetSetting<string>("SkyItalyLastEPGGrabTime", DateTime.MinValue.ToString()), out lastGrabTime);

        return lastGrabTime;
      }
      set
      {
        SetSetting("SkyItalyLastEPGGrabTime", value.ToString());
      }
    }
    ...
    public int DefaultTransponderFrequency
    {
      get
      {
        return GetSetting<int>("SkyItalyDefaultTransponderFrequency", SKY_ITALY_DEFAULT_TRANSPONDER_FREQUENCY);
      }
      set
      {
        SetSetting("SkyItalyDefaultTransponderFrequency", value);
      }
    }
    ...
    public string DefaultTransponderPolarisationString
    {
      get
      {
        return GetSetting<string>("SkyItalyDefaultTransponderPolarisation", SKY_ITALY_DEFAULT_TRANSPONDER_POLARISATION);
      }
      set
      {
        SetSetting("SkyItalyDefaultTransponderPolarisation", value);
      }
    }
    ...
    public Polarisation DefaultTransponderPolarisation
    {
      ...
      set
      {
        switch (value)
        {
          ...
          default:
            DefaultTransponderPolarisationString = SKY_ITALY_DEFAULT_TRANSPONDER_POLARISATION;
            break;
        }
      }
    }
    ...
    public int DefaultTransponderSymbolRate
    {
      get
      {
        return GetSetting<int>("SkyItalyDefaultTransponderSymbolRate", SKY_ITALY_DEFAULT_TRANSPONDER_SYMBOL_RATE);
      }
      set
      {
        SetSetting("SkyItalyDefaultTransponderSymbolRate", value);
      }
    }
    ...
    public string DefaultTransponderInnerFECString
    {
      get
      {
        return GetSetting<string>("SkyItalyDefaultTransponderInnerFEC", SKY_ITALY_DEFAULT_TRANSPONDER_INNER_FEC);
      }
      set
      {
        SetSetting("SkyItalyDefaultTransponderInnerFEC", value);
      }
    }
    ...
    public int NetworkId
    {
      get
      {
        return GetSetting<int>("SkyItalyNetworkId", SKY_ITALY_DEFAULT_NETWORK_ID);
      }
      set
      {
        SetSetting("SkyItalyNetworkId", value);
      }
    }
    ...
    {
      DefaultTransponderFrequency = SKY_ITALY_DEFAULT_TRANSPONDER_FREQUENCY;
      DefaultTransponderPolarisationString = SKY_ITALY_DEFAULT_TRANSPONDER_POLARISATION;
      DefaultTransponderSymbolRate = SKY_ITALY_DEFAULT_TRANSPONDER_SYMBOL_RATE;
      DefaultTransponderInnerFECString = SKY_ITALY_DEFAULT_TRANSPONDER_INNER_FEC;
      NetworkId = SKY_ITALY_DEFAULT_NETWORK_ID;
    }
