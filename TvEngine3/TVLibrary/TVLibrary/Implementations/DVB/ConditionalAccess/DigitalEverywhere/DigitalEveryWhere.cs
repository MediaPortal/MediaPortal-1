...
namespace TvLibrary.Implementations.DVB
{
  ...
  public class DigitalEverywhere : IDiSEqCController, ICiMenuActions, IDisposable
  {
    ...
    public bool CloseCIMenu()
    {
      ...
      CaData data = new CaData(DeCiMessageTag.Mmi);
      DVB_MMI.CreateMMIClose(ref data.Data);
      data.DataLength = 5;
      return SendMmi(data);
    }
    ...
    public bool SelectMenu(byte choice)
    {
      ...
      CaData data = new CaData(DeCiMessageTag.Mmi);
      DVB_MMI.CreateMMISelect(choice, ref data.Data);
      data.DataLength = 5;
      return SendMmi(data);
    }
    ...
    public bool SendMenuAnswer(bool cancel, String answer)
    {
      ...
      CaData data = new CaData(DeCiMessageTag.Mmi);
      DVB_MMI.CreateMMIAnswer(cancel, answer, ref data.Data, ref data.DataLength);
      return SendMmi(data);
    }
