...
{
  /// <summary>
  /// A Freesat service information grabber interface.
  /// </summary>
  [Guid("29979b9f-36f2-4e26-981f-57ceb77fbfc2"),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
  internal interface IGrabberSiFreesat : IGrabberSiDvb
  {
    /// <summary>
    ...
    [PreserveSig]
    new void GetServiceCount(out ushort actualOriginalNetworkId, out ushort serviceCount);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetService(ushort index,
                        out byte tableId,
                        ...
                        [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 51)] byte[] openTvChannelCategoryIds,
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetServiceNameByIndex(ushort serviceIndex,
                                    byte nameIndex,
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetServiceNameByLanguage(ushort serviceIndex,
                                      Iso639Code language,
                                      IntPtr providerName,
                                      ref ushort providerNameBufferSize,
                                      IntPtr serviceName,
    ...
    [PreserveSig]
    new byte GetNetworkNameCount(ushort networkId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetNetworkNameByIndex(ushort networkId,
                                    byte index,
                                    out Iso639Code language,
                                    IntPtr name,
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetNetworkNameByLanguage(ushort networkId,
                                      Iso639Code language,
                                      IntPtr name,
                                      ref ushort nameBufferSize);
    ...
    [PreserveSig]
    new byte GetBouquetNameCount(ushort bouquetId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetBouquetNameByIndex(ushort bouquetId,
                                    byte index,
                                    out Iso639Code language,
                                    IntPtr name,
                                    ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetBouquetNameByLanguage(ushort bouquetId,
                                      Iso639Code language,
                                      IntPtr name,
                                      ref ushort nameBufferSize);
    ...
    [PreserveSig]
    new byte GetTargetRegionNameCount(ulong regionId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetTargetRegionNameByIndex(ulong regionId,
                                        byte index,
                                        out Iso639Code language,
                                        IntPtr name,
                                        ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetTargetRegionNameByLanguage(ulong regionId,
                                            Iso639Code language,
                                            IntPtr name,
                                            ref ushort nameBufferSize);
    ...
    [PreserveSig]
    new byte GetCyfrowyPolsatChannelCategoryNameCount(byte categoryId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetCyfrowyPolsatChannelCategoryNameByIndex(byte categoryId,
                                                        byte index,
                                                        out Iso639Code language,
                                                        IntPtr name,
                                                        ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetCyfrowyPolsatChannelCategoryNameByLanguage(byte categoryId,
                                                            Iso639Code language,
                                                            IntPtr name,
                                                            ref ushort nameBufferSize);
    ...
    [PreserveSig]
    new ushort GetTransmitterCount();
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    new bool GetTransmitter(ushort index,
                            out byte tableId,
