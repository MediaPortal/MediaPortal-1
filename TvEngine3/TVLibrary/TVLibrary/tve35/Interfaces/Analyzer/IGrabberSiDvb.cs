...
namespace Mediaportal.TV.Server.TVLibrary.Interfaces.Analyzer
{
  ...
  internal interface IGrabberSiDvb
  {
    ...
    [PreserveSig]
    byte GetCyfrowyPolsatChannelCategoryNameCount(byte categoryId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetCyfrowyPolsatChannelCategoryNameByIndex(byte categoryId,
                                                    byte index,
                                                    out Iso639Code language,
                                                    IntPtr name,
                                                    ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetCyfrowyPolsatChannelCategoryNameByLanguage(byte categoryId,
                                                        Iso639Code language,
                                                        IntPtr name,
                                                        ref ushort nameBufferSize);
    ...
    [PreserveSig]
    byte GetFreesatRegionNameCount(uint regionId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetFreesatRegionNameByIndex(uint regionId,
                                      byte index,
                                      out Iso639Code language,
                                      IntPtr name,
                                      ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetFreesatRegionNameByLanguage(uint regionId,
                                        Iso639Code language,
                                        IntPtr name,
                                        ref ushort nameBufferSize);
    ...
    [PreserveSig]
    byte GetFreesatChannelCategoryNameCount(uint categoryId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetFreesatChannelCategoryNameByIndex(uint categoryId,
                                              byte index,
                                              out Iso639Code language,
                                              IntPtr name,
                                              ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetFreesatChannelCategoryNameByLanguage(uint categoryId,
                                                  Iso639Code language,
                                                  IntPtr name,
                                                  ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetMediaHighwayChannelCategoryName(ushort categoryId,
                                            IntPtr name,
                                            ref ushort nameBufferSize);
    ...
    [PreserveSig]
    byte GetNorDigChannelListNameCount(ulong channelListId);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetNorDigChannelListNameByIndex(ulong channelListId,
                                          byte index,
                                          out Iso639Code language,
                                          IntPtr name,
                                          ref ushort nameBufferSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetNorDigChannelListNameByLanguage(ulong channelListId,
                                            Iso639Code language,
                                            IntPtr name,
                                            ref ushort nameBufferSize);
