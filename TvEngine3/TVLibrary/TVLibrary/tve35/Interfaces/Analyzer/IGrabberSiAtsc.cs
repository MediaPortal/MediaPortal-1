...
{
  /// <summary>
  /// An ATSC service information grabber interface.
  /// </summary>
  [Guid("9769a108-9b39-403a-9fe8-60991095231f"),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
  internal interface IGrabberSiAtsc
  {
    /// <summary>
    ...
    /// <summary>
    /// Get the number of ATSC channels received by the grabber from the long-form virtual channel table.
    /// </summary>
    /// <returns>the number of ATSC channels received by the grabber from the LVCT</returns>
    [PreserveSig]
    ushort GetLvctChannelCount();

    /// <summary>
    /// Retrieve an ATSC long-form virtual channel's details from the grabber.
    /// </summary>
    ...
    /// <param name="sourceId">The identifier of the source that the channel is associated with. Refer to ATSC specifications for further detail.</param>
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetLvctChannelLongNameByIndex(ushort channelIndex,
                                        byte nameIndex,
    ...
    /// <param name="splice">An indication of whether a splice is point is anticipated. Refer to ATSC specifications for further detail.</param>
    ...
    /// <param name="accessControlled">An indication of whether the channel's sub-streams are encrypted or not.</param>
    /// <param name="hideGuide">An indication of whether the channel is intended to be visible in the electronic programme guide.</param>
    /// <param name="serviceType">The channel's service type, encoded according to ATSC specifications.</param>
    /// <param name="outOfBand">An indication of whether the channel is transmitted in an out-of-band transmission path. Only applicable for cable channels. Refer to ATSC specifications for further detail.</param>
    ...
    /// <param name="pathSelect">The physical transmission path that the channel is associated with. Only applicable for cable channels. Refer to ATSC specifications for further detail.</param>
    /// <param name="channelType">The channel's type, encoded according to ATSC specifications. This field partially indicates which other fields will be populated.</param>
    ...
    /// <param name="transportType">The type of transport (eg. digital MPEG 2 TS, analog) used to transmit the channel, encoded according to ATSC specifications.</param>
    ...
    /// <param name="waveformStandard">The waveform standard of the channel's transmission, encoded according to ATSC specifications. Not applicable for MPEG 2 transport.</param>
    /// <param name="videoStandard">The channel's video standard, encoded according to ATSC specifications. Not applicable for MPEG 2 transport.</param>
    ...
    /// <param name="modulationFormat">The modulation format of the channel's transmitter, encoded according to ATSC specifications.</param>
    /// <returns><c>true</c> if the channel's details are successfully retrieved, otherwise <c>false</c></returns>
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
