namespace SetupTv.Sections
{
  partial class XmlSetup
  {
    ...
    private void InitializeComponent()
    {
			...
			this.dataGridChannelMappings.RowHeadersDefaultCellStyle = dataGridViewCellStyle12;
			...
			this.tuningChannel.DefaultCellStyle = dataGridViewCellStyle10;
			...
			this.guideChannel.DefaultCellStyle = dataGridViewCellStyle11;
