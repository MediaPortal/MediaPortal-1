...
namespace ProcessPlugins.EpgGrabber
{
    public partial class Zap2itPluginConfig : SetupTv.SectionSettings
    {
        ...
        /// </summary>
        public Zap2itPluginConfig() : this("Zap2It")
        {
           //InitializeComponent();
        }
        ...
        /// Initializes a new instance of the <see cref="T:PluginConfig"/> class.
        /// </summary>
        public Zap2itPluginConfig(string name) : base(name)
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            if (lineupManager != null) e.Result = lineupManager.RetrieveLineups();
        }
        ...
        {
            Zap2it.WebEntities.WebLineup lineup = (Zap2it.WebEntities.WebLineup)toolStripLineups.SelectedItem;
            if (lineupManager != null) e.Result = lineupManager.RetrieveChannelsForLineup(lineup);
        }
