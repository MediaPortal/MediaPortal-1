...
namespace ProcessPlugins.EpgGrabber
{
    public static class PluginSettings
    {
        ...
        {
            get { return DateTime.Parse(tvLayer.GetSetting(Zap2itPlugin.PLUGIN_NAME + "_NextPoll", DateTime.Now.ToString("s")).Value); }
            set 
            {
        ...
        {
            get { return tvLayer.GetSetting(Zap2itPlugin.PLUGIN_NAME + "_UserName", string.Empty).Value; }
            set 
            {
        ...
        {
            get { return Int32.Parse(tvLayer.GetSetting(Zap2itPlugin.PLUGIN_NAME + "_GuideDays", "5").Value); }
            set 
            {
