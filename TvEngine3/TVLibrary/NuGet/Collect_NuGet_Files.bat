...
rem xcopy "..\..\..\..\Packages\MediaInfo.0.7.69\MediaInfo.dll" "References" /R /Y
xcopy "..\..\TvService\bin\%TARGET%\x86\*.*" "References\x86" /R /Y
xcopy "..\..\TvService\bin\%TARGET%\MediaInfo.Wrapper.dll" "References" /R /Y
