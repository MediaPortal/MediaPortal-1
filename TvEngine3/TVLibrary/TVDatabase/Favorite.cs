...
namespace TvDatabase
{
  ...
  public class Favorite : Persistent
  {
    ...
    [TableColumn("idFavorite", NotNull = true), PrimaryKey(AutoGenerated = true)]
    ...
    {
      return Broker.RetrieveList(typeof(Favorite));
    }
    ...
    public static Favorite Retrieve(int id)
    {
      ...
      return Broker.RetrieveInstance(typeof(Favorite), key) as Favorite;
    }
