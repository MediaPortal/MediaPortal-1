...
namespace TvDatabase
{
  ...
  public class Server : Persistent
  {
    ...
    [TableColumn("idServer", NotNull = true), PrimaryKey(AutoGenerated = true)]
    private int idServer;
    [TableColumn("isMaster", NotNull = true)]
    private bool isMaster;
    [TableColumn("hostName", NotNull = true)]
    ...
    {
      get { return isMaster; }
      set { isChanged |= isMaster != value; isMaster = value; }
    }
    ...
    {
      get { return hostName; }
      set { isChanged |= hostName != value; hostName = value; }
    }
    #endregion
