...
namespace TvDatabase
{
  ...
  public class Recording : Persistent
  {
    ...
    [TableColumn("idSchedule", NotNull = true), ForeignKey("Schedule", "idSchedule")]
    private int idSchedule;
    [TableColumn("isRecording", NotNull = false)]
    ...
    /// </summary> 
    public Recording(int idChannel, int idSchedule, bool isRecording, DateTime startTime, DateTime endTime, string title, string description, string genre,
    ...
    /// </summary> 
    public Recording(int idRecording, bool isRecording, int idSchedule, int idChannel, DateTime startTime, DateTime endTime, string title,
