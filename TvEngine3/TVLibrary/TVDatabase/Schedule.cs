...
namespace TvDatabase
{
  ...
  public class Schedule : Persistent
  {
    ...
    [TableColumn("idParentSchedule", NotNull = true), ForeignKey("Channel", "idParentSchedule")] private int idParentSchedule;
    ...
    /// </summary> 
    public Schedule(int idChannel, int idParentSchedule, int scheduleType, string programName, DateTime startTime, DateTime endTime,
    ...
    /// </summary> 
    public Schedule(int idSchedule, int idParentSchedule, int idChannel, int scheduleType, string programName, DateTime startTime,
    ...
    public void UnCancelSerie()
    {
      foreach (CanceledSchedule schedule in ReferringCanceledSchedule())
      {
        ...
        Program.SetSingleStateSeriesPending(schedule.CancelDateTime, schedule.ReferencedSchedule().ReferencedChannel().IdChannel, schedule.ReferencedSchedule().ProgramName);
        //}
      }
      return;
    }
    ...
    {
      Schedule schedule = new Schedule(IdChannel, idParentSchedule, scheduleType, ProgramName, StartTime, EndTime, MaxAirings, Priority,
