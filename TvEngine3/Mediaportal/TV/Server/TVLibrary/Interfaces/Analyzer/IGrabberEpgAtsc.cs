...
{
  /// <summary>
  /// An ATSC electronic programme guide grabber interface.
  /// </summary>
  [Guid("615ab76a-7a85-45f8-abf8-5bbab30aa26d"),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
  internal interface IGrabberEpgAtsc
  {
    /// <summary>
    ...
    /// <summary>
    /// Get the number of ATSC events received by the grabber.
    /// </summary>
    /// <returns>the number of ATSC events received by the grabber</returns>
    [PreserveSig]
    uint GetEventCount();

    /// <summary>
    /// Retrieve an ATSC event's details from the grabber.
    /// </summary>
    ...
    /// <summary>
    /// Retrieve an ATSC event's text from the grabber.
    /// </summary>
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetEventTextByIndex(uint eventIndex,
                              byte textIndex,
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.I1)]
    bool GetEventTextByLanguage(uint eventIndex,
                                Iso639Code language,
                                IntPtr title,
                                ref ushort titleBufferSize,
                                IntPtr text,
