...
namespace Mediaportal.TV.Server.TVLibrary.Implementations
{
  ...
  internal abstract class TunerBase : ITunerInternal, ITuner, IDisposable
  {
    ...
    // This implementation exists to enable tuner sub-classes to easily
    // implement tuner extension interfaces without having to implement
    // additional, unnecessary tuner extension base interface methods.
