...
namespace Mediaportal.TV.Server.TVLibrary.Implementations.DVB.Graphs.DVBS
{
  ...
  public class TvCardDVBS : TvCardDvbBase
  {
    ...
    {
        get { return LogHelper.GetLogger(typeof(TvCardDVBS)); }
    }
    ...
    {
      Log.DebugFormat("TvCardDvbS: build graph");
      base.BuildGraph();
      ...
      foreach (ICustomDevice deviceInterface in _customDeviceInterfaces)
      {
        ...
        {
          Log.DebugFormat("TvCardDvbS: found DiSEqC command interface");
    ...
    {
      Log.DebugFormat("TvCardDvbS: create tuning space");
      ...
      if (container == null)
      {
        Log.ErrorFormat("TvCardDvbS: failed to get the tuning space container");
        return;
      }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          {
            Log.DebugFormat("TvCardDvbS: found correct tuningspace");
      ...
      Log.DebugFormat("TvCardDvbS: create new tuningspace");
    ...
    protected override ITuneRequest AssembleTuneRequest(IChannel channel)
    {
      ...
      if (dvbsChannel == null)
      {
        Log.DebugFormat("TvCardDvbS: channel is not a DVB-S channel!!! {0}", channel.GetType().ToString());
        return null;
      }
