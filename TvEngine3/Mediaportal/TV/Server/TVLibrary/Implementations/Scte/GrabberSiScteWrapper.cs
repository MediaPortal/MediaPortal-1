...
{
  /// <summary>
  /// This implementation of <see cref="IGrabberSiScte"/> only exists because
  /// attempting to cast the interface implementation exposed by TsWriter
  /// (CGrabberSiAtscScte with PID 0x1ffc) to <see cref="IGrabberSiAtsc"/>
  /// causes TsWriter/COM to switch to a different implementation
  /// (CGrabberSiAtscScte with PID 0x1ffb).
  /// </summary>
  internal class GrabberSiScteWrapper : IGrabberSiScte
  {
    private IGrabberSiScte _grabber = null;

    public GrabberSiScteWrapper(IGrabberSiScte grabber)
    {
      _grabber = grabber;
    }
    ...
    public bool IsSeenLvct()
    {
      return _grabber.IsSeenLvct();
    }
    ...
    public bool IsReadyLvct()
    {
      return _grabber.IsReadyLvct();
    }
    ...
    public ushort GetLvctChannelCount()
    {
      return _grabber.GetLvctChannelCount();
    }
    ...
    public bool GetLvctChannel(ushort index,
                                out byte tableId,
    ...
    {
      return _grabber.GetLvctChannel(index,
                                      out tableId,
    ...
    public bool GetLvctChannelLongNameByIndex(ushort channelIndex,
                                              byte nameIndex,
                                              out Iso639Code language,
                                              IntPtr name,
                                              ref ushort nameBufferSize)
    {
      return _grabber.GetLvctChannelLongNameByIndex(channelIndex,
                                                    nameIndex,
                                                    out language,
                                                    name,
                                                    ref nameBufferSize);
    ...
    /// <param name="nameBufferSize">As an input, the size of the <paramref name="name">long name buffer</paramref>; as an output, the consumed buffer size.</param>
    /// <returns><c>true</c> if the channel's long name is successfully retrieved, otherwise <c>false</c></returns>
    public bool GetLvctChannelLongNameByLanguage(ushort channelIndex,
                                                  Iso639Code language,
                                                  IntPtr name,
                                                  ref ushort nameBufferSize)
    {
      return _grabber.GetLvctChannelLongNameByLanguage(channelIndex,
                                                        language,
                                                        name,
                                                        ref nameBufferSize);
    }
    ...
    public bool IsSeenSvct()
    {
      return _grabber.IsSeenSvct();
    }
    ...
    public bool IsReadySvct()
    {
      return _grabber.IsReadySvct();
    }
    ...
    public ushort GetSvctVirtualChannelCount()
    {
      return _grabber.GetSvctVirtualChannelCount();
    }
    ...
    /// <returns><c>true</c> if the channel's details are successfully retrieved, otherwise <c>false</c></returns>
    public bool GetSvctVirtualChannel(ushort index,
                                        ...
                                        out bool hdtvChannel,
                                        out bool preferredSource,
                                        out bool applicationVirtualChannel,
                                        out ushort majorChannelNumber,
                                        out ushort minorChannelNumber,
                                        out ushort sourceId,
                                        ...
                                        out bool splitBitstreamMode,
                                        out ModulationFormat modulationFormat)
    {
      return _grabber.GetSvctVirtualChannel(index,
    ...
    public ushort GetSvctDefinedChannelCount()
    {
      return _grabber.GetSvctDefinedChannelCount();
    }
    ...
    /// <returns><c>true</c> if the channel's details are successfully retrieved, otherwise <c>false</c></returns>
    public bool GetSvctDefinedChannel(ushort index,
                                      out TransmissionMedium transmissionMedium,
                                      out ushort vctId,
                                      out ushort virtualChannelNumber)
    {
      return _grabber.GetSvctDefinedChannel(index,
                                            out transmissionMedium,
                                            out vctId,
                                            out virtualChannelNumber);
    }
    ...
    public void OnOutOfBandSectionReceived(byte[] sectionData,
                                            ushort sectionDataBufferSize)
    {
      _grabber.OnOutOfBandSectionReceived(sectionData, sectionDataBufferSize);
    }
  }
}