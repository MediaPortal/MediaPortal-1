...
namespace Mediaportal.TV.Server.Plugins.TunerExtension.DigitalDevices.Service
{
  ...
  [ServiceKnownType(typeof(DigitalDevicesCiSlotConfig))]
  internal interface IDigitalDevicesConfigService
  {
    [OperationContract]
    ICollection<DigitalDevicesCiSlotConfig> GetAllSlotConfiguration();

    [OperationContract]
    void SaveAllSlotConfiguration(ICollection<DigitalDevicesCiSlotConfig> settings);
