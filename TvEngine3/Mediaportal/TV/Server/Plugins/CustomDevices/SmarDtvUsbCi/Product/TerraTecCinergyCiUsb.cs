...
{
  internal class TerraTecCinergyCiUsb : SmarDtvUsbCiProductBase
  {
    ...
    private ITerraTecCinergyCiUsb _interface = null;

    #endregion

    /// <summary>
    /// Initialise a new instance of the <see cref="TerraTecCinergyCiUsb"/> class.
    /// </summary>
    public TerraTecCinergyCiUsb()
      : base("TerraTec Cinergy CI USB", "US2CIBDA", "Cinergy CI USB Capture", "cinergyCiUsbTuner")
    {
    ...
    public override IBaseFilter Initialise()
    {
      ...
      _interface = _filter as ITerraTecCinergyCiUsb;
      return _filter;
    }
    ...
    public override int OpenInterface(ref SmarDtvUsbCiCallBack callBack)
    {
    ...
    public override int GetVersionInfo(out SmarDtvUsbCiVersionInfo versionInfo)
    {
    ...
    {
      base.Deinitialise();
      Release.ComObject("SmarDTV USB CI TerraTec Cinergy CI USB filter", ref _filter);
      _interface = null;
    }
  }
}