...
{
  partial class XmlTvImportConfig
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.labelDataOrListFile = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      this.buttonDataOrListFileBrowse = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.textBoxDataOrListFile = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPTextBox();
      this.groupBoxTimeCorrection = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPGroupBox();
      this.numericUpDownTimeCorrectionMinutes = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPNumericUpDown();
      this.numericUpDownTimeCorrectionHours = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPNumericUpDown();
      ...
      this.numericUpDownScheduledActionsTimeFrequency = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPNumericUpDown();
      this.labelScheduledActionsTimeBetween = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      this.dateTimePickerScheduledActionsTimeBetweenEnd = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPDateTimePicker();
      this.radioButtonScheduledActionsTimeStartup = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPRadioButton();
      this.buttonScheduledActionsTimeNow = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.radioButtonScheduledActionsTimeBetween = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPRadioButton();
      this.dateTimePickerScheduledActionsTimeBetweenStart = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPDateTimePicker();
      ...
      this.openFileDialogScheduledActionsProgram = new System.Windows.Forms.OpenFileDialog();
      this.openFileDialogDataOrListFile = new System.Windows.Forms.OpenFileDialog();
      ...
      this.labelImport.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                  | System.Windows.Forms.AnchorStyles.Right)));
      this.labelImport.Location = new System.Drawing.Point(3, 60);
      this.labelImport.Name = "labelImport";
      this.labelImport.Size = new System.Drawing.Size(448, 41);
      this.labelImport.TabIndex = 3;
      this.labelImport.Text = "TV Server automatically imports when any of the data files change. You can also f" +
          "orce an import using the button below. Importing can take several minutes to com" +
          "plete so please be patient.";
      // 
      // buttonImport
      // 
      this.buttonImport.Location = new System.Drawing.Point(151, 104);
      ...
      // labelDataOrListFile
      // 
      this.labelDataOrListFile.AutoSize = true;
      this.labelDataOrListFile.Location = new System.Drawing.Point(3, 16);
      this.labelDataOrListFile.Name = "labelDataOrListFile";
      this.labelDataOrListFile.Size = new System.Drawing.Size(136, 13);
      this.labelDataOrListFile.TabIndex = 0;
      this.labelDataOrListFile.Text = "Data (XML) or list (LST) file:";
      // 
      // buttonDataOrListFileBrowse
      // 
      this.buttonDataOrListFileBrowse.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
      this.buttonDataOrListFileBrowse.Location = new System.Drawing.Point(427, 30);
      this.buttonDataOrListFileBrowse.Name = "buttonDataOrListFileBrowse";
      ...
      // 
      this.textBoxDataOrListFile.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                  | System.Windows.Forms.AnchorStyles.Right)));
      this.textBoxDataOrListFile.Location = new System.Drawing.Point(6, 32);
      this.textBoxDataOrListFile.Name = "textBoxDataOrListFile";
      this.textBoxDataOrListFile.Size = new System.Drawing.Size(415, 20);
      this.textBoxDataOrListFile.TabIndex = 1;
      this.textBoxDataOrListFile.TextChanged += new System.EventHandler(this.textBoxDataOrListFile_TextChanged);
      // 
      ...
      this.numericUpDownTimeCorrectionMinutes.Maximum = new decimal(new int[] {
            ...
            0,
            0});
      this.numericUpDownTimeCorrectionMinutes.Minimum = new decimal(new int[] {
            59,
            0,
            0,
            -2147483648});
      ...
      this.labelTimeCorrectionList.Size = new System.Drawing.Size(353, 13);
      this.labelTimeCorrectionList.TabIndex = 5;
      this.labelTimeCorrectionList.Text = "Note list files enable you to specify separate corrections for each data file.";
      // 
      ...
      this.groupBoxScheduledActionsTime.Controls.Add(this.radioButtonScheduledActionsTimeStartup);
      ...
      this.groupBoxScheduledActionsStatus.Text = "Action Status";
      // 
      ...
      this.buttonScheduledActionsProgramBrowse.Location = new System.Drawing.Point(415, 95);
      ...
      this.textBoxScheduledActionsProgramLocation.Size = new System.Drawing.Size(384, 20);
      ...
      // 
      // openFileDialogScheduledActionsProgram
      // 
      this.openFileDialogScheduledActionsProgram.Filter = "Executables (*.exe, *.bat)|*.exe;*.bat|All Files|*.*";
      this.openFileDialogScheduledActionsProgram.Title = "Select a program or batch script.";
      // 
      // openFileDialogDataOrListFile
      // 
      this.openFileDialogDataOrListFile.Filter = "Data Files (*.xml, *.xmltv)|*.xml;*.xmltv|List Files (*.lst)|*.lst|All Files|*.*";
      this.openFileDialogDataOrListFile.Title = "Select an XMLTV data or list file.";
      // 
    ...
    private MPButton buttonDataOrListFileBrowse;
    private MPLabel labelDataOrListFile;
    private MPTextBox textBoxDataOrListFile;
    ...
    private MPRadioButton radioButtonScheduledActionsTimeStartup;
    private MPRadioButton radioButtonScheduledActionsTimeBetween;
    private MPDateTimePicker dateTimePickerScheduledActionsTimeBetweenStart;
    ...
    private System.Windows.Forms.OpenFileDialog openFileDialogScheduledActionsProgram;
    private MPLabel labelScheduledActionsTimeBetween;
    private MPDateTimePicker dateTimePickerScheduledActionsTimeBetweenEnd;
    private MPNumericUpDown numericUpDownTimeCorrectionMinutes;
    private MPNumericUpDown numericUpDownTimeCorrectionHours;
    private MPLabel labelScheduledActionsTimeHours;
    private MPNumericUpDown numericUpDownScheduledActionsTimeFrequency;
    private System.Windows.Forms.OpenFileDialog openFileDialogDataOrListFile;
