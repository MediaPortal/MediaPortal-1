...
{
  /// <summary>
  /// Tuner channel linkage scanner interface.
  /// </summary>
  public interface IChannelLinkageScanner
  {
    /// <summary>
    /// Starts scanning for linkages
    /// </summary>
    void Start(IChannelLinkageScannerCallBack callBack);
    ...
    /// </summary>
    List<PortalChannel> ChannelLinkages
    {
      get;
    }
  }
