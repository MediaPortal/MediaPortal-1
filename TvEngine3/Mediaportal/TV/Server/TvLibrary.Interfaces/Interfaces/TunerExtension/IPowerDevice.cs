...
{
  /// <summary>
  /// An interface for tuners that are responsible for supplying power to other
  /// connected elements (such as aerials, LNBs, amplifiers and switches) or
  /// that can be manually powered down/up to reduce power consumption.
  /// </summary>
  public interface IPowerDevice : ITunerExtension
  {
    /// <summary>
