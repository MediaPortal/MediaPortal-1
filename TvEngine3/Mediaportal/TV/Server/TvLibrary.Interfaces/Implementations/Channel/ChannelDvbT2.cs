...
{
  /// <summary>
  /// An implementation of <see cref="T:IChannel"/> for DVB-T2 channels.
  /// </summary>  
  [DataContract]
  public class ChannelDvbT2 : ChannelOpenTvBase, IChannelDvb, IChannelOfdm
  {
    #region variables
    ...
    public override bool IsDifferentTransmitter(IChannel channel)
    {
      ...
      if (
        dvbt2Channel == null ||
        Frequency != dvbt2Channel.Frequency ||
        Bandwidth != dvbt2Channel.Bandwidth ||
        PlpId != dvbt2Channel.PlpId
      )
      {
        return true;
      }
    ...
    {
      ChannelDvbT2 channel = obj as ChannelDvbT2;
      if (
        channel == null ||
        !base.Equals(obj) ||
    ...
    {
      return string.Format("DVB-T2, {0}, frequency = {1} kHz, bandwidth = {2} kHz, PLP ID = {3}",
