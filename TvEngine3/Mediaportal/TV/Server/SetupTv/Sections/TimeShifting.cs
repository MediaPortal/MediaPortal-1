...
{
  public partial class TimeShifting : SectionSettings
  {
    ...
    public TimeShifting(ServerConfigurationChangedEventHandler handler)
    ...
    public override void OnSectionActivated()
    {
      ...
      _parkTimeLimit = ServiceAgents.Instance.SettingServiceAgent.GetValue("parkTimeLimit", 10);
    ...
    public override void OnSectionDeActivated()
    {
      ...
      if (_parkTimeLimit != numericUpDownParkTimeLimit.Value)
      {
        ...
        ServiceAgents.Instance.SettingServiceAgent.SaveValue("parkTimeLimit", (int)numericUpDownParkTimeLimit.Value);
        needReload = true;
      }
