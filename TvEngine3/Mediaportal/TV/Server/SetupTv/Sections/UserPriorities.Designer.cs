...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  partial class UserPriorities
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBox11 = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPGroupBox();
      this.numDefaultUser = new System.Windows.Forms.NumericUpDown();
      this.lblUsers = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      this.numScheduler = new System.Windows.Forms.NumericUpDown();
      this.lblScheduler = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      this.numEpgGrabber = new System.Windows.Forms.NumericUpDown();
      this.lblEPG = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      ...
      this.groupBox10.Text = "Custom User Priorities";
      // 
      // gridUserPriorities
      // 
      ...
      this.gridUserPriorities.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
      ...
      this.gridUserPriorities.DefaultCellStyle = dataGridViewCellStyle2;
      ...
      this.gridUserPriorities.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
