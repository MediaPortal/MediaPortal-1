...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  partial class Channels
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.lblFilterLabel = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPLabel();
      ...
      this.mpButtonPreview = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpButtonClear = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpGroupBox3 = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPGroupBox();
      this.mpButtonDeleteEncrypted = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpButtonUncheckEncrypted = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpGroupBox2 = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPGroupBox();
      this.mpButtonDelGroup = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpButtonAddGroup = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      this.mpButtonRenameGroup = new Mediaportal.TV.Server.SetupControls.UserInterfaceControls.MPButton();
      ...
      this.mpListView1.Size = new System.Drawing.Size(453, 209);
