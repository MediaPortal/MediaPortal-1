...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  partial class Recording
  {
    ...
    "%";
      ...
      this.groupBoxThumbnailer.Controls.Add(this.numericUpDownThumbnailerRowCount);
      ...
      this.numericUpDownThumbnailerRowCount.Maximum = new decimal(new int[] {
            ...
            0,
            0});
      this.numericUpDownThumbnailerRowCount.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      ...
      this.numericUpDownThumbnailerColumnCount.Maximum = new decimal(new int[] {
            ...
            0,
            0});
      this.numericUpDownThumbnailerColumnCount.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
