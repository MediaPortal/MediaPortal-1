...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  public partial class TvRecording : SectionSettings
  {
    ...
    public override void OnSectionActivated()
    {
      ...
      // database tab
      IList<Recording> allRecordings = ServiceAgents.Instance.RecordingServiceAgent.ListAllRecordings();
      try
      {
      ...
      ThreadPool.QueueUserWorkItem(
        delegate
        {
          try
          {
            ...
            foreach (Recording r in allRecordings)
            {
    ...
    private void buttonRecordingChangeChannel_Click(object sender, EventArgs e)
    {
      ...
      int mediaType = -1;
      List<Recording> recordings = new List<Recording>(items.Count);
      ...
      try
      {
        ...
        Dictionary<int, Recording> savedRecordings = new Dictionary<int, Recording>(recordings.Count);
