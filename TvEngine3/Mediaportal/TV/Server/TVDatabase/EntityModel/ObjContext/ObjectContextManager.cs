...
namespace Mediaportal.TV.Server.TVDatabase.EntityModel.ObjContext
{
  public static class ObjectContextManager
  {
    ...
    private static void InsertInitialValues(Model model)
    {
      ...
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 2, Name = "C-Band", LowBandFrequency = 5150000, HighBandFrequency = -1, SwitchFrequency = -1, IsBandStacked = false });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 3, Name = "10700 MHz", LowBandFrequency = 10700000, HighBandFrequency = -1, SwitchFrequency = -1, IsBandStacked = false });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 4, Name = "10750 MHz", LowBandFrequency = 10750000, HighBandFrequency = -1, SwitchFrequency = -1, IsBandStacked = false });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 5, Name = "11250 MHz (NA Legacy)", LowBandFrequency = 11250000, HighBandFrequency = -1, SwitchFrequency = -1, IsBandStacked = false });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 6, Name = "11300 MHz", LowBandFrequency = 11300000, HighBandFrequency = -1, SwitchFrequency = -1, IsBandStacked = false });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 7, Name = "DishPro Band-Stacked FSS", LowBandFrequency = 10750000, HighBandFrequency = 13850000, SwitchFrequency = -1, IsBandStacked = true });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 8, Name = "DishPro Band-Stacked DBS", LowBandFrequency = 11250000, HighBandFrequency = 14350000, SwitchFrequency = -1, IsBandStacked = true });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 9, Name = "NA Band-Stacked FSS", LowBandFrequency = 10750000, HighBandFrequency = 10175000, SwitchFrequency = -1, IsBandStacked = true });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 10, Name = "NA Band-Stacked DBS", LowBandFrequency = 11250000, HighBandFrequency = 10675000, SwitchFrequency = -1, IsBandStacked = true });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 11, Name = "Sadoun Band-Stacked", LowBandFrequency = 10100000, HighBandFrequency = 10750000, SwitchFrequency = -1, IsBandStacked = true });
      model.LnbTypes.AddObject(new LnbType { IdLnbType = 12, Name = "C-Band Band-Stacked", LowBandFrequency = 5150000, HighBandFrequency = 5750000, SwitchFrequency = -1, IsBandStacked = true });
