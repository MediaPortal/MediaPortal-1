...
namespace Mediaportal.TV.Server.TVDatabase.EntityModel.ObjContext
{
  public static class ObjectContextManager
  {
    ...
    public static void SetupStaticValues(Model ctx)
    {
      ...
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 1, Priority = 1, ClassId = "{4d997eb1-46f5-4818-b5ce-6900aa7ed43b}", Name = "AVerMedia" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 2, Priority = 2, ClassId = "{0a775550-00f0-4b13-a454-3f8eab4ac0b6}", Name = "Hauppauge SoftMCE [combined MainConcept]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 3, Priority = 3, ClassId = "{ae5660ae-7e08-48e6-a738-7ee6338c614f}", Name = "Hauppauge SoftMCE [MainConcept]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 4, Priority = 4, ClassId = "{c251e660-2ff5-4db1-8235-ab35bdcaf95e}", Name = "Hauppauge SoftPVR [MainConcept]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 5, Priority = 5, ClassId = "{4ffff691-cc45-4372-9635-ca5151ba2bff}", Name = "KWorld [CyberLink]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 6, Priority = 6, ClassId = "{cf486bca-92de-4290-bcb4-ad4b5fef6668}", Name = "Medion PowerCinema [CyberLink]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 7, Priority = 7, ClassId = "{36b46e60-d240-11d2-8f3f-0080c84e9806}", Name = "Medion PowerVCR II [CyberLink]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 8, Priority = 8, ClassId = "{de37b729-3c95-44dc-a0e0-c0a956736fa6}", Name = "PCTV Systems" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 9, Priority = 9, ClassId = "{215817f3-b2ad-4b28-af04-252e8936dee1}", Name = "Pinnacle" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 10, Priority = 10, ClassId = "{bf94d1f7-fb26-4a6a-9d83-092d88b17a36}", Name = "TerraTec [CyberLink]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 11, Priority = 11, ClassId = "{fcb24ebf-b9d0-40d9-9076-f27b93dbb952}", Name = "Twinhan [CyberLink]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 12, Priority = 12, ClassId = "{758c0f02-df95-11d2-8e75-00104b93cf06}", Name = "ATI" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 13, Priority = 13, ClassId = "{ad6a3830-d190-4d98-9135-a74c942af32f}", Name = "CyberLink" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 14, Priority = 14, ClassId = "{09c8d515-5c6a-434d-ad92-fef7eb153310}", Name = "CyberLink [Power2Go]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 15, Priority = 15, ClassId = "{77a4e3a6-8a00-4e67-b0e3-705f59e9acd9}", Name = "CyberLink [PowerEncoder]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 16, Priority = 16, ClassId = "{ead7bc81-1ddf-4a50-bf5e-225deffff1d1}", Name = "CyberLink [PowerProducer]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 17, Priority = 17, ClassId = "{317ddb61-870e-11d3-9c32-00104b3801f6}", Name = "InterVideo" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 18, Priority = 18, ClassId = "{2be4d160-6f2e-4b3a-b0bd-e880917238dc}", Name = "MainConcept" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 19, Priority = 19, ClassId = "{2be4d150-6f2e-4b3a-b0bd-e880917238dc}", Name = "MainConcept [combined]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 20, Priority = 20, ClassId = "{00098205-76cc-497e-98a1-6ef10d0bf26c}", Name = "MainConcept [Applian]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 21, Priority = 21, ClassId = "{42150cd9-ca9a-4ea5-9939-30ee037f6e74}", Name = "Microsoft" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 22, Priority = 22, ClassId = "{5f5aff4a-2f7f-4279-88c2-cd88eb39d144}", Name = "Microsoft [combined]" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 23, Priority = 23, ClassId = "{efd8a271-7391-11d4-8807-00e018a8539a}", Name = "nanocosmos" });
      ctx.VideoEncoders.AddObject(new VideoEncoder { IdVideoEncoder = 24, Priority = 24, ClassId = "{cf957f50-77fe-4192-a59f-95ca43bd04ba}", Name = "Ulead" });

      // List of supported audio encoders.
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 1, Priority = 1, ClassId = "{5f5cebd4-cc63-4e85-bd37-534f62a658d0}", Name = "Hauppauge SoftMCE [MainConcept]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 2, Priority = 2, ClassId = "{c251e670-2ff5-4db1-8235-ab35bdcaf95e}", Name = "Hauppauge SoftPVR [MainConcept]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 3, Priority = 3, ClassId = "{20d30120-e975-45d7-ace2-8e2ac5581f33}", Name = "KWorld [CyberLink]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 4, Priority = 4, ClassId = "{44bfff7d-47f3-4591-ac3a-60d94e80b2cc}", Name = "Medion PowerCinema [CyberLink]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 5, Priority = 5, ClassId = "{a3d70ac0-9023-11d2-8d55-0080c84e9c68}", Name = "Medion PowerVCR II [CyberLink]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 6, Priority = 6, ClassId = "{8928e446-2282-4192-9f10-6e2c563477da}", Name = "PCTV Systems" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 7, Priority = 7, ClassId = "{695db666-361c-4be5-8219-9960be378101}", Name = "Pinnacle" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 8, Priority = 8, ClassId = "{14c276b7-c71d-4f45-8439-1fc8bae6c6aa}", Name = "TerraTec [CyberLink]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 9, Priority = 9, ClassId = "{649a74a7-879b-4a01-9178-3ca1c2d4e400}", Name = "Twinhan [CyberLink]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 10, Priority = 10, ClassId = "{6467dd70-fbd5-11d2-b5b6-444553540000}", Name = "ATI" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 11, Priority = 11, ClassId = "{e25fa630-52de-4bfa-9e98-b5cbd500396d}", Name = "CyberLink" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 12, Priority = 12, ClassId = "{e8f36981-7d45-4af4-aca2-e7d960d5ad6f}", Name = "CyberLink [Power2Go]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 13, Priority = 13, ClassId = "{5a9f9772-ccd3-4bac-81aa-d60574d67afb}", Name = "CyberLink [PowerEncoder]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 14, Priority = 14, ClassId = "{5f15e71d-8066-4d26-bb0a-41a17339dc92}", Name = "CyberLink [PowerProducer]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 15, Priority = 15, ClassId = "{0cd2e140-8d60-11d3-9c32-00104b3801f6}", Name = "InterVideo" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 16, Priority = 16, ClassId = "{2be4d170-6f2e-4b3a-b0bd-e880917238dc}", Name = "MainConcept" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 17, Priority = 17, ClassId = "{15bebb32-5bb5-42b6-b45a-ba49f78ba19f}", Name = "MainConcept [Applian]" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 18, Priority = 18, ClassId = "{acd453bc-c58a-44d1-bbf5-bfb325be2d78}", Name = "Microsoft" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 19, Priority = 19, ClassId = "{e6a3558a-932a-4720-97d6-dc5eda03a3f7}", Name = "nanocosmos" });
      ctx.AudioEncoders.AddObject(new AudioEncoder { IdAudioEncoder = 20, Priority = 20, ClassId = "{cf957f70-77fe-4192-a59f-95ca43bd04ba}", Name = "Ulead" });
