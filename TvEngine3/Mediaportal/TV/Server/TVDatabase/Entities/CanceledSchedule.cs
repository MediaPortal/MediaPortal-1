        ...
        public int IdCanceledSchedule
        {
            ...
            set
            {
                if (_idCanceledSchedule != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdCanceledSchedule'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
