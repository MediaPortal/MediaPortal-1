        ...
        public int IdHistory
        {
            ...
            set
            {
                if (_idHistory != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdHistory'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
                    _idHistory = value;
