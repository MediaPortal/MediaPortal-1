        ...
        public int IdRecording
        {
            ...
            set
            {
                if (_idRecording != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdRecording'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
                    _idRecording = value;
