        ...
        public int IdProgram
        {
            ...
            set
            {
                if (_idProgram != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdProgram'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
                    _idProgram = value;
