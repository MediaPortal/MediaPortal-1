        ...
        public int IdKeywordMap
        {
            ...
            set
            {
                if (_idKeywordMap != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdKeywordMap'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
                    _idKeywordMap = value;
