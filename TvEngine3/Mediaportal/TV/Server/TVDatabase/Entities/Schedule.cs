        ...
        public int IdSchedule
        {
            ...
            set
            {
                if (_idSchedule != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Die 'IdSchedule'-Eigenschaft ist Teil des Objektschlüssels und kann nicht geÃ¤ndert werden. Änderungen an Schlüsseleigenschaften können nur ausgeführt werden, wenn das Objekt nachverfolgt wird oder sich im Added-Zustand befindet.");
                    }
                    _idSchedule = value;
