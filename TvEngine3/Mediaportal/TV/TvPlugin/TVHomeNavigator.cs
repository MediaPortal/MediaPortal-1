...
";
    ...
    public void ZapNow()
    {
      ...
      // Log.Info(Log.LogType.Error, "zapnow group:{0} current group:{0}", m_zapgroup, m_currentgroup);
      //if (m_zapchannel == null)
      //   Log.Info(Log.LogType.Error, "zapchannel==null");
      //else
      //   Log.Info(Log.LogType.Error, "zapchannel=={0}",m_zapchannel);
    }
