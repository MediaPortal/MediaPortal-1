...
namespace Mediaportal.TV.TvPlugin
{
  public class TvOsd : GUIInternalWindow
  {
    ...
    private string GetChannelName()
    {
      ...
      {
        Recording rec = TvRecorded.ActiveRecording();
        return TvRecorded.GetChannelDisplayName(rec);
      }
      else
      {
    ...
    private void ShowPrograms()
    {
      ...
      {
        prog = TVHome.Navigator.Channel.CurrentProgram;
      }
    ...
    private void SetRecorderStatus(bool forced = false)
    {
      if (imgRecIcon != null)
      {
    ...
    private void UpdateProgressBar()
    {
      ...
      else
      {
        ...
        if (rec != null)
        {
          ...
          channelDisplayName = TvRecorded.GetChannelDisplayName(rec) + " (" + GUILocalizeStrings.Get(604) + ")";
